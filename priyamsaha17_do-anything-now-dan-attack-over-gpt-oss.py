...
file_path = '/kaggle/input/ai-safety-verification-dataset/Moonshot Data/Datasets Categorized/Jailbreaks/DAN/jailbreak-dan.json'
...
for i in range(len(datasets)):
    datasets[i] = datasets[i].sample(frac=1, random_state=100).reset_index(drop=True).head(20)
