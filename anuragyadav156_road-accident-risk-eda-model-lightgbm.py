...
sns.histplot(x= traindf["speed_limit"])
...
# Fit on training data (2D)
traindf["speed_limit"] = scaler.fit_transform(traindf[["speed_limit"]])

# Transform test data (use same scaler)
testdf["speed_limit"] = scaler.transform(testdf[["speed_limit"]])
...
predictions = best_model.predict(testdf)
