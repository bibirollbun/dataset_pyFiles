...
# ---------------------------
sources = {
    "/kaggle/input/predicting-the-beats-per-minute-of-songs-sub-files/submission12.csv": 0.3,
    "/kaggle/input/predicting-the-beats-per-minute-of-songs-sub-files/submission13.csv": 2.0,
    "/kaggle/input/predicting-the-beats-per-minute-of-songs-sub-files/submission14.csv": 0.5,
    "/kaggle/input/predicting-the-beats-per-minute-of-songs-sub-files/submission15.csv": 0.5,
}
