...
class ReplyAgent:
    def create_reply(self,message,intent,urgency):
        if intent == "refund":
            return "Please provide me your order ID so i can help you further."
        if intent == "cancellation":
            return "For cancellation i want your registered email ID."
        if intent == "billing":
            return "Please give me your invoice number for the verification."
        if intent == "general_help":
            return "I'm here to help you,Plz share me about your problem."
        return "Thank you for your message. Is there anything i can help you with ?"
