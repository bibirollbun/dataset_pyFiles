...
params = {
      ...
      'subm'     : [
          {'name': f'0.70108', 'weight':+0.25, 'color':'royalblue'},
          {'name': f'0.70109', 'weight':+0.25, 'color':'orange'   },
          {'name': f'0.70150', 'weight':+0.25, 'color':'green'    },
          {'name': f'0.70165', 'weight':+0.25, 'color':'crimson'  },]
}
...
params = {
      ...
      'subm'     : [
          {'name': f'0.70190', 'weight':+0.05, 'color':'royalblue'},
          {'name': f'0.70191', 'weight':+0.05, 'color':'orange'   },
          {'name': f'0.70418', 'weight':+0.90, 'color':'green'    },]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [+10, -3,-7]],
      'subm'     : [
          {'name': f'0.70255', 'weight':+0.10, 'color':'royalblue'},
          {'name': f'0.70285', 'weight':+0.10, 'color':'orange'   },
          {'name': f'0.70404', 'weight':+0.80, 'color':'green'    },]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [+10, -3,-7]],
      'subm'     : [
          {'name': f'0.70442.cat', 'weight':+0.05, 'color':'royalblue'},
          {'name': f'0.70442.lgbm','weight':+0.05, 'color':'orange'   },
...
params = {
      ...
      'subm'     : [
          {'name': f'g1', 'weight':+0.01, 'color':'royalblue'},
          {'name': f'g2', 'weight':+0.02, 'color':'orange'   },
          {'name': f'g3', 'weight':+0.03, 'color':'green'    },
          {'name': f'g4', 'weight':+0.94, 'color':'crimson'  },]
}
df = h_blend(params, details=True)


for file in 'g1,g2,g3,g4,tida_desc'.split(','): os.remove(file+'.csv')
