...
df_train = pd.read_csv("/kaggle/input/black-jack-smart-effect-of-removal-ml/train.csv")
df_test = pd.read_csv("/kaggle/input/black-jack-smart-effect-of-removal-ml/test.csv")
...
submission_df = pd.read_csv('/kaggle/input/black-jack-smart-effect-of-removal-ml/sample_submission.csv')
