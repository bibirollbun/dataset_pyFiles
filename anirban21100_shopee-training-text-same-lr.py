...
EPOCHS = 40
fold_id = 0
LR = [3e-5, 3e-5] #[bb_lr, neck_lr]
debug = False
BATCH_SIZE = 64
# img_backbone = "timm/eca_nfnet_l1.ra2_in1k"
text_backbone = ["FacebookAI/xlm-roberta-base", # 1e-4
                "FacebookAI/xlm-roberta-large", # 1e-4
                "cahya/bert-base-indonesian-1.5G", #3e-5
                "indobenchmark/indobert-base-p1", #1e-4
                "google-bert/bert-base-multilingual-cased"] #3e-5
# img_size = 256
max_len = 35
NUM = 0
