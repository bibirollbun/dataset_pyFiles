...
train_x['store_item'] = train['store'].astype(str) + "_" + train['item'].astype(str)
test_x['store_item']  = test['store'].astype(str) + "_" + test['item'].astype(str)

le = LabelEncoder()
le.fit(pd.concat([train_x['store_item'], test_x['store_item']])) 
