...
#学習曲線描画のため、ログを取得
train_acc_list = [0.70, 0.80, 0.88]   
val_acc_list =   [0.65, 0.75, 0.78]   
train_loss_list = [0.90, 0.60, 0.35]  
val_loss_list =   [0.95, 0.70, 0.68]  
...
# Accuracy
plt.subplot(1, 2, 2)
plt.plot(epochs, train_acc_list, 'bo-', label='Train Accuracy')
plt.plot(epochs, val_acc_list, 'ro-', label='Validation Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
