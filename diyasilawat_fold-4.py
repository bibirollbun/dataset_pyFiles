...
class Config:
    ...
    # Path to dataset that contains your cached .npy volumes
    cache_dir = '/kaggle/input/rsna-aneurysm-cache/cache'  # <-- keep or adjust name
