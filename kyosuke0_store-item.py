...
cols_to_encode = ['year', 'month', 'day', 'dow']
train_x_encoded = pd.get_dummies(train_x, columns=cols_to_encode, drop_first=True)
test_x_encoded = pd.get_dummies(test_x, columns=cols_to_encode, drop_first=True)
