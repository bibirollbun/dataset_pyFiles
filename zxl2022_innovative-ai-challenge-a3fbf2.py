...
pdd1=pd.read_csv('/kaggle/input/innovative-ai-challenge-with-randomforestregressor/submission.csv')

pdd2=pd.read_csv('/kaggle/input/bagging-leaveoneout-public-5126-4-6e05cc/submission.csv')
...
test_df_cp['Crop_Yield (kg/ha)']=(test_df_cp['Crop_Yield (kg/ha)']+pdd1['Target']+pdd2['Target'])/3


test_df_cp


test_df_cp.to_csv("ensmble_Model_Prediction.csv", index=None)
