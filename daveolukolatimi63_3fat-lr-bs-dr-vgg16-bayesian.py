...
class MultiFactorOptimizer(CNNHyperparameterOptimizer):
...
TWO_FACTOR_CONFIGS = {
    ...
    "LR_DR": ["LEARNING_RATE", "BATCH_SIZE"],
...
def run_specific_analysis(factor_config_name, sampler_type="GRID", n_trials=None):
...
MULTIFACTOR_SETTINGS["architecture"] = "VGG16"
[
    # "BS_EP",
    # "BS_OPT",
    # "EP_DR",
...
# 1. Run specific 3-factor analysis:
study = run_specific_analysis("LR_BS_DR", "BAYESIAN")
