...
shutil.copy(ds_path4 +'/submission 0.92730.csv', new_path +'/0.92730.csv')
...
display(get_preds_from_column(3, df_desc)) # For example, the 3-rd column


df = df_vote   # lb = 0.92_727
...
#df = get_preds_from_column(0, df_desc) # LB = 0.92670 - v.16
#df = get_preds_from_column(1, df_desc) # LB = 0.92694 - v.17
#df = get_preds_from_column(4, df_desc) # LB = 0.92707 - v.18
#df = get_preds_from_column(5, df_desc) # LB = 0.92715 - v.19
...
straight_blend(df_51,df_52,wts=[0.40,0.60],subm='Group_5.csv')
