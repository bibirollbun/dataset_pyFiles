...
# Initialize and Apply SMOTE to training data only
...
y_preds = gb_clf.predict(X_test_transformed)
y_preds
...
Y_prob = gb_clf.predict_proba(X_test_transformed)[:,1]
...
test_preds = gb_clf.predict(data_test_transformed)
test_preds
