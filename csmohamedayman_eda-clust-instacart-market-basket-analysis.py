...
test  = test.drop(columns=list(dropped_nan))
...
train, _ = drop_id_feature(train, 'product_id')
train, _ = drop_id_feature(train, 'user_id')
train, _ = drop_id_feature(train, 'aisle_id')
train, _ = drop_id_feature(train, 'order_id')
train, _ = drop_id_feature(train, 'department_id')

test, _ = drop_id_feature(test, 'product_id')
test, _ = drop_id_feature(test, 'user_id')
test, _ = drop_id_feature(test, 'aisle_id')
test, _ = drop_id_feature(test, 'order_id')
test, _ = drop_id_feature(test, 'department_id')
...
test = test.drop(columns=list(dropped_mode))
...
for feature in ['days_since_prior_order', 'order_hour_of_day', 'department']:
