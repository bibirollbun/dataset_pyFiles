...
# Contoh: Jika Anda memiliki dataset dengan ID dan prediksi hujan (0 = tidak hujan, 1 = hujan)
# Pastikan ini sesuai dengan output model Anda
ids = [1, 2, 3, 4, 5]  # Ganti dengan ID asli dari dataset
predictions = [0, 1, 0, 1, 0]  # Ganti dengan hasil prediksi model Anda
...
print("File submission.csv berhasil dibuat! Isi direktori kerja:")
print(os.listdir('/kaggle/working'))

# Submit file ke kompetisi Kaggle (ganti <competition-name> dengan nama kompetisi yang diikuti)
!kaggle competitions submit -c <competition-name> -f /kaggle/working/submission.csv -m "First submission"
