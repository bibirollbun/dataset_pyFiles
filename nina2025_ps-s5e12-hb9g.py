...
params = {
      ...
      'subm'     : [
         { 'name': f'0.70108', 'weight':+0.50, 'color':'darkmagenta'},
         { 'name': f'0.70109', 'weight':+0.50, 'color':'limegreen'  },]
}
...
params = {
      ...
      'subwts'   : [w/150 for w in [5,-5]],
      'subm'     : [
          {'name': f'0.70164', 'weight':+0.50, 'color':'deeppink'},
          {'name': f'0.70165', 'weight':+0.50, 'color':'royalblue'  },]
}
...
params = {
      ...
      'subm'     : [
         { 'name': f'0.70072', 'weight':+0.24, 'color':'limegreen'  },
         { 'name': f'0.70165', 'weight':+0.38, 'color':'royalblue'  },
         { 'name': f'0.70175', 'weight':+0.38, 'color':'darkmagenta'},]
}
...
params = {
      ...
      'subm'     : [
         ...
         { 'name': f'g2', 'weight':+0.11, 'color':'deeppink' },
         { 'name': f'g3', 'weight':+0.79, 'color':'darkmagenta'    },]
}
df123 = h_blend(params, details=True)


for file in 'g1,g2,g3'.split(','): os.remove(f'{file}.csv')


df123.to_csv('submission.csv',index=False)
df123
