...
path = f'/kaggle/input/01-november-2025-ps-s5e11/submission '
...
params = {
      ...
      'subm'     : [
         ...
         { 'name': f'0.92339','weight':+0.07 },
         { 'name': f'0.92350','weight':+0.08 },
         { 'name': f'0.92449','weight':+0.15 },
         { 'name': f'0.92536','weight':+0.30 },
         { 'name': f'0.92603','weight':+0.40 },
      ]
}

df_cross = h_blend(params,color='green5',figures1=True,figures2=True,details=True)
