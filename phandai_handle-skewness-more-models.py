...
rmsle_ridge = calculate_rmsle(y_val, y_pred_ridge)
print(f"Ridge Regression RMSLE:  {rmsle_ridge:.4f}")

# Evaluate Lasso Regression
rmsle_lasso = calculate_rmsle(y_val, y_pred_lasso)
print(f"Lasso Regression RMSLE:  {rmsle_lasso:.4f}")

rmsle_xgb = calculate_rmsle(y_val, y_pred_xgb)
print(f"XGBoost Regressor RMSLE: {rmsle_xgb:.4f}")

rmsle_lgb = calculate_rmsle(y_val, y_pred_lgb)
...
# Predict
y_pred = xgb_model.predict(test_processed)
