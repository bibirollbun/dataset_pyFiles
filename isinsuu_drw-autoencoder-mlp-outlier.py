...
lasso_trainer.fit(X, y)

scores["Lasso"] = lasso_trainer.fold_scores
oof_preds["Lasso"] = lasso_trainer.oof_preds
test_preds["Lasso"] = lasso_trainer.predict(X_test)
...
ae_test_preds= ae_trainer.predict(X_test)
