...
df = pd.read_parquet('/kaggle/input/aa-v-2025-ii-pronosticos-nn-rnn-lstm-tcn/df_train.parquet')
print(df.shape)
df.head(5)
...
df_test = pd.read_parquet('/kaggle/input/aa-v-2025-ii-pronosticos-nn-rnn-lstm-tcn/df_test.parquet')
