...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.out = nn.Linear(2048, 1)  # ResNet50 outputs 2048 features
    ...
    def monitor_metrics(self, outputs, targets, loss):
        ...
        return {"auc": torch.tensor(auc), "loss": torch.tensor(loss.item())}
...
df = pd.read_csv("/kaggle/input/gowtham-23bcs10168-ml-project/train_5folds.csv")
df.head()
