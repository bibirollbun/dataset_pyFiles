...
base_lgb =  LGBMClassifier(random_state=seed, verbose=-1, n_estimators=100)
base_cat =  CatBoostClassifier(random_state=seed, verbose=0)
...
def generate_baseline_results(models, model_names, X, y, metrics='accuracy', cv=5, plot_results=False):
    """
...
cv_results = generate_baseline_results(models, model_names, X_transformed, y, metrics='accuracy', cv=5, plot_results=True)
