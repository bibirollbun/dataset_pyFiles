...
block_size = 512        # Longitud del contexto (tokens que ve el modelo)
...
batch_size = 128         # NÃºmero de secuencias procesadas simultÃ¡neamente
...
eval_interval = 500     # Cada cuÃ¡ntas iteraciones evaluar en validation set
                        # Valores tÃ­picos: 100-500
                        # MÃ¡s frecuente = mÃ¡s feedback pero entrenamiento mÃ¡s lento

eval_iters = 200        # CuÃ¡ntos batches usar para estimar la pÃ©rdida
...
# HiperparÃ¡metros adicionales necesarios
n_head = 6  # NÃºmero de cabezas de atenciÃ³n
n_layer = 6  # NÃºmero de bloques Transformer
