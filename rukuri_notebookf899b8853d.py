...
train_x['doy'] = train[col].dt.dayofyear
test_x['doy']  = test[col].dt.dayofyear
...
train_x['is_wknd'] = train[col].dt.weekday // 4
test_x['is_wknd']  = test[col].dt.weekday // 4
...
train_x["holiday"]=0
train_x.loc[(train_x["dow"]==5)|(train_x["dow"]==6), 'holiday'] = 1
test_x["holiday"]=0
test_x.loc[(test_x["dow"]==5)|(test_x["dow"]==6), 'holiday'] = 1
