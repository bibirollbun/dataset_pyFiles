...
path = f'/kaggle/input/4-november-2025-ps-s5e11/submission '
...
df_master1 = pd.read_csv('/kaggle/input/4-november-2025-ps-s5e11/submission 0.92620.csv')
...
# df_masters.to_csv('submission masters.csv',index=False)


path = '/kaggle/input/4-november-2025-ps-s5e11/submission '
...
df_JpnRed1 = pd.read_csv('/kaggle/input/4-november-2025-ps-s5e11/submission 0.92546.csv')
...
# df_JGroupe.to_csv('submission JGroupe.csv',index=False)
...
# df_master2.to_csv('submission arti_2.csv',index=False)
