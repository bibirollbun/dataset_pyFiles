...
class ImageTransform():
    ...
    def __init__(self, resize, mean, std):
        ...
        def __call__(self, img, phase):return self.data_transform[phase](img)
...
train_dataset = ImageDataset(train_list, transform=ImageTransform(img_size, mean, std), phase='train')
val_dataset = ImageDataset(val_list, transform=ImageTransform(img_size, mean, std), phase='val')
