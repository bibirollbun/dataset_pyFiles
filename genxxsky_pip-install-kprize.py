!pip install --target=/kaggle/working vllm==0.7.1 bitsandbytes fsspec==2024.9.0 pre_commit==4.0.1 cfgv==3.4.0 dill==0.3.8


!pip install --target=/kaggle/working tree-sitter tree-sitter-python


!rm -rf /kaggle/working/ray*


!pip install --target=/kaggle/working rpds-py
