...
with zipfile.ZipFile("/kaggle/input/train.zip", 'r') as zip_ref:
    zip_ref.extractall("/kaggle/working/train")

with zipfile.ZipFile("/kaggle/input/test1.zip", 'r') as zip_ref:
...
IMAGE_WIDTH = IMAGE_WIDTH  # define your IMAGE_WIDTH
IMAGE_HEIGHT = IMAGE_HEIGHT  # define your IMAGE_HEIGHT
IMAGE_CHANNELS = IMAGE_CHANNELS  # define your IMAGE_CHANNELS
