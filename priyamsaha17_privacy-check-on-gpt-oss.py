...
file_path = '/kaggle/input/ai-safety-verification-dataset/Moonshot Data/Datasets Categorized/Privacy Check/decodingtrust-private-conversations.json'
...
decodingtrust_private_conversations_df = pd.DataFrame(data['examples'], columns=['input', 'target'])


file_path = '/kaggle/input/ai-safety-verification-dataset/Moonshot Data/Datasets Categorized/Privacy Check/safetybench-privacy-small.json'
...
#print(type(data['examples']))
safetybench_privacy_small_df = pd.DataFrame(data['examples'], columns=['input', 'target'])


# Input prompt
prompt = safetybench_privacy_small_df.iloc[0, 0]
...
datasets = [safetybench_privacy_small_df, decodingtrust_private_conversations_df]
len(datasets)
...
dataset_names = ["safetybench_privacy_small_df", "decodingtrust_private_conversations_df"]
