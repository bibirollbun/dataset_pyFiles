...
try:
    ...
    class YatConv(nnx.Module):
        def __init__(self, *args, **kwargs):
            super().__init__()
        def __call__(self, x):
            raise NotImplementedError("YatConv placeholder is not a real layer.")
...
class YatCNN(nnx.Module):
    ...
    def __init__(self, *, num_classes: int, input_channels: int, rngs: nnx.Rngs):
        ...
        self.conv4 = nnx.Conv(128, 256, kernel_size=(3, 3), rngs=rngs)
...
class Decoder(nnx.Module):
    ...
    def __init__(self, *, output_channels: int, rngs: nnx.Rngs):
        self.deconv1 = nnx.ConvTranspose(256, 128, kernel_size=(3, 3), strides=(2, 2), padding='SAME', rngs=rngs)
        self.deconv2 = nnx.ConvTranspose(128, 64, kernel_size=(3, 3), strides=(2, 2), padding='SAME', rngs=rngs)
        self.deconv3 = nnx.ConvTranspose(64, 32, kernel_size=(3, 3), strides=(2, 2), padding='SAME', rngs=rngs)
...
def main():
    ...
    dataset_configs = {
        'cifar10': {
            ...
            'num_epochs': 15, 'eval_every': 300, 'batch_size': 128,
