...
!7z x ../input/diabetic-retinopathy-detection/train.zip.001 "-i!train/12*.jpeg" -y # restrict extracted file to about 100 for the disk restriction
!mkdir data
...
history = model.fit(
        ...
        use_multiprocessing=True,  # nếu muốn dùng đa tiến trình
