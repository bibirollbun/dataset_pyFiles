...
filtered_dataset = dataset['train'].filter(lambda example: example['task'] == 'Multiclass_Product_Classification')
...
for i in tqdm(range(0, len(list_of_texts), BATCH_SIZE), desc="Generating responses"):
    ...
    print(f"========ITERATION {i} / {len(list_of_texts) / BATCH_SIZE} DONE===========")
