...
# تعریف ضرایب وزنی برای هر کلاس
custom_weights = {0: 0.142, 1: 0.2857, 2: 0.571}

# محاسبه وزن‌ها با استفاده از ضرایب وزنی
normalized_weights = {int(label): custom_weights.get(int(label), 1) for label in class_counts.index}
...
train_ds_t1, val_ds_t1, len_train_t1, len_val_t1 = create_datasets(train_data, 'Sagittal T1', batch_size=32)
train_ds_t2, val_ds_t2, len_train_t2, len_val_t2 = create_datasets(train_data, 'Axial T2', batch_size=32)
train_ds_t2stir, val_ds_t2stir, len_train_t2stir, len_val_t2stir = create_datasets(train_data, 'Sagittal T2/STIR', batch_size=32)
