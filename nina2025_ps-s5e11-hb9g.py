...
def bokeh_show(
    ...
    if show_figures2 == True:
        ...
        _height = 574 if len(params["subm"]) == 20 else 254
...
# 
params = {
  'path'     : f"/kaggle/input/22-november-2025-ps-s5e11/submission_",   
  'id_target': ['id',"loan_paid_back"],
  'type_sort': ['asc/desc',0.30,0.70 ],
  'subwts'   : [ -0.01,+0.01,-0.01,+0.01,-0.01,+0.01,-0.01,+0.01,-0.01,+0.01,
                 +0.01,-0.01,+0.01,-0.01,+0.01,-0.01,+0.01,-0.01,+0.01,-0.01],
  'subm'     : [
      {'name': f'001', 'LB':0.92,    'weight':+0.05, 'color':'firebrick'},
      {'name': f'002', 'LB':0.92,    'weight':+0.05, 'color':'crimson'},
      {'name': f'003', 'LB':0.92,    'weight':+0.05, 'color':'red'},
      {'name': f'004', 'LB':0.92,    'weight':+0.05, 'color':'orangered'},
      {'name': f'005', 'LB':0.92,    'weight':+0.05, 'color':'tomato'},
      {'name': f'006', 'LB':0.92,    'weight':+0.05, 'color':'darkgreen'},
      {'name': f'007', 'LB':0.92771, 'weight':+0.05, 'color':'green'},
      {'name': f'008', 'LB':0.92,    'weight':+0.05, 'color':'forestgreen'},
      {'name': f'009', 'LB':0.92,    'weight':+0.05, 'color':'limegreen'},
      {'name': f'010', 'LB':0.92,    'weight':+0.05, 'color':'lime'},
      {'name': f'011', 'LB':0.92,    'weight':+0.05, 'color':'midnightblue'},
      {'name': f'012', 'LB':0.92,    'weight':+0.05, 'color':'mediumblue'},
      {'name': f'013', 'LB':0.92740, 'weight':+0.05, 'color':'blue'},
      {'name': f'014', 'LB':0.92747, 'weight':+0.05, 'color':'royalblue'},
      {'name': f'015', 'LB':0.92756, 'weight':+0.05, 'color':'steelblue'},
      {'name': f'016', 'LB':0.92770, 'weight':+0.05, 'color':'sandybrown'},
      {'name': f'017', 'LB':0.92743, 'weight':+0.05, 'color':'chocolate'},
      {'name': f'018', 'LB':0.92764, 'weight':+0.05, 'color':'sienna'},
      {'name': f'019', 'LB':0.92768, 'weight':+0.05, 'color':'brown'},
      {'name': f'020', 'LB':0.92773, 'weight':+0.05, 'color':'maroon'},]
}

df = h_blend(params, fig1=True,fig2=True)
...
params = {
  ...
  'subm'     : [
      {'name': f'015', 'LB':0.92756, 'weight':+0.30, 'color':'limegreen'  },
      {'name': f'017', 'LB':0.92743, 'weight':+0.10, 'color':'forestgreen'},
      {'name': f'018', 'LB':0.92764, 'weight':+0.30, 'color':'darkgreen'  },
      {'name': f'019', 'LB':0.92768, 'weight':+0.30, 'color':'maroon'     },]
}

df_0_92773 = h_blend(params, details=True)
