...
class Model:
    def __init__(self):
        self.model_path = kagglehub.model_download('vinothkumarsekar89/llama_32_3b_instruct_svg_code_generation/transformers/01') 
...
# model=Model()
# print(model.predict('Sun in the east'))
