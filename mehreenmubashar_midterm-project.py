...
PREV_DAYS_LAST_DUE_DIFF: DAYS_LAST_DUE_1ST_VERSION
    """
...
def train_apps_all(apps_all_train):
    ...
    clf.fit(train_x, train_y, eval_set=[(train_x, train_y), (valid_x, valid_y)], eval_metric= 'auc', callbacks=[early_stopping(200), log_evaluation(100)]
           )
