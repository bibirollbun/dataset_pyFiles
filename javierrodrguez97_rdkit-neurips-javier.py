...
# Desactivan mensajes no deseados:
RDLogger.DisableLog('rdApp.*')                     # Desactiva los logs de advertencia/info de RDKit
os.environ["TOKENIZERS_PARALLELISM"] = "false"     # Previene avisos de advertencia de librer铆as como HuggingFace Transformers
...
# Iteracci贸n sobre las variables
for t in targets:
    print (t)
    if len(test)<10:
        test[t] = 0
