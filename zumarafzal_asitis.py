...
!pip install deep-lightcurve lightkurve --quiet
...
pip install deep-lightcurve -U


pip install lightkurve lightkurve-ext
...
lc_data = lkx.LightCurveCollection(lc_data_list).stitch()
lc = dl.light_curve_preparation(time=lc_data.time.value, flux=lc_data.flux)



pred, figs = dl_combined.predict(
    lc,
