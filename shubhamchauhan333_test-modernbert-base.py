...
train = pd.read_csv('/kaggle/input/amazon-ml-challenge/test.csv')
...
# --- Inference settings ---
batch_size = 512   # Large batch size for L4x4 GPUs
embeddings_list = []
...
np.save("test_embeddings_ModernBERT-base.npy", all_embeddings.numpy())
