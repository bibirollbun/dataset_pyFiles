...
params = {
      ...
      'subm'     : [
         { 'name': f'0.70108', 'weight':+0.33333, 'color':'darkmagenta'},
         { 'name': f'0.70109', 'weight':+0.33333, 'color':'limegreen'  },
         { 'name': f'0.70110', 'weight':+0.33334, 'color':'royalblue'  },]
}
...
params = {
      ...
      'subm'     : [
         { 'name': f'0.70108', 'weight':+0.33333, 'color':'darkmagenta'},
         { 'name': f'0.70109', 'weight':+0.33333, 'color':'limegreen'  },
         { 'name': f'0.70165', 'weight':+0.33334, 'color':'blue'  },]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [10, -3,-7]],
      'subm'     : [
         { 'name': f'0.70096', 'weight':+0.33334, 'color':'mediumblue' },
         { 'name': f'0.70108', 'weight':+0.33333, 'color':'darkmagenta'},
         { 'name': f'0.70109', 'weight':+0.33333, 'color':'limegreen'  },]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [10, -3,-7]],
      'subm'     : [
         { 'name': f'g1', 'weight':+0.33334, 'color':'royalblue' },
         { 'name': f'g2', 'weight':+0.33333, 'color':'blue'},
         { 'name': f'g3', 'weight':+0.33333, 'color':'mediumblue'  },]
}
