# MABe Mouse Behavior Detection - Enhanced V3
# Based on Mattia Angeli's V2 notebook with improvements for higher Kaggle scores
# 
# Key Enhancements in V3:
# 1. Advanced Feature Engineering:
#    - Multi-scale rolling window features with adaptive windows
#    - Enhanced curvature features with temporal patterns  
#    - Lag features for temporal dependencies
#    - Feature importance-based selection
# 
# 2. Enhanced Model Ensemble:
#    - Weighted ensemble based on validation performance
#    - More diverse model configurations
#    - Early stopping with patience
#    - Cross-validation for model selection
# 
# 3. Better Threshold Optimization:
#    - Grid search for action-specific thresholds
#    - Validation-based threshold tuning
#    - Dynamic threshold adjustment based on confidence
# 
# 4. Advanced Post-Processing:
#    - Adaptive temporal smoothing with FPS awareness
#    - Confidence-based filtering
#    - Enhanced robustify with better gap filling strategies
# 
# 5. Data Sampling Improvements:
#    - Better stratified sampling for rare behaviors
#    - Balanced training samples between single/pair behaviors
#    - Adaptive sample sizes per behavior type
#
# Integration with Kedro:
# - Uses tested Kedro functions where beneficial
# - Leverages action_thresholds from Kedro pipelines
# - Uses safe_rolling and other utilities from Kedro
...
if verbose:
    print("[INFO] Kedro functions not available, using notebook versions")
...
# V3 Enhancement: Advanced rolling window features and lag features

def add_lag_features(X, center_x, center_y, fps, max_lag=3):
...
# ==================== ENHANCED ENSEMBLE ====================
# V3 Enhancement: Weighted ensemble based on validation performance
...
# V3 Enhancement: Grid search for optimal thresholds

def optimize_thresholds_grid_search(pred, meta, true_labels, action_list, 
