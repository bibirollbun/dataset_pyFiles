...
train_df=train.drop(['id','day','winddirection','mintemp','dewpoint','windspeed','rainfall'],axis=1)
y=train['rainfall']


test_df=test.drop(['id','day','winddirection','mintemp','dewpoint','windspeed'],axis=1)
