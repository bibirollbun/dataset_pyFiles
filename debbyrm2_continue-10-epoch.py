...
csv_file = "/kaggle/input/engcapt21000con10/21000engcaptptb.csv"
...
csv_file_path = 'Test_Dataset_BLIP-ECG-21000-cont.csv'
...
def save_split_to_csv(split_data, filename):
    csv_data_list = []
...
# Save train split
save_split_to_csv(train_df, 'Train_Dataset_BLIP-ECG-21000.csv')

# Save validation split
save_split_to_csv(val_df, 'Val_Dataset_BLIP-ECG-21000.csv')
...
checkpoint_path = "/kaggle/input/6-epoch-21000/blip-ecg-capt-21000.pth"
...
model_output_path = '/kaggle/working/blip-ecg-capt-21000.pth'
