...
#print("学習用レコード数:", train.shape[0])
#print("テスト用レコード数:", test.shape[0])
#print("全特徴量数:", train.drop(columns=[ID_COL, OBJECT_COL]).shape[1])
#print("数値型特徴量数:", train.select_dtypes(include=['int64', 'float64']).drop(columns=[OBJECT_COL]).shape[1])
#print("文字列型特徴量数:", train.select_dtypes(include=['object']).shape[1])
#print("目的変数数:", 1)
