...
train = pd.read_csv('/kaggle/input/nlp-sentiment-analysis-xm/train.csv')  # Training data with text and labels
test = pd.read_csv('/kaggle/input/nlp-sentiment-analysis-xm/test_features.csv')  # Test data for predictions
