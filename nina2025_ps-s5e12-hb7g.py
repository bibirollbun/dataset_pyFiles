...
params = {
      ...
      'subm'     : [
          ...
          {'name': f'0.70175', 'weight':+0.50, 'color':'darkmagenta'},]
}
...
params = {
      ...
      'subm'     : [
         { 'name': f'0.70109', 'weight':+0.31, 'color':'limegreen'  },
         { 'name': f'0.70165', 'weight':+0.34, 'color':'royalblue'  },
         { 'name': f'0.70175', 'weight':+0.35, 'color':'darkmagenta'},]
}
...
params = {
      ...
      'subm'     : [
         { 'name': f'g1', 'weight':+0.06, 'color':'darkmagenta'},
         { 'name': f'g2', 'weight':+0.17, 'color':'darkorchid' },
         { 'name': f'g3', 'weight':+0.77, 'color':'magenta'    },]
}
