...
# Xây dựng mô hình với thêm 3 lớp mới
model = Sequential([
...
checkpoint_path = 'best_model_with_extra_layers.h5.keras'
...
results.to_csv('kq.csv', sep=',', index=False)
print("Dự đoán đã được lưu vào 'kq.csv'")
