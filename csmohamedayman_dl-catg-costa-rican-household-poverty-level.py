...
baseline_models = get_categorical_models(input_size=train_model1.shape[1]-1, output_size=4)
...
df_cpy = add_columns(train_model2.copy())
df_dtypes(df_cpy)
...
train_model2 = add_columns(train_model2)
df_dtypes(train_model2)
...
baseline_models = get_categorical_models(input_size=train_model2.shape[1]-1, output_size=4)
evaluate_model_func = evaluate_categorical_model
#for i, j in baseline_models.items(): print(i, j)
...
baseline_models = get_categorical_models(input_size=train_model3.shape[1]-1, output_size=4)
evaluate_model_func = evaluate_categorical_model
#for i, j in baseline_models.items(): print(i, j)
...
selected_numerical_features = set(numerical_features) & (set(correlations_df.head(5)['Feature']) | set(correlations_df.tail(5)['Feature']))
...
baseline_models = get_categorical_models(input_size=train_model4.shape[1]-1, output_size=4)
evaluate_model_func = evaluate_categorical_model
#for i, j in baseline_models.items(): print(i, j)
...
baseline_models = get_categorical_models(input_size=train_model5.shape[1]-1, output_size=4)
evaluate_model_func = evaluate_categorical_model
#for i, j in baseline_models.items(): print(i, j)
...
train_model6 = add_columns(train_model6)
...
selected_oversamplying_features = set(oversamplying_features) & (set(correlations_df.head(2)['Feature']) | set(correlations_df.tail(2)['Feature'])) & set(['Target'])
print(f'selected_oversamplying_features: {selected_oversamplying_features}')
...
baseline_models = get_categorical_models(input_size=train_model6.shape[1]-1, output_size=4)
evaluate_model_func = evaluate_categorical_model
#for i, j in baseline_models.items(): print(i, j)
...
train_model7 = add_columns(train_model7)
df_dtypes(train_model7)


test_model7 = test.copy()
test_model7 = add_columns(test_model7)
...
selected_numerical_features = set(numerical_features) & (set(correlations_df.head(6)['Feature']) | set(correlations_df.tail(6)['Feature']))
print(f'selected_numerical_features: {selected_numerical_features}')
...
baseline_models = get_categorical_models(input_size=train_model7.shape[1]-1, output_size=4)
evaluate_model_func = evaluate_categorical_model
#for i, j in baseline_models.items(): print(i, j)
