...
class ReplyAgent:
    def create_reply(self, message, intent, urgency):
        ...
        if intent == "cancellation":
            return "I can help you to cancel your subscription. Kindly provide your registered email."
        if intent == "billing":
            return "It seems you have a billing concern. Please send your invoice number for verification."
        if intent == "general_help":
            return "Sure, I am here to help. Could you please share more details?"
