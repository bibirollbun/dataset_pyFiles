...
params = {
  ...
  'subm'     : [
      {'name': f'743', 'weight':+0.17, 'color':'darkmagenta'},
      {'name': f'751', 'weight':+0.17, 'color':'darkorchid' },
      {'name': f'756', 'weight':+0.17, 'color':'deeppink'   },
      {'name': f'767', 'weight':+0.49, 'color':'magenta'    },]
}
