...
def color_scheme(dk,color):
    ...
    clr_Red54 = ['darkgray','forestgreen','gray','dimgray',"crimson"]
...
params = {
      ...
      'subwts'   : [ +0.08,+0.05, -0.02,-0.04,-0.07 ],
      'subm'     : [
         { 'name': f'0.92601','weight':+0.14 },
         { 'name': f'0.92638','weight':+0.21 },
         { 'name': f'0.92640','weight':+0.25 },
         { 'name': f'0.92642','weight':+0.07 },
         { 'name': f'0.92643','weight':+0.33 },]
}

df_cross52 = h_blend(params,color='red52',figures1=True,figures2=True,details=True)
...
df_cross53 = h_blend(params,color='red53',figures1=True,figures2=True,details=True)
...
params = {
      ...
      'subwts'   : [ +0.08,+0.05, -0.02,-0.04,-0.07 ],
      'subm'     : [
         { 'name': f'0.92601','weight':+0.07 },
         { 'name': f'0.92620','weight':+0.14 },
         { 'name': f'0.92638','weight':+0.21 },
         { 'name': f'0.92640','weight':+0.25 },
         { 'name': f'0.92643','weight':+0.33 },]
}

df_cross54 = h_blend(params,color='red54',figures1=True,figures2=True,details=True)
...
params = {
      ...
      'id_target': ['id',"loan_paid_back"],          
      'type_sort': ['asc/desc', 0.30,0.70],
      'subwts'   : [ +0.14, -0.01,-0.05,-0.08 ],
      'subm'     : [
         { 'name': f'0.92601','weight':+0.19 },
         { 'name': f'0.92638','weight':+0.26 },
         { 'name': f'0.92640','weight':+0.27 },
         { 'name': f'0.92643','weight':+0.28 },]
}

df_cross = h_blend(params,color='red55',figures1=True,figures2=True,details=True)
