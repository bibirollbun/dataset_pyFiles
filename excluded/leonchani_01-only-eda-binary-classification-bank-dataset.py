...
df_train = pd.read_csv('/kaggle/input/playground-series-s5e8/train.csv') # importing 'train' data
df_test = pd.read_csv('/kaggle/input/playground-series-s5e8/test.csv')   # importing 'test' data
