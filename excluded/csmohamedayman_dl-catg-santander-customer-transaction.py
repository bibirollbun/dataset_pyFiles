...
dir_path = '/kaggle/input/santander-customer-transaction-prediction'
...
train, _ = drop_id_feature(train, 'ID_code')
test, test_id = drop_id_feature(test, 'ID_code')
...
selected_features_by_variance_threshold = variance_threshold_selector(train_model3, 0.5)
...
selected_features = set(selected_features_by_variance_threshold) & selected_features_by_significance & selected_features_by_model
...
selected_features_by_variance_threshold = variance_threshold_selector(train_model6, 0.5)
print(f'selected_features_by_variance_threshold are {len(selected_features_by_variance_threshold)} features\n{selected_features_by_variance_threshold}')
