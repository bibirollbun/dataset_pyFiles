...
#     'colsample_bytree': uniform(0.5, 0.4), # Samples from 0.5 to 0.9
...
model = XGBRegressor(
    n_estimators=100000, 
    learning_rate=0.013644365130309945,
    max_depth=5,               # Adjust tree depth
    min_child_weight=2,        # Tune to control overfitting
    subsample=0.754158648386226,             # Fraction of samples used per tree
    colsample_bytree=0.5403112005509707,      # Fraction of features used per tree
    reg_alpha=0.3365542148887265,             # L1 regularization
    reg_lambda=1.3114452707614843,            # L2 regularization
