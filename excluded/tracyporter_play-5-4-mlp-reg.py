...
train.drop(columns=['id','Episode_Length_minutes','Guest_Popularity_percentage'], inplace=True)
test.drop(columns=['id','Episode_Length_minutes','Guest_Popularity_percentage'], inplace=True)
...
model = MLPRegressor(activation='relu',random_state=42, max_iter=2000, tol=0.1).fit(X_train, y_train)
