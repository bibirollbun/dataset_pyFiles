...
file_path = '/kaggle/input/ai-safety-verification-dataset/Moonshot Data/Datasets Categorized/Jailbreaks/bipia/bipia-abstract-train.json'
...
bipia_abstract_train_df = pd.DataFrame(data['examples'], columns=['input', 'target'])


file_path = '/kaggle/input/ai-safety-verification-dataset/Moonshot Data/Datasets Categorized/Jailbreaks/bipia/bipia-email-train.json'
...
#print(type(data['examples']))
bipia_email_train_df = pd.DataFrame(data['examples'], columns=['input', 'target'])


file_path = '/kaggle/input/ai-safety-verification-dataset/Moonshot Data/Datasets Categorized/Jailbreaks/bipia/bipia-table-train.json'
...
#print(type(data['examples']))
bipia_table_train_df = pd.DataFrame(data['examples'], columns=['input', 'target'])


file_path = '/kaggle/input/ai-safety-verification-dataset/Moonshot Data/Datasets Categorized/Jailbreaks/bipia/bipia-news.json'
...
#print(type(data['examples']))
bipia_news_df = pd.DataFrame(data['examples'], columns=['input', 'target'])


# Input prompt
prompt = bipia_news_df.iloc[0, 0]
...
datasets = [bipia_abstract_train_df, bipia_email_train_df , bipia_table_train_df, bipia_news_df]
len(datasets)
...
dataset_names = ["bipia_abstract_train_df", "bipia_email_train_df" , "bipia_table_train_df", "bipia_news_df"]
