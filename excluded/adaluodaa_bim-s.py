...
for B in [ 2**9, 2**10,2**11,2**12,2**13,2**14,2**15,2**16,2**17,2**18 ] :
    #B=2
    print(f'******************************************************************************************')
    print(f'***********************B = {B}************************************************************')
    for j in [0, 1,2,3,4,5]:
        ...
        print(f'_________________________ {j} _____ len: {len(word_list)}______B = {B}______________________________________________')
...
summs=0
for j in [0,1,2,3,4,5]:
           text = " ".join(s2.split('\n')[j].split(" ")  )   #  " ".join(num_to_word( batch_states[0]  ).split(" ")[0:10]) #num_to_word(batch_states[1] )
           ...
           with torch.no_grad():
                ...
                summs+=math.exp(loss_list)
           print(j,loss_list, math.exp(loss_list),  len(text.split(" ")))    
print(summs/6)                
