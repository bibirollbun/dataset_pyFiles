...
X[num_cols] = selector.fit_transform(X[num_cols])
X_test[num_cols] = selector.transform(X_test[num_cols])
...
x = layers.Dense(1024, activation='selu', kernel_regularizer=regularizers.l2(0.0001))(inputs)
x = layers.BatchNormalization()(x)
x = layers.Dropout(0.3)(x)
x = layers.Dense(512, activation='selu', kernel_regularizer=regularizers.l2(0.0001))(x)
x = layers.BatchNormalization()(x)
x = layers.Dropout(0.3)(x)
x = layers.Dense(256, activation='selu', kernel_regularizer=regularizers.l2(0.0001))(x)
x = layers.BatchNormalization()(x)
x = layers.Dropout(0.2)(x)
x = layers.Dense(128, activation='selu', kernel_regularizer=regularizers.l2(0.0001))(x)
x = layers.BatchNormalization()(x)
x = layers.Dropout(0.2)(x)
...
model.compile(optimizer=keras.optimizers.AdamW(learning_rate=0.005),
...
model.fit(X_processed, y_full_cat, epochs=150, batch_size=256, verbose=1)
