...
#to ignore warnings that we may see in the code 
...
sns.scatterplot(data=df, x='image_width', y='is_tma', hue='label', palette='Set2')
plt.title('Scatter Plot of image width vs is tma')
plt.show()
assert 'image_width' in df.columns and 'is_tma' in df.columns, "Ensure 'image_width' and 'is_tma' columns exist in the dataset"
...
plt.show()
assert 'is_tma' in df.columns, "Ensure 'is_tma' exists in the dataset"
