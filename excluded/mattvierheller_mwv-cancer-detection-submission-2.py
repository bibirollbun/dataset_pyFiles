...
cnn_model = keras.models.load_model('/kaggle/input/cnn-model-3/Cancer_detection_cnn_model_3.h5')
cnn_model.summary()
...
cancer_submission.to_csv('cancer_detection_submission_data_aug.csv', index = False, header = True)
