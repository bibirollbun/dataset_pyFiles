...
model = PawpularModel()
model = Tez(model)
model.load(f"/kaggle/input/k/kooldrip/training-petfinder-my-pawpularity-contest/model_f0.bin", weights_only=True)
# model.load(f"/kaggle/input/resnet50v0/pytorch/default/1/model_f{i}.bin", weights_only=True)
