...
df_train = pd.read_csv('/kaggle/input/playground-series-s5e7/train.csv') # importing 'train' data
df_test = pd.read_csv('/kaggle/input/playground-series-s5e7/test.csv')   # importing 'test' data
...
# df_train_tmp
df_train_tmp = df_train.drop(['id'], axis=1)
df_train_tmp['Stage_fear'] = df_train_tmp['Stage_fear'].replace(mapping)
df_train_tmp['Drained_after_socializing'] = df_train_tmp['Drained_after_socializing'].replace(mapping)
