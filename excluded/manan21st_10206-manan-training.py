...
import pandas as pd
import numpy as np
train = pd.read_csv('/kaggle/input/folddata/train_5folds.csv')
train.head()
...
for kfold in range(kfolds):
    ...
    # -------- SAVE ONLY ONCE PER FOLD --------
    save_path = f"/kaggle/working/manan_gru_classifier_best_{kfold}.pth"
    torch.save(best_state, save_path, _use_new_zipfile_serialization=False)
