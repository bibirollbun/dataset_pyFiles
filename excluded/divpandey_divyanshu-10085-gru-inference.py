...
train = pd.read_csv('/kaggle/input/10085-divyansh-creating-folds-lmsysn/train_5folds.csv')
final_df.head()
...
for kfold in range(kfolds):
    ...
    model_path = f"/kaggle/input/divyanshu-10085-gru-training/gru_classifier_kfold_{kfold}epoch{epoches_to_use[kfold]}.pth"
