...
class ResNetEncoder(nn.Module):
    def __init__(self, architecture='resnet34', pretrained=False):
...
class SimCLR(nn.Module):
    def __init__(self, architecture='resnet50', projection_dim=128):
        super(SimCLR, self).__init__()
        self.encoder = ResNetEncoder(architecture=architecture, pretrained=True)
...
def main_skip_pretrain():
    """Main function to run fine-tuning only with raw ResNet50 encoder"""
    print("="*60)
    print("SIMCLR PIPELINE: FINE-TUNING WITH RAW RESNET50 ENCODER")
    print("="*60)
