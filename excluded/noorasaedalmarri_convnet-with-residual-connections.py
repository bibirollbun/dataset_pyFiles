...
# =====================
# Custom ResNet-like Model for CIFAR-10
# =====================
...
if __name__ == "__main__":
    ...
    x = torch.randn(1, 3, 32, 32)  # CIFAR-10 input shape
    y = model(x)
...
viz_model = draw_graph(model, input_size=(1, 3, 32, 32), expand_nested=True)
viz_model.visual_graph.render("CustomResNet", format="png")  # saves image
