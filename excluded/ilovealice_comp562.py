...
# Current best run id: fresh-sweep-11 or electric-sweep-47 (we will round some of the found hyperparameters for easier reading)
...
CONFIG = {
    ...
    "run_name": "ast-cosine-warmup-mix-up-crop-noise-mask-aug", # for wandb logging
    ...
    "time_shift_pct": 0.0,  # Fraction of the audio length to shift
    "add_noise": True,      # Whether to add noise
    "noise_std": 1e-3,      # Standard deviation of the noise
    # "freq_mask_frac": 0.09, # Fraction of frequency bins to mask
    # "time_mask_frac": 0.05, # Number of time steps to mask
...
CONFIG["freq_mask_param"] = 48
CONFIG["time_mask_param"] = 192
