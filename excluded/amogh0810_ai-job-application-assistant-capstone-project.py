...
try:
    ...
    print(
        f"ðŸ”‘ Auth Error: Please make sure you have added 'GOOGLE_API_KEY' to your Kaggle secrets. Details: {e}")
...
job_description = pdf_to_string("/kaggle/input/jd-resume/Python-Lead-Dev.pdf")
resume = pdf_to_string("/kaggle/input/resume/Python_Lead_Developer_Resume.pdf")
