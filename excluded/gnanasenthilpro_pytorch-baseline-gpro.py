...
if TRAIN == False:
    MODEL_PATH = '/kaggle/input/artifacts/trained_model.pth'
    SCALER_PATH = '/kaggle/input/artifacts/standard_scaler.pkl'
    LABEL_MAP_PATH = '/kaggle/input/artifacts/label_map.json'
