...
#val: "images/val" 
#test: "images/val" 
with open("yolo_scs.yaml", "w") as f:
    f.write('path: "/kaggle/working/data_fold0"\n')
    f.write('train: "images/train"\n')
    f.write('val: "images/val"\n')
    f.write('test: "images/val"\n')
    f.write("names:\n")
    f.write("    0: left_subarticular_stenosis_l1_l2_normal/mild\n")
    f.write("    1: left_subarticular_stenosis_l1_l2_moderate\n")
    f.write("    2: left_subarticular_stenosis_l1_l2_severe\n")
    f.write("    3: left_subarticular_stenosis_l2_l3_normal/mild\n")
    f.write("    4: left_subarticular_stenosis_l2_l3_moderate\n")
    f.write("    5: left_subarticular_stenosis_l2_l3_severe\n")
    f.write("    6: left_subarticular_stenosis_l3_l4_normal/mild\n")
    f.write("    7: left_subarticular_stenosis_l3_l4_moderate\n")
    f.write("    8: left_subarticular_stenosis_l3_l4_severe\n")
    f.write("    9: left_subarticular_stenosis_l4_l5_normal/mild\n")
    f.write("    10: left_subarticular_stenosis_l4_l5_moderate\n")
    f.write("    11: left_subarticular_stenosis_l4_l5_severe\n")
    f.write("    12: left_subarticular_stenosis_l5_s1_normal/mild\n")
    f.write("    13: left_subarticular_stenosis_l5_s1_moderate\n")
    f.write("    14: left_subarticular_stenosis_l5_s1_severe\n")
    f.write("    15: right_subarticular_stenosis_l1_l2_normal/mild\n")
    f.write("    16: right_subarticular_stenosis_l1_l2_moderate\n")
    f.write("    17: right_subarticular_stenosis_l1_l2_severe\n")
    f.write("    18: right_subarticular_stenosis_l2_l3_normal/mild\n")
    f.write("    19: right_subarticular_stenosis_l2_l3_moderate\n")
    f.write("    20: right_subarticular_stenosis_l2_l3_severe\n")
    f.write("    21: right_subarticular_stenosis_l3_l4_normal/mild\n")
    f.write("    22: right_subarticular_stenosis_l3_l4_moderate\n")
    f.write("    23: right_subarticular_stenosis_l3_l4_severe\n")
    f.write("    24: right_subarticular_stenosis_l4_l5_normal/mild\n")
    f.write("    25: right_subarticular_stenosis_l4_l5_moderate\n")
    f.write("    26: right_subarticular_stenosis_l4_l5_severe\n")
    f.write("    27: right_subarticular_stenosis_l5_s1_normal/mild\n")
    f.write("    28: right_subarticular_stenosis_l5_s1_moderate\n")
    f.write("    29: right_subarticular_stenosis_l5_s1_severe\n")

with open('yolo_scs.yaml', 'r') as f:
    print(f.read())
