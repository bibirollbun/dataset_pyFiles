...
def enumerate_weights():
    ...
    # list_A = [0.515,0.516,0.517,0.518,0.519,0.520,0.521,0.522,0.523]
    # list_B = [0.174,0.175,0.176,0.177,0.178,0.179,0.180,0.181,0.182]
    
    # enumeration.scheme.2 LB = ?
    # list_A = [0.528,0.529,0.530,0.531,0.532]
    # list_B = [0.179,0.180,0.181,0.182,0.182]

    # enumeration.scheme.3 LB = ?
    # list_A = [0.510,0.520,0.530,0.540,0.550]
    # list_B = [0.170,0.180,0.190,0.200,0.210]
...
def predict(sequence, demographics):
    ...
    wts,da_w,c_w  = [0.268, 0.343, 0.388], [0.70, 0.30], [+0.0021,-0.00055,-0.00155]
        ...
        for j in range(len(list_avgs__sort_at__max_v)):
            for k in range(len(list_avgs__sort_at__cm_123)):
                ...
                if i_cm_12==j_max_v==k_cm_123:
                    list9.append(list_avgs__sort_at__cm_123[k])
                if len(list9)==9: break
            if len(list9)==9: break
        if len(list9)==9: break

    # average vote

    preds = np.array([list9[i]['avg_p'] for i in range(len(list9))])
