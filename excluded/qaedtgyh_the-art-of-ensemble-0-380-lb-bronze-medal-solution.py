...
with torch.no_grad():
    predictions3 = resnet(X_tensor).numpy()
predictions3 /= 10000
predictions3
...
class SubmissionGenerator:
    ...
    def create(self, predictions1, predictions, predictions3, sigma_fgs=None, sigma_air=None):
        ...
        submission_df.iloc[:, 0] = predictions3
...
# 'predictions1' is the output from Model 1
# 'predictions2' is the output from Model 2
...
submission = submission_generator.create(final_predictions, predictions, predictions3, sigma_fgs=sigma_fgs_vec, sigma_air=sigma_air_vec)
