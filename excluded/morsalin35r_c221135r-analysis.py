...
df = pd.read_csv("/kaggle/input/ml-dataset/train_dataset.csv")
...
train_df = pd.read_csv("/kaggle/input/ml-dataset/train_dataset.csv")
test_df = pd.read_csv("/kaggle/input/ml-dataset/test_dataset_exam.csv")
