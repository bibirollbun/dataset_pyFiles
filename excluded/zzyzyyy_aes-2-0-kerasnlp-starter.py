...
df = pd.read_csv(f'/kaggle/input/new-data/test.csv') 


BASE_PATH = '/kaggle/input/learning-agency-lab-automated-essay-scoring-2'


BASE_PATH = '/kaggle/input/new-data'


# Load data
df = pd.read_csv(f'/kaggle/input/new-data/train.csv')  # Read CSV file into a DataFrame
...
for i in range(5):
    ...
    print(f"â�“ Text {i+1}:\n{text[:150]} .... {text[-150:]}\n")
    print(f"âœ… True: {true_answer}\n")
    print(f"ğŸ¤– Predicted: {pred_answer}\n")
    print("-" * 90, "\n")



# # Train Data
test_df = pd.read_csv(f"/kaggle/input/new-data/test.csv")
