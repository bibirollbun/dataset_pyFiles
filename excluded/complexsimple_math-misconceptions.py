...
print()
display( Latex(train.text.values[0]) )


lengths = [len(tokenizer.encode(t, truncation=False)) for t in train["text"]]
import matplotlib.pyplot as plt

plt.hist(lengths, bins=50, color='magenta')
plt.title("Token Length Distribution", color='blue')
plt.xlabel("Number of tokens", color='green')
