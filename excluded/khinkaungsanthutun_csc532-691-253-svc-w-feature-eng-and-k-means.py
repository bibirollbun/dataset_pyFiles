...
# Load the dataset
train_df = pd.read_csv("/kaggle/input/playground-series-s5e3/train.csv")  # Replace with actual file path if needed

# Select features for clustering (excluding ID and target variable if applicable)
