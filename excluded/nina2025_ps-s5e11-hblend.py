...
def color_scheme(dk,color):
    ...
    clr_Red53 = ['darkgray','gray','dimgray','crimson',"crimson"]
...
# ------------------------------------------------------------------------
    def read(dk,i):
        ...
        return pd.read_csv(FiN).rename(columns={
            'target':tnm, 'pred':tnm, 'loan_paid_back_proba':tnm,dk["target"]:tnm})
...
df_cross = h_blend(params,color='red52',figures1=True,figures2=True,details=True)
