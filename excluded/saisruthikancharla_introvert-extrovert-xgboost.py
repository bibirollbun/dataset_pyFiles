...
models={
    ...
    "XGBoost":XGBClassifier(max_depth=4,learning_rate=0.01,n_estimators=1000,subsample=0.8,colsample_bytree= 0.8),
...
xgb= XGBClassifier(max_depth=4,learning_rate=0.1,n_estimators=200,subsample=0.4,colsample_bytree= 0.8)
xgb.fit(x_train,y_train)
y_test_pred=xgb.predict(test.iloc[:,:-1])
