...
base_learners = [
    ('rf', RandomForestRegressor(n_estimators=150, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, n_jobs=-1)),
    ('xgb', xgb.XGBRegressor(n_estimators=150, max_depth=8, learning_rate=0.1, random_state=42, n_jobs=-1)),
]
