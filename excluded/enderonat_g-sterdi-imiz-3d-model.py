...
# spectrogram_from_eeg(eeg_path+"/"+os.listdir(eeg_path)[3]).shape
...
unique_eeg_ids_df = unique_eeg_ids_df
...
def predict_for_eeg_id(model, eeg_id, spectrogram_from_eeg, class_mapping=None):
    """
...
predict_for_eeg_id(model,2292521648		,spectrogram_from_eeg)
