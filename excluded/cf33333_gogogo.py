...
temperature = 0.713    # Higher temperature = more random/creative outputs
top_p = 0.703         # Nucleus sampling parameter for more diverse outputs (1.0 disables filtering)
