...
try:
    ...
    # GOOGLE_APPLICATION_CREDENTIALS = UserSecretsClient().get_secret("GOOGLE_APPLICATION_CREDENTIALS")
    # os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = SESSION_DB_URL
...
memory_service = VertexAiMemoryBankService(
    project="project-52f530b5-d60c-4b3c-bd0",
    location="us-central1",
    agent_engine_id="1754130064628252672"
)
...
await run_session(runner, "hello, I am Cristian, Is there any task related to improve performance and which project does it belong to?", "conversation-01")
