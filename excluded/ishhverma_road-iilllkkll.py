...
weights = {
    "/kaggle/input/predicting-road-accident-risk-vault/autogluon15.csv": 0.87,
    "/kaggle/input/predicting-road-accident-risk-vault/submission.csv": 0.25,
    "/kaggle/input/predicting-road-accident-risk-vault/submission (1).csv": 0.15,
}
