...
report_image = "https://raw.githubusercontent.com/DeepLumiere/MedOCR/main/labimage.png"
...
if ',' in raw_test_list_output:
    ...
    for line in raw_test_list_output.split('\n'):
        ...
        if clean_line and (clean_line.startswith(('* ', '- ', 'â€¢ ')) or (clean_line[0].isdigit() and '. ' in clean_line[:3])):
