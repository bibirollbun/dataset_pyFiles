...
# Defining a function to quickly check the amount if images in each category directory
...
# torch.manual_seed(42)
# display_images_from_dataloader(val_dataloader, cat_names_list)
...
model_results = train_model(model, train_dataloader, val_dataloader, criterion, accuracy_fn, optimiser, num_epochs=10)
