...
preprocessor = joblib.load('/kaggle/input/aa-ieee-models-num-only-v01/ieee_processor.joblib')
model = joblib.load('/kaggle/input/aa-ieee-models-num-only-v01/ieee_final_model_rf_01.joblib')
print(type(model))
...
print(num_features[:50])


x_test = preprocessor.transform(test[num_features])
print(x_test.shape)
