...
# Xval_images_preprocessed = preprocess_input(Xval_images.astype(np.float32))
# validation_data = ([Xval_images_preprocessed, Xval_metadata.astype(np.float32)], y_val)
...
base_model.load_weights("/kaggle/input/efficientnet-weights/efficientnetb3_weights.weights.h5")
...
# rmse = np.sqrt(mean_squared_error(y_val * 100, preds))
# rmse
