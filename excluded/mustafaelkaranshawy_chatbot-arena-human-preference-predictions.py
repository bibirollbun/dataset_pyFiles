...
test_df = pd.read_csv("/kaggle/input/lmsys-chatbot-arena/test.csv")Chatbot Arena Human Preference Predictions
...
class Config:
    gemma_dir = kagglehub.model_download("seguride/gemma-2-9b-it-bnb-4bit-unsloth/transformers/default")
    lora_dir = kagglehub.model_download("seguride/gemma2-9b-it-bnb-4bit-lora-tune/transformers/default")
    max_length = 2048
    batch_size = 4
