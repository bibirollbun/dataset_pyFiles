...
def main() -> None:
    ...
    parser.add_argument("--min-len", type=int, default=10, help="Minimum segment/window length (frames)")
    parser.add_argument("--gap-close", type=int, default=5, help="Merge same-action gaps up to this many frames")
    parser.add_argument("--p-min", type=float, default=0.03, help="Rare-action min prior threshold")
    parser.add_argument("--cap", type=float, default=0.02, help="Rare-action maximum share if below p-min")
...
!python baseline.py --mode validate --prior-scope mixed --eps 12 -vv
