...
#train_df=train.drop(['id','day','maxtemp','mintemp','winddirection','rainfall'],axis=1)

#y=train['rainfall']
#選んだのはpressure, maxtemp, temparature, mintemp, dewpoint, humidity, cloud, sunshine


#学習に 'winddirection' を含める
# 'id', 'day', 'maxtemp', 'mintemp' は相関や冗長性を考慮して削除
train_df = train.drop(['id', 'day', 'maxtemp', 'mintemp', 'rainfall'], axis=1)
test_df = test.drop(['id', 'day', 'maxtemp', 'mintemp'], axis=1)


#test_df=test.drop(['id','day','maxtemp','mintemp','winddirection'],axis=1)
