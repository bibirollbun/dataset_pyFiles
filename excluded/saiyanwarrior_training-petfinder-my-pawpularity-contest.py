...
class PawpularModel(nn.Module):
    def __init__(self):
        ...
        self.model = timm.create_model("eca_nfnet_l1", pretrained=True, in_chans=3)#resnet50#resnet101#eca_nfnet_l1#resnest101e

        self.model.head.fc = nn.Linear(self.model.head.fc.in_features, 512)
