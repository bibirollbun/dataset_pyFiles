...
# ğŸ�… Santa 2024 Evaluation Metric - Step-by-Step Breakdown  This script evaluates submissions by computing **perplexity** scores using a **pre-trained language model**. Let's break it down step by step! ğŸš€  ---

## ğŸ› ï¸� Step 1: Importing Libraries & Setting Up the Environment  The script starts by **importing necessary libraries** and setting up **environment variables**.  ```python
import gc
import os
