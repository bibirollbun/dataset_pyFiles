...
class InMemorySessionService:
    ...
    def __init__(self):
        # mapping: sid -> {"user_id": ..., "created_at": ..., "metadata": ..., "state": {...}}
...
class MockLLMAgent:
    """
    A mocked LLM agent that 'generates' summaries, explanations, quiz questions
    and answers queries. In a real system this would call an LLM API with
    ...
    def explain(self, topic: str, level: str = "intro") -> str:
        return (
            ...
            "This is a concise, learner-friendly explanation covering the main ideas, "
...
class ContentSearchAgent:
    def run(self, topic: str) -> List[Resource]:
        ...
        # Example resources - in a real system we'd query the web or an index
        playlist = "https://www.youtube.com/playlist?list=PLzJwCIvZuAFY-jBJS8-L1FB0dP469vsMG"
        resources = [
            Resource(
...
class StudyCoordinator:
    ...
    def plan_for(self, session_id: str, topics: List[str], weekly_hours: int = 5) -> Dict[str, Any]:
        ...
        results: Dict[str, Any] = {"resources": {}, "flashcards": {}, "quizzes": {}, "informative_queries": {}}
...
if __name__ == "__main__":
    ...
    # show stored session state keys
