...
print(train_df['loan_category'].value_counts())


print(f" Unique Customer Count: {train_df['customerID'].nunique()}")
print(f" Unique Loan Count: {train_df['loanID'].nunique()}")
...
print(f" Birleştirilmiş veri: {all_data.shape}")
...
# Borç veren ile asıl kredi farkı
...
# Log transformations (büyük sayılar için)
...
# Müşteri bazlı özellikler (aggregation)
...
comparison_df = pd.DataFrame({
    ...
    'F1 Score': [v['f1_score'] for v in models_results.values()]
