...
model = ExtraTreesClassifier(n_estimators=1000, class_weight='balanced',random_state=42).fit(X_train,y_train)
...
trees_importances = pd.Series(importances, index=feature_names)
trees_importances.plot.barh()
