...
model = CustomModel()
model = Tez(model)
model.load(f"/kaggle/input/model-f0/model_f0 (1).bin", weights_only=True)
...
dense_features = [
    # Add any tabular features here if you used them during training
]
...
# Optional sigmoid scaling if your model outputs logits
