...
model = joblib.load('/kaggle/input/models/ensemble_model.pkl')


model.estimators[0].feature_names_[289]


df_test


# set(df_test['max_pmts_year_1139T'])
df_test[df_test["max_pmts_year_1139T"] == 2020]
