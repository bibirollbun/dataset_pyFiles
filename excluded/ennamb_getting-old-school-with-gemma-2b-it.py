...
class Model:
    def __init__(self):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(
            ...
            max_memory={"cuda:0": "13GiB"},
        )
        if any(device == "cpu" for device in self.model.hf_device_map.values()):
            raise RuntimeError("Model fallback to CPU detected — check VRAM or quant config.")
        ...
        print(f"Remaining Headroom: {headroom:.2f} GB")
