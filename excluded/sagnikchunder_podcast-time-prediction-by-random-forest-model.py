...
plt.hist(train['Listening_Time_minutes'],bins=60,color='yellow',edgecolor='black')
plt.xlabel('Values')
...
plt.hist(train['Host_Popularity_percentage'],bins=60,color='yellow',edgecolor='black')
plt.xlabel('Values')
plt.ylabel('Frequency')
plt.title('Host popularity percentage Histogram')
plt.show()


plt.hist(train['Genre'],bins=60,color='yellow',edgecolor='black')
plt.xlabel('Values')
...
plt.hist(train['Publication_Day'],bins=60,color='yellow',edgecolor='black')
plt.xlabel('Values')
plt.xticks(rotation=45)
plt.ylabel('Frequency')
...
plt.hist(train['Publication_Time'],bins=60,color='yellow',edgecolor='black')
plt.xlabel('Values')
plt.xticks(rotation=45)
plt.ylabel('Frequency')
...
plt.hist(train['Episode_Sentiment'],bins=60,color='yellow',edgecolor='black')
plt.xlabel('Values')
plt.xticks(rotation=45)
plt.ylabel('Frequency')
...
# Map sentiment values to binary
sentiment_mapping = {"Positive": 1, "Negative": 0}

train["Episode_Sentiment"] = train["Episode_Sentiment"].map(sentiment_mapping)
test["Episode_Sentiment"] = test["Episode_Sentiment"].map(sentiment_mapping)
