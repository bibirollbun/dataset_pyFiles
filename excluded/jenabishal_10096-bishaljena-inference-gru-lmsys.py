...
train = pd.read_csv('/kaggle/input/10103-siddham-creating-folds-lmsys/train_5folds.csv')
final_df.head()
...
for kfold in range(kfolds):
    ...
    model_path = f"/kaggle/input/10103-siddham-training-5fold-lmsys/gru_classifier_kfold_{kfold}_epoch_{epoches_to_use[kfold]}.pth"
