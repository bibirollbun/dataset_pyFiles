...
train = pd.read_csv('/kaggle/input/eda-n-folds-lmsys/train_5folds.csv')
final_df.head()
...
for kfold in range(kfolds):
    ...
    model_loaded.load_state_dict(torch.load(f"/kaggle/input/training-gru-lmsys/lstm_classifier_kfold_{kfold}_epoch_{epoches_to_use[kfold]}.pth", map_location=device))
