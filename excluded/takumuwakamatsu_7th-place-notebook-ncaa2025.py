...
print()
submission_df = set_optimalStrategy(X[['ID','Pred']], mensTeamSeeds2025_df, womensTeamSeeds2025_df, riskTeam, riskTeamToWinRound)
...
submission_df.to_csv('predictions.csv',index=None)
