...
train = pd.read_csv("/kaggle/input/spotify-song-popularity/train.csv")
test = pd.read_csv("/kaggle/input/spotify-song-popularity/test.csv")
submission = pd.read_csv("/kaggle/input/spotify-song-popularity/sample_submission.csv")
