...
up = {
      'path'     : '/kaggle/input/27-november-2025-ps-s5e11/',            
      'id_target': ['id',"loan_paid_back"],          
      'type_sort': ['asc/desc',0.32,0.68 ],
      'subwts'   : [e/150 for e in [11, -1,-3,-7]]
}


params = {'subm' : [
         { 'name': f'11','weight':+0.15, 'color':'orangered'},
         { 'name': f'12','weight':+0.20, 'color':'red'      },
         { 'name': f'13','weight':+0.25, 'color':'crimson'  },
         { 'name': f'14','weight':+0.40, 'color':'firebrick'},]
}
dfr = h_blend(params,_update=up, details=True, subm='g1.csv')
print('\n--------------------------------------------------------------\n')
params = {'subm' : [
         { 'name': f'15','weight':+0.15, 'color':'lime'       },
         { 'name': f'16','weight':+0.20, 'color':'forestgreen'},
         { 'name': f'17','weight':+0.25, 'color':'limegreen'  },
         { 'name': f'18','weight':+0.40, 'color':'darkgreen'  },]
}
dfg = h_blend(params,_update=up, details=True, subm='g2.csv')
print('\n--------------------------------------------------------------\n')
params = {'subm' : [
         { 'name': f'19','weight':+0.15, 'color':'deepskyblue'},
         { 'name': f'44','weight':+0.20, 'color':'royalblue'  },
         { 'name': f'45','weight':+0.25, 'color':'blue'       },
         { 'name': f'46','weight':+0.40, 'color':'mediumblue' },]
}
dfb = h_blend(params,_update=up, details=True, subm='g3.csv')
print('\n--------------------------------------------------------------\n')
...
params = {
      ...
      'id_target': ['id',"loan_paid_back"],          
      'type_sort': ['asc/desc',0.32,0.68 ],
      'subwts'   : [e/150 for e in [10, -3,-7]],
      'subm'     : [
         { 'name': f'g1', 'weight':+0.15, 'color':'red'  },
         { 'name': f'g2', 'weight':+0.30, 'color':'green'},
         { 'name': f'g3', 'weight':+0.55, 'color':'blue' },]
}
df1 = h_blend(params, details=True, subm='1.csv')

for file in 'g1,g2,g3'.split(','): os.remove(f'/kaggle/working/{file}.csv')


params = {'subm' : [
         { 'name': f'21','weight':+0.15, 'color':'orangered' },
         { 'name': f'22','weight':+0.20, 'color':'red'       },
         { 'name': f'23','weight':+0.25, 'color':'crimson'   },
         { 'name': f'24','weight':+0.40, 'color':'firebrick' },]
}
dfr = h_blend(params,_update=up, details=True, subm='g1.csv')
print('\n--------------------------------------------------------------\n')
params = {'subm' : [
         { 'name': f'25','weight':+0.15, 'color':'lime'       },
         { 'name': f'26','weight':+0.20, 'color':'forestgreen'},
         { 'name': f'27','weight':+0.25, 'color':'limegreen'  },
         { 'name': f'28','weight':+0.40, 'color':'darkgreen'  },]
}
dfg = h_blend(params,_update=up, details=True, subm='g2.csv')
print('\n--------------------------------------------------------------\n')
params = {'subm' : [
         { 'name': f'29','weight':+0.15, 'color':'deepskyblue'},
         { 'name': f'47','weight':+0.20, 'color':'royalblue'  },
         { 'name': f'48','weight':+0.25, 'color':'blue'       },
         { 'name': f'49','weight':+0.40, 'color':'mediumblue' },]
}
dfb = h_blend(params,_update=up, details=True, subm='g3.csv')
print('\n--------------------------------------------------------------\n')
...
df2 = h_blend(params, details=True, subm='2.csv')
...
params = {
      'subm'     : [
         { 'name': f'31','weight':+0.15, 'color':'orangered'},
         { 'name': f'32','weight':+0.20, 'color':'red'      },
         { 'name': f'33','weight':+0.25, 'color':'crimson'  },
         { 'name': f'34','weight':+0.40, 'color':'firebrick'},]
}
dfr = h_blend(params,_update=up, details=True, subm='g1.csv')
print('\n--------------------------------------------------------------\n')
params = {
      'subm'     : [
         { 'name': f'35','weight':+0.15, 'color':'lime'       },
         { 'name': f'36','weight':+0.20, 'color':'forestgreen'},
         { 'name': f'37','weight':+0.25, 'color':'limegreen'  },
         { 'name': f'38','weight':+0.40, 'color':'darkgreen'  },]
}
dfg = h_blend(params,_update=up, details=True, subm='g2.csv')
print('\n--------------------------------------------------------------\n')
params = {
      'subm'     : [
         { 'name': f'39','weight':+0.15, 'color':'deepskyblue'},
         { 'name': f'41','weight':+0.20, 'color':'royalblue'  },
         { 'name': f'42','weight':+0.25, 'color':'blue'       },
         { 'name': f'43','weight':+0.40, 'color':'mediumblue' },]
}
dfb = h_blend(params,_update=up, details=True, subm='g3.csv')
print('\n--------------------------------------------------------------\n')
...
df3 = h_blend(params, details=True, subm='3.csv')
...
params = {
      ...
      'subwts'   : [e/200 for e in [10, -3,-7]],
      'subm'     : [
         { 'name': f'1', 'weight':+0.50, 'color':'red'  },
         { 'name': f'2', 'weight':+0.30, 'color':'green'},
         { 'name': f'3', 'weight':+0.20, 'color':'blue' },]
}
df = h_blend(params, details=True)

for file in '1,2,3'.split(','): os.remove(f'/kaggle/working/{file}.csv')
