...
# using free models in this example. 
# they seem to hallucinate references more often
# perplexity/sonar-deep-research
# seems to do better in that regard but is an expensive model to run. 
...
# I removed the instruction about references as many seems hallucination. 
