...
!/kaggle/working/mmseqs/bin/mmseqs createdb /kaggle/input/stanford-rna-3d-folding/PDB_RNA/pdb_seqres_NA.fasta pdb_seqres_NA --dbtype 2 # > MMseqs_createDB.log


import csv
input_file='/kaggle/input/stanford-rna-3d-folding/test_sequences.csv'
...
sequences_file = '/kaggle/input/stanford-rna-3d-folding/test_sequences.csv'
