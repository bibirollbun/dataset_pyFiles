...
# modules -.外掛程式別人寫好好用的class/function
...
#   #  data['Age']=(data['Age']*100).astype(np.uint16)
#    # data['Height']=(data['Height']*100).astype(np.uint16)
...
#     data['NCP']=round(data['NCP']).astype('int')
...
# 建立 bagging  decision trees models -random forest models
# 2. 使用訓練資料進行模型訓練
