...
params={'n_estimators': 977, 'max_depth': 10, 'learning_rate': 0.012597466163562209, 'subsample': 0.6656557872047859, 'colsample_bytree': 0.9935036287719694, 'gamma': 4.960553357629705, 'min_child_weight': 5}
model=XGBRegressor(**params,random_state=42,n_jobs=-1)
...
submission_df.to_csv('csubmission10.csv',index=False)
from IPython.display import FileLink

FileLink("csubmission10.csv")
