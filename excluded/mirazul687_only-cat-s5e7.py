...
for fold, (train_idx, val_idx) in enumerate(kf.split(X, y), 1):
    ...
    print(f"Fold {fold} Accuracy: {accuracy_score(y_val, val_preds):.4f}")

print(f"\nFinal OOF Accuracy: {accuracy_score(y, oof_preds):.4f}")
...
print("✅ Submission saved as 'submission_cat.csv'")
