...
# 1) Prepare a 4-bit quantization config
bnb_config = BitsAndBytesConfig(
    load_in_4bit=True,
    bnb_4bit_quant_type="nf4",           # best tradeoff of speed & accuracy
...
base_model = AutoModelForSequenceClassification.from_pretrained(
    "/kaggle/input/gemma2-9b-it-cv945",
    quantization_config=bnb_config,
    device_map="auto",
)

# 4) Wrap with your LoRA adapter
