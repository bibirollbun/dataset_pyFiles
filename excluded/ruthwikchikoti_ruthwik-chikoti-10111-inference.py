...
model.load(f"/kaggle/input/ruthwik-chikoti-23bcs10111-petfinder/model_f0.bin", weights_only=True)
# model.load(f"/kaggle/input/resnet50v1/pytorch/default/1/model_f{i} (1).bin", weights_only=True)
# /kaggle/input/ruthwik-chikoti-23bcs10111-petfinder/model_f0.bin
