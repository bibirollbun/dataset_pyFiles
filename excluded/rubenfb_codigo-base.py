...
block_size = 64        # Longitud del contexto (tokens que ve el modelo)
...
batch_size = 32         # NÃºmero de secuencias procesadas simultÃ¡neamente
...
learning_rate = 1e-4   # Tasa de aprendizaje (learning rate)
