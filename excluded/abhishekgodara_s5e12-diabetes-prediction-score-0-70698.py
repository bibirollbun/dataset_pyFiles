...
params = {
      ...
      'subm'     : [
          {'name': f'0.70442.cat', 'weight':+0.07, 'color':'royalblue'},
          {'name': f'0.70442.lgbm','weight':+0.07, 'color':'orange'   },
          {'name': f'0.70442.xgb', 'weight':+0.04, 'color':'green'    },
          {'name': f'0.70651',     'weight':+0.82, 'color':'crimson'  },]
}
df = h_blend(params, details=True, subm='submission.csv')
