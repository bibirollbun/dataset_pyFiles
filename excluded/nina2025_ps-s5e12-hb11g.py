...
def display_distances(params):
    ...
    if len(files)==3:
        ...
        _0_70_37_ = '0.70371' if '0.70371' in files[2] else '0.70370'
        _0_70____ = '0.70356' if '0.70356' in files[1] else '0.70164'
        ...
        ax[0,0].set_title(f'0.70072 - {_0_70____}')
        sns.kdeplot(df13[f'{target}_1'], label='', fill=True, ax=ax[0,1])
        sns.kdeplot(df13[f'{target}_3'], label='', fill=True, ax=ax[0,1])
        ax[0,1].set_title(f'0.70072 - {_0_70_37_}')
        sns.kdeplot(df23[f'{target}_2'], label='', fill=True, ax=ax[0,2])
        sns.kdeplot(df23[f'{target}_3'], label='', fill=True, ax=ax[0,2])
        ax[0,2].set_title(f'{_0_70____} - {_0_70_37_}')
        sns.scatterplot(x=f'{target}_1', y=f'{target}_2', data=df12.sample(300_000), ax=ax[1,0], alpha=0.3)
        ax[1,0].plot([0,1],[0,1],'r--')
        sns.scatterplot(x=f'{target}_1', y=f'{target}_3', data=df13.sample(300_000), ax=ax[1,1], alpha=0.3)
        ax[1,1].plot([0,1],[0,1],'r--')
        sns.scatterplot(x=f'{target}_2', y=f'{target}_3', data=df23.sample(300_000), ax=ax[1,2], alpha=0.3)
...
params = {
      'path'     : f'/kaggle/input/10-december-2025-ps-s5e12/',            
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/100 for w in [ +3, -1,-2 ]],
      'subm'     : [
         { 'name': f'0.70072', 'weight':+0.10, 'color':'limegreen'  },
         { 'name': f'0.70164', 'weight':+0.20, 'color':'darkmagenta'},
         { 'name': f'0.70370', 'weight':+0.70, 'color':'red' },]
}
df1 = h_blend(params, details=True)
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/100 for w in [ +4, -1.5, -2.5 ]],
      'subm'     : [
         { 'name': f'0.70072', 'weight':+0.08, 'color':'limegreen'  },
         { 'name': f'0.70164', 'weight':+0.12, 'color':'darkmagenta'},
         { 'name': f'0.70371', 'weight':+0.80, 'color':'red' },]
}
df2 = h_blend(params, details=True)
...
#       'id_target': ['id',"diagnosed_diabetes"],          
#       'type_sort': ['asc/desc',0.30,0.70 ],
#       'subwts'   : [w/100 for w in [ +4.5, -1.5, -3.0 ]],
#       'subm'     : [
#          { 'name': f'0.70072', 'weight':+0.10, 'color':'limegreen'  },
#          { 'name': f'0.70164', 'weight':+0.05, 'color':'darkmagenta'},
#          { 'name': f'0.70371', 'weight':+0.85, 'color':'red' },]
# }
# df3 = h_blend(params, details=True)
...
#       'subm'     : [
#          { 'name': f'0.70072', 'weight':+0.10, 'color':'limegreen'  },
#          { 'name': f'0.70356', 'weight':+0.35, 'color':'darkmagenta'},
#          { 'name': f'0.70371', 'weight':+0.55, 'color':'red' },]
# }
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/200 for w in [ +8,+5, 0, -2,-4,-7 ]],
      'subm'     : [
         { 'name': f'0.70072', 'weight':+0.07, 'color':'limegreen'  },
         { 'name': f'0.70164', 'weight':+0.09, 'color':'magenta'    },
         { 'name': f'0.70165', 'weight':+0.15, 'color':'royalblue'  },
         { 'name': f'0.70175', 'weight':+0.12, 'color':'darkmagenta'},
         { 'name': f'0.70356', 'weight':+0.52, 'color':'darkorchid' },
         { 'name': f'0.70370', 'weight':+0.05, 'color':'mediumvioletred'},]
}
