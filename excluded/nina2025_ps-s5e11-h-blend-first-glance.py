...
params = {
      ...
      'id_target': ['id',"loan_paid_back"],          
      'type_sort': ['asc/desc',0.35,0.65 ],
      'subwts'   : [ +0.07,+0.04,+0.01, 0, -0.01,-0.04,-0.07 ],
      'subm'     : [
         { 'name': f'0.92601','weight':+0.10 },
         { 'name': f'0.92640','weight':+0.14 },
         { 'name': f'0.92643','weight':+0.14 },
         { 'name': f'0.92655','weight':+0.14 },
         { 'name': f'0.92672','weight':+0.14 },
         { 'name': f'0.92683','weight':+0.14 },
         { 'name': f'0.92684','weight':+0.20 },
      ]
}
...
df_cross = h_blend(params, color='tes51', figures1=True, figures2=True, details=True)
...
params = {
      ...
      'id_target': ['id',"loan_paid_back"],          
      'type_sort': ['asc/desc',0.35,0.65 ],
      'subwts'   : [ -0.01,+0.04,+0.07,-0.03,-0.07 ],
      'subm'     : [
         #{ 'name': f'0.92601','weight':+0.20 },
         { 'name': f'0.92640','weight':+0.20 },
         { 'name': f'0.92643','weight':+0.20 },
...
df_cross = h_blend(params, color='tes52', figures1=True, figures2=True, details=True)
...
df_cross = h_blend(params, color='tes53', figures1=True, figures2=True, details=True)
