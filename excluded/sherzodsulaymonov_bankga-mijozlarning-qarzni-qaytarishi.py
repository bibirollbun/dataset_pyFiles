...
# takrorlangan(duplikated qiymatlarni tekshiramiz)
train.duplicated().sum() 


# matinli ustunlarni tekshiramiz
train.Geography.value_counts(), train.Gender.value_counts(), train.Exited.value_counts()
