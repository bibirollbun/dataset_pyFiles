...
class FE:
    ...
    def recalculate_hla_sums(self, df):
        ...
        df = df.with_columns(
            ...
            (pl.col("hla_high_res_8").fill_null(0) + pl.col("hla_low_res_6").fill_null(0)).alias("hla_h1"),

            (pl.col("hla_high_res_8").fill_null(0) + pl.col("hla_high_res_8").fill_null(0)).alias("hla_h2"),
            
            (pl.col("hla_high_res_8").fill_null(0) + pl.col("hla_high_res_6").fill_null(0)).alias("hla_h3"),

            (pl.col("hla_high_res_8").fill_null(0) + pl.col("hla_low_res_8").fill_null(0)).alias("hla_h4"),
            (pl.col("hla_high_res_8").fill_null(0) + pl.col("hla_low_res_10").fill_null(0)).alias("hla_h5"),
            (pl.col("hla_low_res_6").fill_null(0) + pl.col("hla_high_res_8").fill_null(0)).alias("hla_h6"),
            
            (pl.col("hla_low_res_6").fill_null(0) + pl.col("hla_high_res_10").fill_null(0)).alias("hla_h7"),
            (pl.col("hla_low_res_6").fill_null(0) + pl.col("hla_low_res_8").fill_null(0)).alias("hla_h8"),
            (pl.col("hla_low_res_6").fill_null(0) + pl.col("hla_low_res_10").fill_null(0)).alias("hla_h9"),
            (pl.col("hla_low_res_6").fill_null(0) + pl.col("hla_high_res_8").fill_null(0)).alias("hla_h10"),
            (pl.col("hla_high_res_6").fill_null(0) + pl.col("hla_low_res_10").fill_null(0)).alias("hla_h11"),
            (pl.col("hla_high_res_10").fill_null(0) + pl.col("hla_high_res_8").fill_null(0)).alias("hla_h12"),
            (pl.col("hla_high_res_10").fill_null(0) + pl.col("hla_low_res_6").fill_null(0)).alias("hla_h13"),
            (pl.col("hla_high_res_10").fill_null(0) + pl.col("hla_high_res_6").fill_null(0)).alias("hla_h14"),
            (pl.col("hla_high_res_10").fill_null(0) + pl.col("hla_low_res_8").fill_null(0)).alias("hla_h15"),
            (pl.col("hla_high_res_10").fill_null(0) + pl.col("hla_high_res_10").fill_null(0)).alias("hla_h16"),
            (pl.col("hla_match_b_low").fill_null(0) + pl.col("hla_low_res_8").fill_null(0)).alias("hla_h17"),
            (pl.col("hla_low_res_8").fill_null(0) + pl.col("hla_high_res_8").fill_null(0)).alias("hla_h18"),
            (pl.col("hla_low_res_8").fill_null(0) + pl.col("hla_low_res_6").fill_null(0)).alias("hla_h19"),
            (pl.col("hla_low_res_8").fill_null(0) + pl.col("hla_high_res_6").fill_null(0)).alias("hla_h20"),
            (pl.col("hla_low_res_8").fill_null(0) + pl.col("hla_high_res_10").fill_null(0)).alias("hla_h21"),
            (pl.col("hla_low_res_8").fill_null(0) + pl.col("hla_match_b_low").fill_null(0)).alias("hla_h22"),
            (pl.col("hla_low_res_8").fill_null(0) + pl.col("hla_low_res_10").fill_null(0)).alias("hla_h23"),
            (pl.col("hla_low_res_10").fill_null(0) + pl.col("hla_high_res_8").fill_null(0)).alias("hla_h124"),
            (pl.col("hla_low_res_10").fill_null(0) + pl.col("hla_low_res_6").fill_null(0)).alias("hla_h25"),
            (pl.col("hla_low_res_10").fill_null(0) + pl.col("hla_high_res_6").fill_null(0)).alias("hla_h26"),
            (pl.col("hla_low_res_10").fill_null(0) + pl.col("hla_high_res_10").fill_null(0)).alias("hla_h27"),
            (pl.col("hla_low_res_10").fill_null(0) + pl.col("hla_low_res_8").fill_null(0)).alias("hla_h28"),
            (pl.col("hla_high_res_6").fill_null(0) + pl.col("hla_high_res_10").fill_null(0)).alias("hla_h29"),
            (pl.col("hla_high_res_6").fill_null(0) + pl.col("hla_low_res_8").fill_null(0)).alias("hla_h30"),
