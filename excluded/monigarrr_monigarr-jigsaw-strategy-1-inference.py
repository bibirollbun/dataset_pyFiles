...
class CFG:
    ...
    MODELS_TO_RUN = ["deberta-v3-base","roberta-large"]
...
# Load a single tokenizer (they are mostly compatible for this task)
tokenizer = AutoTokenizer.from_pretrained(f"{CFG.MODELS_INPUT_DIR}deberta-v3-base-finetuned/fold0/")
