...
# TabNet
# !pip install --no-index --find-links /kaggle/input/pytorchtabnet/pytorch_tabnet-4.0.0-py3-none-any.whl pytorch-tabnet
!pip install pytorch-tabnet --no-index --find-links=file:///kaggle/input/tabnet/tabnet
# Iterative Stratification
# !pip install /kaggle/input/iterative-stratification/iterative-stratification-master/
!pip install iterative-stratification --no-index --find-links=file:///kaggle/input/d/hiwei6/iterative-stratification/iterative-stratification
...
for fold_nb, (train_idx, val_idx) in enumerate(mskf.split(train_df, targets)):
    ...
    model_path = f"/kaggle/input/moa-overfitting-with-tabnet-py311/tabnet_fold{fold_nb + 1}.zip"
