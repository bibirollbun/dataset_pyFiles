...
# Archive 1 def enumerate_weights():
#     import random
...
#     # # directed        scheme 7
#     # weights30 = {'A': 0.53,  'B': 0.18,   'C': 0.29}

#     #==========================================================
    
#     # directed scheme 7a
#     # wts7a1 = {'A': 0.527,  'B': 0.18+0.003,   'C': 0.29}
#     # wts7a2 = {'A': 0.528,  'B': 0.18+0.002,   'C': 0.29}
#     # wts7a3 = {'A': 0.529,  'B': 0.18+0.001,   'C': 0.29}
    
#     # wts7a4 = {'A': 0.526,  'B': 0.18+0.002,   'C': 0.29+0.002}
    
#     # wts7a5 = {'A': 0.529,  'B': 0.18,         'C': 0.29+0.001}
#     # wts7a6 = {'A': 0.528,  'B': 0.18,         'C': 0.29+0.002}
#     # wts7a7 = {'A': 0.527,  'B': 0.18,         'C': 0.29+0.003}

#     #----------------------------------------------------------
    
#     # directed scheme 7b
#     # wts7b1 = {'A': 0.531,  'B': 0.18-0.001,   'C': 0.29}
#     # wts7b2 = {'A': 0.532,  'B': 0.18-0.002,   'C': 0.29}
#     # wts7b3 = {'A': 0.533,  'B': 0.18-0.003,   'C': 0.29}
    
#     # wts7b4 = {'A': 0.534,  'B': 0.18-0.002,   'C': 0.29-0.002}
    
#     # wts7b5 = {'A': 0.533,  'B': 0.18,         'C': 0.29-0.003}
#     # wts7b6 = {'A': 0.532,  'B': 0.18,         'C': 0.29-0.002}
#     # wts7b7 = {'A': 0.531,  'B': 0.18,         'C': 0.29-0.001}

#     #----------------------------------------------------------
    
#     # directed scheme 7c
#     # wts7c1 = {'A': 0.517,  'B': 0.18+0.013,   'C': 0.29}
#     # wts7c2 = {'A': 0.518,  'B': 0.18+0.012,   'C': 0.29}
#     # wts7c3 = {'A': 0.519,  'B': 0.18+0.011,   'C': 0.29}
    
#     # wts7c4 = {'A': 0.505,  'B': 0.18+0.012,   'C': 0.29+0.013}
    
#     # wts7c5 = {'A': 0.519,  'B': 0.18,         'C': 0.29+0.011}
#     # wts7c6 = {'A': 0.518,  'B': 0.18,         'C': 0.29+0.012}
#     # wts7c7 = {'A': 0.517,  'B': 0.18,         'C': 0.29+0.013}
...
#     # # directed random scheme 5
#     # weights20 = {'A': 0.5315, 'B': 0.1800, 'C': 0.2885}
#     # weights21 = {'A': 0.5321, 'B': 0.1805, 'C': 0.2874}
#     # weights22 = {'A': 0.5325, 'B': 0.1810, 'C': 0.2865}
#     # weights23 = {'A': 0.5330, 'B': 0.1815, 'C': 0.2855}
#     # weights24 = {'A': 0.5335, 'B': 0.1820, 'C': 0.2845}

#     # # directed random scheme 8
#     # weights25 = {'A': 0.5340, 'B': 0.1825, 'C': 0.2835}
#     # weights26 = {'A': 0.5345, 'B': 0.1830, 'C': 0.2825}
#     # weights27 = {'A': 0.5350, 'B': 0.1835, 'C': 0.2815}
#     # weights28 = {'A': 0.5355, 'B': 0.1840, 'C': 0.2805}
#     # weights29 = {'A': 0.5374, 'B': 0.1846, 'C': 0.2780}
...
#     # weights_7 = random.choice([weights30])
#     # weights_4 = random.choice([weights15,weights16,weights17,weights18,weights19])
#     # weights_5 = random.choice([weights20,weights21,weights22,weights23,weights24])
#     # weights_8 = random.choice([weights25,weights26,weights27,weights28,weights29])
        
#     # return weights_1,weights_2,weights_3,weights_4  # LB = 0.854
#     # return           weights_2,weights_3            # LB = 0.854

#     # return weights_1,weights_2,weights_3,weights_4  # in the enumeration function predict 
#                                                      # the values for weights_2 and weights_3 
#                                                      # will be taken
    
#     # return weights_1,weights_7,weights_8,weights_5  # LB = 0.855 < our.LB.0.855.Top  !!!
    
#     #return wts7a1, wts7a2, wts7a3, wts7a4, wts7a5, wts7a6, wts7a7   # v.7
#     #return wts7b1, wts7b2, wts7b3, wts7b4, wts7b5, wts7b6, wts7b7   # v.8
    
#     #return wts7c1, wts7c2, wts7c3, wts7c4, wts7c5, wts7c6, wts7c7   # v.10

#     wts = {'A': 0.53, 'B': 0.18, 'C': 0.29}

#     return wts,wts,wts,wts,wts,wts,wts                             # v.11


# Archive 2 enumerate weights():

# def enumerate_weights():
#     wts = [
#         # {'A': 0.527,  'B': 0.18+0.003,   'C': 0.29},
#         # {'A': 0.528,  'B': 0.18+0.002,   'C': 0.29},
#         # {'A': 0.529,  'B': 0.18+0.001,   'C': 0.29},
#         # {'A': 0.526,  'B': 0.18+0.002,   'C': 0.29+0.002},
#         # {'A': 0.529,  'B': 0.18,         'C': 0.29+0.001},
#         # {'A': 0.528,  'B': 0.18,         'C': 0.29+0.002},
#         # {'A': 0.527,  'B': 0.18,         'C': 0.29+0.003},
#         # {'A': 0.531,  'B': 0.18-0.001,   'C': 0.29},
#         # {'A': 0.532,  'B': 0.18-0.002,   'C': 0.29},
#         # {'A': 0.533,  'B': 0.18-0.003,   'C': 0.29},
#         # {'A': 0.534,  'B': 0.18-0.002,   'C': 0.29-0.002},
#         # {'A': 0.533,  'B': 0.18,         'C': 0.29-0.003},
#         # {'A': 0.532,  'B': 0.18,         'C': 0.29-0.002},
#         # {'A': 0.531,  'B': 0.18,         'C': 0.29-0.001},
#         # {'A': 0.517,  'B': 0.18+0.013,   'C': 0.29},
#         # {'A': 0.518,  'B': 0.18+0.012,   'C': 0.29},
#         # {'A': 0.519,  'B': 0.18+0.011,   'C': 0.29},
#         # {'A': 0.505,  'B': 0.18+0.012,   'C': 0.29+0.013},
#         # {'A': 0.519,  'B': 0.18,         'C': 0.29+0.011},
#         # {'A': 0.518,  'B': 0.18,         'C': 0.29+0.012},
#         # {'A': 0.517,  'B': 0.18,         'C': 0.29+0.013},
#         # {'A': 0.5285, 'B': 0.1770,       'C': 0.2945},
#         # {'A': 0.5290, 'B': 0.1780,       'C': 0.2930},
#         # {'A': 0.5295, 'B': 0.1785,       'C': 0.2920},
#         # {'A': 0.5305, 'B': 0.1790,       'C': 0.2905},
#         # {'A': 0.5310, 'B': 0.1795,       'C': 0.2895},
#         # {'A': 0.5315, 'B': 0.1800,       'C': 0.2885},
#         # {'A': 0.5321, 'B': 0.1805,       'C': 0.2874},
#         # {'A': 0.5325, 'B': 0.1810,       'C': 0.2865},
#         # {'A': 0.5330, 'B': 0.1815,       'C': 0.2855},
#         # {'A': 0.5335, 'B': 0.1820,       'C': 0.2845},
#         # {'A': 0.5340, 'B': 0.1825,       'C': 0.2835},
#         # {'A': 0.5345, 'B': 0.1830,       'C': 0.2825},
#         # {'A': 0.5350, 'B': 0.1835,       'C': 0.2815},
#         # {'A': 0.5355, 'B': 0.1840,       'C': 0.2805},
#         # {'A': 0.5374, 'B': 0.1846,       'C': 0.2780},
#         {'A': 0.53,   'B': 0.18,         'C': 0.29},
#     ]
#     return wts

"""
{'A': 0.500,  'B': 0.185,   'C': 0.274},
{'A': 0.505,  'B': 0.190,   'C': 0.280},
{'A': 0.510,  'B': 0.195,   'C': 0.285},
{'A': 0.515,  'B': 0.200    'C': 0.290},
{'A': 0.520,  'B': 0.205,   'C': 0.295},
{'A': 0.525,  'B': 0.210,  
{'A': 0.530,  
"""
...
# def enumerate_weights():
#     wts = [
#         {'A': 0.500,  'B': 0.180,   'C': 0.320},
#         {'A': 0.500,  'B': 0.185,   'C': 0.315},
#         {'A': 0.500,  'B': 0.190,   'C': 0.310},
#         {'A': 0.500,  'B': 0.195,   'C': 0.305},
#         {'A': 0.500,  'B': 0.200,   'C': 0.300},

#         {'A': 0.505,  'B': 0.180,   'C': 0.315},
#         {'A': 0.505,  'B': 0.185,   'C': 0.310},
#         {'A': 0.505,  'B': 0.190,   'C': 0.305},
#         {'A': 0.505,  'B': 0.195,   'C': 0.300},
#         {'A': 0.505,  'B': 0.200,   'C': 0.295},

#         {'A': 0.510,  'B': 0.180,   'C': 0.310},
#         {'A': 0.510,  'B': 0.185,   'C': 0.305},
#         {'A': 0.510,  'B': 0.190,   'C': 0.300},
#         {'A': 0.510,  'B': 0.195,   'C': 0.295},
#         {'A': 0.510,  'B': 0.200,   'C': 0.290},

#         {'A': 0.515,  'B': 0.180,   'C': 0.305},
#         {'A': 0.515,  'B': 0.185,   'C': 0.300},
#         {'A': 0.515,  'B': 0.190,   'C': 0.295},
#         {'A': 0.515,  'B': 0.195,   'C': 0.290},
#         {'A': 0.515,  'B': 0.200,   'C': 0.285},

#         {'A': 0.520,  'B': 0.180,   'C': 0.300},
#         {'A': 0.520,  'B': 0.185,   'C': 0.295},
#         {'A': 0.520,  'B': 0.190,   'C': 0.290},
#         {'A': 0.520,  'B': 0.195,   'C': 0.285},
#         {'A': 0.520,  'B': 0.200,   'C': 0.280},

#         {'A': 0.525,  'B': 0.180,   'C': 0.295},
#         {'A': 0.525,  'B': 0.185,   'C': 0.290},
#         {'A': 0.525,  'B': 0.190,   'C': 0.285},
#         {'A': 0.525,  'B': 0.195,   'C': 0.280},
#         {'A': 0.525,  'B': 0.200,   'C': 0.275},

#         {'A': 0.530,  'B': 0.180,   'C': 0.290},
#         {'A': 0.530,  'B': 0.185,   'C': 0.285},
#         {'A': 0.530,  'B': 0.190,   'C': 0.280},
#         {'A': 0.530,  'B': 0.195,   'C': 0.275},
#         {'A': 0.530,  'B': 0.200,   'C': 0.270},
#     return wts

# A = [0.500, 0.505, 0.510, 0.515, 0.520, 0.525, 0.530]
# B = [0.180, 0.185, 0.190, 0.195, 0.200]
# # C = 1 - (A + B)

# def proc_wts(list_A, list_B):
#     wts = []
#     for A in list_A:
#         for B in list_B:
...
def enumerate_weights():
    ...
    # enumeration.scheme.1 LB = ?
    list_A = [0.500, 0.505, 0.510, 0.515, 0.520, 0.525, 0.530, 0.535]
    list_B = [0.174, 0.180, 0.185, 0.190, 0.195, 0.200, 0.205, 0.210]
    
    # enumeration.scheme.2 LB = ?
    list_A = [0.530, 0.531, 0.532, 0.533, 0.534, 0.535, 0.536, 0.537, 0.538, 0.539, 0.540]
    list_B = [0.174, 0.177, 0.180, 0.183, 0.185, 0.188, 0.191, 0.195, 0.198, 0.201, 0.204]
...
def predict3(sequence: pl.DataFrame, demographics: pl.DataFrame) -> str:
    ...
    return [
       (wts['A']* copy.deepcopy(avg_pred_A)+ 
        wts['B']* copy.deepcopy(pred_B)    + 
        wts['C']* copy.deepcopy(avg_pred_C)) for wts in enumerate_weights()
    ]
...
def h_blend(pred0,pred1,pred2, m_w,da_w,c_w):
...
def find_max_v(one_avg_pred):
    max_val = -float('inf')
    for i, val in enumerate(one_avg_pred):
        if val > max_val:
            max_val = val
    return max_val
...
def centr_mass2(points_1, points_2):
    return [(p1+p2)/2 for p1,p2 in zip(points_1,points_2)]
    

def centr_mass3(points_1, points_2, points_3):
    return [(p1+p2+p3)/3 for p1,p2,p3 in zip(points_1,points_2,points_3)]
    

def xf(cm12,cm123,avg_preds):
    xxx = []
    for i, one_avg in enumerate(avg_preds):
        xx = {}
        xx['idx']     = i
        xx['dist12']  = distanceTo(cm12,  one_avg)
        xx['dist123'] = distanceTo(cm123, one_avg)
        xx['max_v']   = find_max_v(       one_avg)
        xx['avg_p']   = one_avg
        xxx.append(xx)
    return xxx
...
def predict(sequence, demographics):
    ...
    preds3 = predict3(sequence, demographics)

    wts,da_w,c_w  = [0.268, 0.343, 0.388], [0.70, 0.30], [ +0.0021,-0.0005477,-0.0015523 ]

    pred3 = np.mean(np.array([pred3[0] for pred3 in preds3]), axis=0)
    
    cm12  = centr_mass2(pred1,pred2)    
    cm123 = centr_mass3(pred1,pred2,pred3)
    ...
    for i in range(1,8):
        ...
        wts[1] = 0.343
        for j in range(1,8):
            avg_preds = [h_blend(pred1,pred2,pred3[0], wts,da_w,c_w) for pred3 in preds3]
            avgs = xf(cm12,cm123,avg_preds)
            list_avgs.append(avgs)
            wts[1] += 0.001
            wts[2] = 1 - (wts[0] + wts[1])
        wts[0] += 0.001 

    list_avgs = [avg for avgs in list_avgs for avg in avgs] # flatten 2d

    # vote

    list_avgs__sort_at__max_v  = sorted(copy.deepcopy(list_avgs), key=lambda _:_['max_v'])
    list_avgs__sort_at__cm_12  = sorted(copy.deepcopy(list_avgs), key=lambda _:_['dist12'])
    list_avgs__sort_at__cm_123 = sorted(copy.deepcopy(list_avgs), key=lambda _:_['dist123'])

    list7 = []

    for i in range(len(list_avgs__sort_at__cm_12)):
        for j in range(len(list_avgs__sort_at__max_v)):
            for k in range(len(list_avgs__sort_at__cm_123)):
                i_cm_12  = list_avgs__sort_at__cm_12 [i]['idx']
                j_max_v  = list_avgs__sort_at__max_v [j]['idx']
                k_cm_123 = list_avgs__sort_at__cm_123[k]['idx']
                if i_cm_12==j_max_v==k_cm_123:
                    list7.append(list_avgs__sort_at__cm_123[k])
                if len(list7)==7: break
            if len(list7)==7: break
        if len(list7)==7: break

    # average vote

    preds = np.array([list7[i]['avg_p'] for i in range(len(list7))])
