...
params = {
      ...
      'subm'     : [
          {'name': f'0.70109', 'weight':+0.10, 'color':'limegreen'  },
          {'name': f'0.70150', 'weight':+0.20, 'color':'olivedrab'},
          {'name': f'0.70165', 'weight':+0.20, 'color':'royalblue'  },
          {'name': f'0.70175', 'weight':+0.20, 'color':'darkmagenta'},
          {'name': f'0.70252', 'weight':+0.30, 'color':'crimson'    },]
}
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/10_000 for w in [+1,-1,+1,-1,+1,-1]],
      'subm'     : [
          {'name': f'0.70109', 'weight':+0.0001, 'color':'limegreen'  },
          {'name': f'0.70150', 'weight':+0.0001, 'color':'olivedrab'  },
          {'name': f'0.70165', 'weight':+0.0001, 'color':'royalblue'  },
          {'name': f'0.70175', 'weight':+0.0001, 'color':'darkmagenta'},
          {'name': f'0.70252', 'weight':+0.0001, 'color':'crimson'    },
          {'name': f'0.70447', 'weight':+0.9995, 'color':'red'        },]
}
