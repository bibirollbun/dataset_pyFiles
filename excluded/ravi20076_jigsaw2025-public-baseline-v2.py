...
%%writefile bertV1_2.py

PrintColor(
    f"\n---> BERTV1_2 CV = 0.88377427 inferencing\n"
)

ip_path   = f"/kaggle/input/jigsaw2025publicmodelsv1/BERTV1_2"
MAX_LEN   = 512
n_classes = 2
...
tokenizer = RobertaTokenizer.from_pretrained(ip_path)
...
exec(open( f"bertV1_2.py", "r").read())
