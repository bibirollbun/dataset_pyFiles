...
params = {
      ...
      'subm'     : [
         { 'name': f'0.69896', 'weight':+0.05, 'color':'crimson'},
         { 'name': f'0.69941', 'weight':+0.10, 'color':'limegreen'},
         { 'name': f'0.70096', 'weight':+0.30, 'color':'royalblue'},
         { 'name': f'0.70108', 'weight':+0.55, 'color':'darkmagenta'},]
}
