...
class RobustMolecularProcessor:
    ...
    def prepare_features(self, df):
        ...
        self.TOP_10_FEATURES = [
            'graph_star_distance',
            'ffv_mw_per_vdw_volume',
            'thermal_flexibility_per_atom',
            'sp2_sp3_ratio_all_atoms',
            'thermal_polar_atom_fraction',
            'rdkit_2d_VSA_EState7',
            'rdkit_2d_NumHeteroatoms',
            'rdkit_2d_FractionCSP3',
            'dp_estimated_backbone_length_angstrom',
            'betweenness_centrality_mean',
            'rdkit_2d_SMR_VSA5',
            'rdkit_2d_VSA_EState8',
            'backbone_aromatic_ratio_total',
            'rdkit_2d_NHOHCount',
            ...
            'rigidity_index',
            'rdkit_2d_fr_halogen',
            'dp_estimated_molecular_weight',
            'rdkit_2d_SMR_VSA1',
            'backbone_planarity_score',
            'rdkit_2d_MolLogP',
            'rdkit_2d_SlogP_VSA12',
            'backbone_aromatic_fraction',
            'rdkit_2d_EState_VSA10',
            'rdkit_2d_SlogP_VSA5',
            'rdkit_2d_NumHDonors',
            'sidechain_polarity_index'
        ]
