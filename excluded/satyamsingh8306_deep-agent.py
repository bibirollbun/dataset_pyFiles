!pip install langchain==0.3.18 langchain-community==0.3.17 langchain-core==0.3.45 langchain-google-genai==2.0.9 langchain-groq==0.2.5 langchain-openai==0.3.5 langchain-text-splitters==0.3.6 langgraph==0.3.21 langgraph-checkpoint==2.0.21 langgraph-checkpoint-sqlite==2.0.6 langgraph-prebuilt==0.1.7 langgraph-sdk==0.1.51 langsmith==0.3.7 langchain-experimental


from kaggle_secrets import UserSecretsClient
user_secrets = UserSecretsClient()
secret_value_0 = user_secrets.get_secret("GROQ_API_KEY")
secret_value_1 = user_secrets.get_secret("TAVILY_API_KEY")
...
llm = ChatGroq(model="qwen/qwen3-32b",api_key = secret_value_0
)
os.environ["TAVILY_API_KEY"] = secret_value_1
...
inputs = {
    "messages": [
        ("user", """I’m looking for fun events in Delhi this weekend, preferably music-related. Also, what’s the weather like there, and can you suggest something that’s indoors if it rains?"""),
    ]
}
