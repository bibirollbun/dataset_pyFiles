...
# Numerical Feature Analysis - boxplot, histogram
...
# Categotical Feature Analysis - countplot, wind rose plot
...
#Target Feature Analysis - countplot
...
axes[0].set_title("Mutual Information Score Heatmap of new features")
axes[1].set_title("Mutual Information Score Heatmap of old features")
plt.show()
