...
SUB_CHUNK_SIZE = 250
SUB_CHUNK_ID = 0    # âœ… FIRST HALF (500â€“749)
...
print("âœ… Output folder ready (Chunk 1 / Sub 0)")
...
SUB_START = CHUNK_START + (SUB_CHUNK_ID * SUB_CHUNK_SIZE)  # 500
SUB_END = min(SUB_START + SUB_CHUNK_SIZE, CHUNK_END)       # 750
...
print("âœ… DONE â†’ Lollipop_ASM_chunk_1_sub_0.7z")
