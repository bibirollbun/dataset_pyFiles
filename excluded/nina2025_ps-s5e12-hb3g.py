...
params = {
      ...
      'subm'     : [
         {'name': f'0.69932', 'weight':+0.331, 'color':'crimson'},
         {'name': f'0.69941', 'weight':+0.332, 'color':'green'},
         {'name': f'0.69948', 'weight':+0.337, 'color':'mediumblue'},]
}
...
params = {
  ...
  'subwts'   : [w/200 for w in [10, -3,-7]],
  'subm'     : [
     {'name': f'0.69955', 'weight':+0.330, 'color':'crimson'   },
     {'name': f'0.69988', 'weight':+0.333, 'color':'green'     },
     {'name': f'0.69993', 'weight':+0.337, 'color':'mediumblue'},]
}
...
params = {
  ...
  'subwts'   : [w/200 for w in [10, -3,-7]],
  'subm'     : [
     {'name': f'0.70009', 'weight':+0.332, 'color':'crimson'   },
     {'name': f'0.70010', 'weight':+0.333, 'color':'green'     },
     {'name': f'0.70026', 'weight':+0.335, 'color':'mediumblue'},]
}
...
params = {
  ...
  'subwts'   : [w/200 for w in [10, -3,-7]],
  'subm'     : [
     { 'name': f'g1', 'weight':+0.25, 'color':'firebrick'   },
     { 'name': f'g2', 'weight':+0.35, 'color':'darkgreen'   },
     { 'name': f'g3', 'weight':+0.40, 'color':'midnightblue'},]
}
