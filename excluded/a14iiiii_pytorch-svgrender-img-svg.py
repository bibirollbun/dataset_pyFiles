...
result = subprocess.run(['micromamba', 'run', '-n', 'svgrender', 'python', '/kaggle/working/PyTorch-SVGRender/svg_render.py', 'x=diffvg', "target='/kaggle/input/tempimg/20170608_bazaar.png'", 'x.num_paths=512', 'x.num_iter=10'], capture_output=True, text=True, executable='/root/.local/bin/micromamba')
