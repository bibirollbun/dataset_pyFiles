...
params = {
      ...
      'subwts'   : [w/200 for w in [ +8,+7, -2,-4,-9 ]],
      'subm'     : [
         { 'name': f'0.70072', 'weight':+0.07, 'color':'limegreen'  },
         { 'name': f'0.70164', 'weight':+0.20, 'color':'magenta'    },
         { 'name': f'0.70165', 'weight':+0.20, 'color':'royalblue'  },
         { 'name': f'0.70175', 'weight':+0.20, 'color':'darkmagenta'},
         { 'name': f'0.70356', 'weight':+0.33, 'color':'darkorchid' },]
}
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/200 for w in [ +7, -2,-5 ]],
      'subm'     : [
         { 'name': f'0.70165', 'weight':+0.33, 'color':'royalblue'  },
         { 'name': f'0.70175', 'weight':+0.33, 'color':'darkmagenta'},
         { 'name': f'0.70356', 'weight':+0.34, 'color':'darkorchid' },]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [ +7, -2,-5 ]],
      'subm'     : [
         { 'name': f'0.70164', 'weight':+0.33, 'color':'magenta'  },
         { 'name': f'0.70165', 'weight':+0.33, 'color':'royalblue'},
         { 'name': f'0.70356', 'weight':+0.34, 'color':'darkorchid' },]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [ +7, -2,-5 ]],
      'subm'     : [
         { 'name': f'0.70164', 'weight':+0.30, 'color':'magenta'  },
         { 'name': f'0.70165', 'weight':+0.40, 'color':'royalblue'},
         { 'name': f'0.70175', 'weight':+0.30, 'color':'darkmagenta' },]
}
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/200 for w in [ +7, -1,-2,-4 ]],
      'subm'     : [
         { 'name': f'0.70072', 'weight':+0.19, 'color':'limegreen'  },
         { 'name': f'0.70164', 'weight':+0.27, 'color':'magenta'    },
         { 'name': f'0.70165', 'weight':+0.27, 'color':'royalblue'  },
         { 'name': f'0.70175', 'weight':+0.27, 'color':'darkmagenta'},]
}
...
params = {
      ...
      'subm'     : [
         { 'name': f'0.70072', 'weight':+0.07, 'color':'limegreen'  },
         { 'name': f'0.70164', 'weight':+0.11, 'color':'magenta'    },
         { 'name': f'0.70165', 'weight':+0.17, 'color':'royalblue'  },
         { 'name': f'0.70175', 'weight':+0.14, 'color':'darkmagenta'},
         { 'name': f'0.70356', 'weight':+0.51, 'color':'darkorchid' },]
}
