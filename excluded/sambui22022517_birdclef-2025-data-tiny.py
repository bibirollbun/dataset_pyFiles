...
df_sampled = df_train.groupby('label', group_keys=False).apply(lambda x: x.sample(frac=0.2, random_state=42))
df_sampled.to_csv('convert_train_tiny.csv', index=False)
