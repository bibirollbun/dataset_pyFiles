TRAIN_CSV = "/kaggle/input/detecting-reversal-points-in-us-equities/competition_data/train.csv"
TEST_CSV = "/kaggle/input/detecting-reversal-points-in-us-equities/competition_data/test.csv"
...
submission = pd.read_csv("/kaggle/input/detecting-reversal-points-in-us-equities/competition_data/sample_submission.csv", low_memory=False)
...
final_features = non_bool_features + selected_bool_features
