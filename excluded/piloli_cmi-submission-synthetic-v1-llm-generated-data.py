...
# Full gesture mapping to 18 classes
GESTURE_NAMES = [
    "Wave hello",
    "Text on phone", 
    "Raise hand",
...
def predict(sequence: pl.DataFrame, demographics: pl.DataFrame) -> str:
    """Synthetic model prediction function"""
    ...
    try:
        ...
        print(f"Predicted: {pred_class_name} (confidence: {ensemble_probs[pred_class_idx]:.3f})")
        
        # Map to full gesture set if needed
        if pred_class_name in GESTURE_NAMES:
            return pred_class_name
        else:
            # Fallback mapping for unseen classes
            class_mapping = {
                "Wave hello": "Wave hello",
                "Text on phone": "Text on phone", 
                "Raise hand": "Raise hand"
            }
            return class_mapping.get(pred_class_name, "Other gesture")
...
print("Synthetic V1 inference complete!")
