...
grid_search_space = { # See https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVR.html
    'kernel': ['poly', 'rbf', 'sigmoid', 'linear'], # For polynomial kernel, default is cubic, could also tune that
    'C': [100000], # Regularization parameter
    'gamma': [0.0001,0.0005, 0.001], # Kernel coefficient
    'epsilon': [0.01 ,0.05, 0.1], # Size of epsilon-tube with no penalty
}
...
y_test_hat_pd.to_csv('y_test_hatsvm.csv', index=False)
