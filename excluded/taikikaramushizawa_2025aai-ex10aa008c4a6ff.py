...
# sample_sbm = pd.read_csv(f"{DATA_DIR}/sample_submission.csv")
...
print(train[train['card_id']=="C_ID_d639edf6cd"])
...
agg_funcs = {
    ...
    'purchase_amount': ['count', 'mean', 'max', 'min', 'std'], # 購入回数・合計・平均・最大・最小・標準偏差
}
