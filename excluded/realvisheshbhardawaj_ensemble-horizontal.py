...
params = {
  ...
  'subwts'   : [ +0.08, -0.02,-0.03,-0.05 ],
  'subm'     : [
      {'name': f'743', 'weight':+0.17, 'color':'navy'},
      {'name': f'751', 'weight':+0.17, 'color':'royalblue'},
      {'name': f'756', 'weight':+0.17, 'color':'deepskyblue'},
      {'name': f'767', 'weight':+0.49, 'color':'dodgerblue'},]
}
