...
# <<< UPGRADE HIGHLIGHT: Tuned Savitzky-Golay parameters >>>
def preprocess_spectra_upgraded(X, method='baseline_snv_airpls', deriv_order=1):
    ...
    if method == 'baseline_snv_airpls':
        ...
        # Increased window for better smoothing, reduced polyorder for stability
...
def main_train():
    print("="*80, "\nCELL 1: MODEL TRAINING PIPELINE (SAV-GOL TUNED)\n", "="*80)
...
def main_final_ensemble():
    print("="*80)
    print("CELL 3: FINAL ENSEMBLE AVERAGING")
    print("="*80)
    ...
    if len(submission_files) < 1:
        print("Error: No submission files found to average.")
        return
