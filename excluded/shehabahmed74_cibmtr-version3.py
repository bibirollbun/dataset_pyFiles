...
requirements_path = "/kaggle/input/input-requirement1/input_requirements.txt.txt"
...
if os.path.exists(requirements_path):
    ...
    print("ğŸ“¦ Installing dependencies from requirements file...")
    ...
    for package in packages:
        ...
        if package:  # Skip empty lines
            ...
            if package.endswith(".whl"):
                print(f"ğŸš€ Installing from wheel file: {package}")
                ...
                print(f"ğŸš€ Installing package: {package}")
                subprocess.check_call([sys.executable, "-m", "pip", "install", package])
    
    print("âœ… All dependencies installed successfully.")

else:
    print(f"â�Œ ERROR: Requirements file not found at {requirements_path}")
