...
for col in categorical_cols:
    combined_data[col] = combined_data[col].fillna(combined_data[col].mode()[0])#ä¼—æ•°å¡«å……
...
# Encoding categorical columns using LabelEncoderæ ‡ç­¾ç¼–ç �
label_encoders = {}
for col in categorical_cols:
...
y_pred_lgb = lgb_reg.predict(X_val)
...
evaluate_model(y_val, y_pred_xgb, "LGBoost")
...
test_predictions_lgb = lgb_reg.predict(test_data)
