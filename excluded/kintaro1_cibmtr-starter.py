...
import os
os.environ['KAGGLE_USERNAME'] ="kintaro1"
os.environ['KAGGLE_KEY'] ="c26f839f3a7a01fa452300cfe0e1a8c9"
...
# Kaggle APIを使用してノートブックをプル
!kaggle kernels push -p /kaggle/cibmtr-starter-pack-by-ama/cibmtr-starter-pack-by-ama
