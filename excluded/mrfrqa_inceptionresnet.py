...
from tensorflow.keras.layers import Dense, Dropout, GlobalAveragePooling2D, Input, Conv2D, BatchNormalization, Activation, SpatialDropout2D
from tensorflow.keras.optimizers import Adam

# InceptionResNetV2 modelini yükle
base_model = InceptionResNetV2(weights='imagenet', include_top=False, input_tensor=Input(shape=(256, 512, 3)))
