...
train_dates = X_train_full['date']  # Keep dates for validation split
...
# =============================================================================
# For test data, we need to create the same date-combination structure
...
# Create X_test with the same features as X_train
...
# =============================================================================
# MULTI-TARGET RANDOM FOREST TRAINING
# =============================================================================
print("\nTraining Multi-Target Random Forest...")

multi_model = DecisionTreeRegressor(
    max_depth=15,
    random_state=42
)

multi_model.fit(X_train, y_train)
print("✓ Multi-target model training completed!")
...
# Use the separate train_dates series for validation split
...
for _, row in test_reference.iterrows():
    ...
    if combo in combo_to_idx:
        ...
        final_predictions.append(max(0, pred))  # Ensure non-negative
    else:
        # Fallback: use median of training data
...
# SAVE SUBMISSION
# =============================================================================
submission_file = 'multi_target_rf_submission.csv'
