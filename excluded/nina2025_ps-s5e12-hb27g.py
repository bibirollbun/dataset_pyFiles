...
direct_blend(['0.70737.a','0.70109'], weight=[0.99, 0.01], output_file='A.csv')
direct_blend(['0.70737.b','0.70442'], weight=[0.97, 0.03], output_file='B.csv')
direct_blend(['0.70737.c','0.70651'], weight=[0.90, 0.10], output_file='C.csv')
direct_blend(['0.70737.d','0.70682'], weight=[0.50, 0.50], output_file='D.csv')
...
params = {
     ...
     'subm'     : [
         {'name': f'A', 'weight':+0.20, 'color':'royalblue'},
         {'name': f'B', 'weight':+0.20, 'color':'orange'   },
         {'name': f'C', 'weight':+0.20, 'color':'green'    },
         {'name': f'D', 'weight':+0.40, 'color':'crimson'  },]
}
