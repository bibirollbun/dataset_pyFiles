...
train = pd.read_csv('/kaggle/input/k/ayaankhan2812/eda-n-folds-lmsys/train_5folds.csv')
final_df.head()
...
for kfold in range(kfolds):
    ...
    model_loaded.load_state_dict(torch.load(f"/kaggle/input/inference-lmsys-43ccb2/lstm_classifier_kfold_{kfold}_epoch_{epoches_to_use[kfold]}.pth", map_location=device))
