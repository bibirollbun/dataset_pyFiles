...
class CFG:
    ...
    # Debug settings
    debug_mode = False  # ğŸ”¥ é—œé–‰èª¿è©¦æ¨¡å¼�
    run_single_fold = False  # ğŸ”¥ é�‹è¡Œå®Œæ•´çš„5-foldäº¤å�‰é©—è­‰
...
class DebertaForTokenBinary(nn.Module):
    ...
    def forward(self, **batch):
        ...
        if labels is not None:
            # ğŸ”¥ ä¿®å¾©ï¼šä½¿ç”¨focal lossä¾†è™•ç�†é¡�åˆ¥ä¸�å¹³è¡¡
    ...
    for epoch in range(CFG.epochs):
        ...
        if f1 > best_f1:
            ...
            torch.save({
                ...
                'best_threshold': float(best_th),  # ğŸ”¥ ç¢ºä¿�æ˜¯Python float
                'best_f1': float(best_f1)  # ğŸ”¥ ç¢ºä¿�æ˜¯Python float
            }, best_path)
