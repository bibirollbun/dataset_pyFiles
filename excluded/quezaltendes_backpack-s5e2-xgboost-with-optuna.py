...
model = XGBRegressor(
    n_estimators=126,
    max_depth=2,
    learning_rate=0.01961430225085952,
    subsample=0.6689464405797093,
    colsample_bytree=0.9177334548324169,
    gamma=7.779734685001938,
    reg_alpha=2.2058448377495488,
    reg_lambda=9.510080878629326,
verbosity=0)
