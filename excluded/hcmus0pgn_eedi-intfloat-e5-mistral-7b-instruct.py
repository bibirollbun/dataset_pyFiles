...
%%writefile /kaggle/working/eedi-mining-misconceptions/conf/llm_embedding/conf_intfloat.yaml
debug: false
seed: 334
...
!accelerate launch /kaggle/working/eedi-mining-misconceptions/code/train_llm_embedding.py --config-name conf_intfloat
