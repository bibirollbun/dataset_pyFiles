...
path = '/kaggle/input/anime-recommendation-system-by-tah/'
...
animes.fillna(animes.median(), inplace=True)
...
data = ratings.merge(animes, on='anime_id', how='left')


dls = CollabDataLoaders.from_df(data, user_name='user_id', item_name='anime_id', rating_name='rating', bs=64)
