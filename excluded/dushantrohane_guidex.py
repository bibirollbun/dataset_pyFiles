...
class ContentSearchAgent:
    def run(self, topic: str) -> List[Resource]:
        ...
        playlist = "https://youtube.com/playlist?list=PLqFaTIg4myu9r7uRoNfbJhHUbLp-1t1YE&si=oiJ1Zs2VAXxY4o6k"
        return [
            Resource(
                title=f"{topic} —  AI Agent Intensive (playlist)",
                url=playlist,
            ...
            Resource(
                ...
                url="https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbVBqcmNkQjFXS3RFd2hXb0FHa1EwcU9PWHN2UXxBQ3Jtc0tsSkVkNWRQcnV2Rmxia192UE5nMC04VDMwZGZ2Mk84R0gzYnhFZ2lGZU9lMGFfTG1uZ1JZNDZEQjZfMVNadTRVeW8wU0k0SlJCQktERTNPNV9FT0w4YXJHcUpUZmJEeTZiUEVMWWN1Q1IyVUoyLTZpSQ&q=https%3A%2F%2Fwww.kaggle.com%2Fwhitepaper-foundational-llm-and-text-generation&v=mQDlCZZsOyo",
