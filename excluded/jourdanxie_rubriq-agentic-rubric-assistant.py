...
2) Infer 3â€“8 evaluation criteria.
...
Edubridge was born from this observationâ€”a commitment to democratise educational guidance and ensure that every student, regardless of their background or financial situation, can access quality career counselling and learning resources.
...
Trusted Sources Only: Unlike generic AI chatbots, Edubridge only recommends resources from verified, quality educational platformsâ€”saving students from information overload and low-quality content.
...
Production-Ready Code: Complete with error handling, logging, session management, and deployment capabilities. This isn't just a demoâ€”it's a working system ready for real users.
...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="indigo", neutral_hue="slate"), css=custom_css, title="EduBridge AI") as demo:
    ...
    with gr.Group():
        ...
        with gr.Row():
            ...
            clear_btn = gr.Button("ğŸ”„ Reset", variant="secondary", scale=1)
    ...
    gr.HTML(f"
        <div class='footer-text'>
            Made with â�¤ï¸� by <b>Mohammed Faizal. M</b> - U.G Student, B.Com, The New College, Chennai, India<br>
