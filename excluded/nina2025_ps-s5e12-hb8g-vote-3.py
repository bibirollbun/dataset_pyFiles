...
pwpage = f'/kaggle/working/submissions/'
dspage = f'/kaggle/input/07-december-2025-ps-s5e12/'

if os.path.isdir(pwpage): shutil.rmtree(pwpage) 
    
os.mkdir(pwpage)

shutil.copy('/kaggle/input/ps-s5e12-hb8g-vote-2/submission.csv',pwpage+'0.70371.csv')
shutil.copy('/kaggle/input/ps-s5e12-hb8g-vote-2-b/Vote.2b.csv', pwpage+'Vote.2b.csv')
shutil.copy('/kaggle/input/ps-s5e12-hb8g-vote-2-c/Vote.2c.csv', pwpage+'Vote.2c.csv')
shutil.copy('/kaggle/input/ps-s5e12-hb8g-vote-2-d/Vote.2d.csv', pwpage+'Vote.2d.csv')


path = pwpage # or dspage - there will be no difference, this is done to control reliability
...
params = {
      ...
      'subm'     : [
         {'name': f'0.70371', 'weight':+0.25, 'color':'magenta'},
         {'name': f'Vote.2b', 'weight':+0.25, 'color':'darkmagenta'},
         {'name': f'Vote.2c', 'weight':+0.25, 'color':'limegreen'},
         {'name': f'Vote.2d', 'weight':+0.25, 'color':'royalblue'},]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [11, -1,-3,-7]],
      'subm'     : [
         {'name': f'0.70371', 'weight':+0.30, 'color':'magenta'},
         {'name': f'Vote.2b', 'weight':+0.30, 'color':'darkmagenta'},
         {'name': f'Vote.2c', 'weight':+0.10, 'color':'limegreen'},
         {'name': f'Vote.2d', 'weight':+0.30, 'color':'royalblue'},]
}
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/5_000 for w in [-7, -3,-1,+10]],
      'subm'     : [
         {'name': f'0.70371', 'weight':+1.000, 'color':'magenta'},
         {'name': f'Vote.2b', 'weight':+0.005, 'color':'darkmagenta'},
         {'name': f'Vote.2c', 'weight':-0.004, 'color':'limegreen'},
         {'name': f'Vote.2d', 'weight':-0.001, 'color':'royalblue'},]
}
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/1000 for w in [ 5, -1,-4 ]],
      'subm'     : [
         {'name': f'0.70371', 'weight':+0.995, 'color':'magenta'},
         {'name': f'Vote.2b', 'weight':+0.010, 'color':'darkmagenta'},
         {'name': f'Vote.2d', 'weight':-0.005, 'color':'royalblue'},]
}
...
params = {
      'path'     : '/kaggle/input/08-december-2025-ps-s5e12/',            
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['random',0.30,0.70 ],
      'subwts'   : [w/100 for w in [ +4 ,-4 ]],
      'subm'     : [
         {'name': f'0.70371.v3','weight':+0.21, 'color':'magenta'},
         {'name': f'0.70372',   'weight':+0.79, 'color':'deeppink'},]
}
df8 = h_blend(params, details=True)


df = df1 # version.1.LB = 0.70_353
df = df2 # version.2.LB = 0.70_360
df = df3 # version.3.LB = 0.70_371
df = df4 # version.4.LB = 0.70_371 < version.3
