dry_run = False
!pip install ../input/kornia-local/kornia-0.6.4-py2.py3-none-any.whl
!pip install ../input/kornia-local/kornia_moons-0.1.9-py3-none-any.whl
...
matcher.load_state_dict(torch.load("../input/kornia-local/loftr_outdoor.ckpt")['state_dict'])
