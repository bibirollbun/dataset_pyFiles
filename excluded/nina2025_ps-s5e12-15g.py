...
params = {
      'path'     : f'/kaggle/input/01-december-2025-ps-s5e12/',            
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/200 for w in [+11, -1,-3,-7]],
      'subm'     : [
          {'name': f'0.70095', 'weight':+0.25, 'color':'crimson'    },
          {'name': f'0.70108', 'weight':+0.25, 'color':'darkmagenta'},
          {'name': f'0.70109', 'weight':+0.25, 'color':'limegreen'  },
          {'name': f'0.70110', 'weight':+0.25, 'color':'royalblue'  },]
}
...
params = {
      'path'     : f'/kaggle/input/14-december-2025-ps-s5e12/',            
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/200 for w in [+11, -1,-3,-7]],
      'subm'     : [
          {'name': f'0.70076', 'weight':+0.10, 'color':'limegreen'    },
          {'name': f'0.70165', 'weight':+0.30, 'color':'royalblue'},
          {'name': f'0.70190', 'weight':+0.30, 'color':'darkmagenta'  },
          {'name': f'0.70191', 'weight':+0.30, 'color':'crimson'  },]
}
...
params = {
      ...
      'subwts'   : [w/200 for w in [+11, -1,-3,-7]],
      'subm'     : [
          {'name': f'0.70044', 'weight':+0.05, 'color':'crimson'},
          {'name': f'0.70252', 'weight':+0.10, 'color':'red'    },
          {'name': f'0.70389', 'weight':+0.15, 'color':'green'  },
          {'name': f'0.70447', 'weight':+0.70, 'color':'blue'   },]
}
...
params = {
      ...
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/200 for w in [+8, -3,-5]],
      'subm'     : [
          {'name': f'g1', 'weight':+0.10, 'color':'limegreen'  },
          {'name': f'g2', 'weight':+0.20, 'color':'darkmagenta'},
          {'name': f'g3', 'weight':+0.70, 'color':'crimson'    },]
}
df = h_blend(params, details=True, subm='g4.csv')


for file in 'g1,g2,g3,g4'.split(','): os.remove(file+'.csv')
