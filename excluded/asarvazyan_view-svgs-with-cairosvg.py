...
svg = """
<svg width="800px" height="800px" viewBox="0 0 24 24" data-name="Layer 1" id="Layer_1">
  <title/>
  ...
  <path d="M14,14h0a2.99994,2.99994,0,0,1-3-3V9h6v2A2.99994,2.99994,0,0,1,14,14Z" style="fill:#fff"/>
  <path d="M13,4,10,6V2.2071a.5.5,0,0,1,.8536-.3535Z" style="fill:#ff888b"/>
  <path d="M15,4l3,2V2.2071a.5.5,0,0,0-.8536-.3535Z" style="fill:#ff888b"/>
  <path d="M14,11h0a4,4,0,0,1-4-4V4h8V7A4.00005,4.00005,0,0,1,14,11Z" style="fill:#4b5661"/>
...
png_from_file = cairosvg.svg2png(url="output.svg")
Image(png_from_file)


png_from_url = cairosvg.svg2png(url="https://www.svgrepo.com/show/454281/cat-halloween-kitty.svg")
Image(png_from_url)


with open("output.svg", "r") as f:
    png_from_object = cairosvg.svg2png(file_obj=f)
Image(png_from_object)
