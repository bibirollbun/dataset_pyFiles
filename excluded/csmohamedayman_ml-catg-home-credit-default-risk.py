...
def evaluate_categorical_model(y_test, y_pred):
...
def get_categorical_models():
    # Dictionary of categorical models
    categorical_models = {
...
baseline_models = get_categorical_models()
...
tuned_baseline_models = tune_models(baseline_models, X, y, 'f1_macro')
