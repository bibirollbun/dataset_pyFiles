...
class CFG:
    ...
    model_path = '/kaggle/input/test-model-v2'  
...
class BirdCLEFModel(nn.Module):
    def __init__(self, cfg, num_classes):
        ...
        self.classifier = nn.Linear(backbone_out+128, cfg.num_classes)
    ...
    def forward(self, x, targets=None):
        ...
        cnn_features = self.pooling(cnn_features)
        ...
        combined_features = torch.cat((features, cnn_features), dim=1)
