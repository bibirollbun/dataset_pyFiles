...
ParamsXgb = {'max_depth': 9, 'learning_rate': 0.01081748198113918, 'min_child_weight': 26, 'subsample': 0.8662369177169547,
            'n_estimators': 100000}

results_XGB_1 = base.Train_ML(ParamsXgb,'XGB',e_stop=150) # CV : 0.9744
...
save_outputs('XGB_0.9744',results_XGB_1[0], results_XGB_1[1])

sample['y'] = results_XGB_1[1]
