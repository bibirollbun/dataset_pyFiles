...
params = {
    ...
    'eval_metric': 'rmse', # Use RMSE since we have already taken log(1 + y) 
    'device': 'cuda',
    'seed': seed1
}
...
def objective(trial):
    ...
    for train_idx, valid_idx in cv.split(df_train):
        ...
        # I probably don't need to do a try/ except anymore, since I am not taking 
        # logs in my metric anymore. I don't think it can hurt though. 
        try:
...
# The following essentially trains 5 models with the parameters found above, each with 1/10th of the data.
...
final_preds = np.expm1(final_preds) # Don't forget to exponentiate the predictions
# since the evaluation metric will be RMSLE
