...
X_under, y_under = oversampler.fit_resample(X_train_transform, y_train)
print(f"\n[Undersampling] Shape: {X_under.shape}")
print(f"[Undersampling] Balance: {Counter(y_under)}")
...
test_proba = lgb_model.predict_proba(test_transform)[:, 1]
