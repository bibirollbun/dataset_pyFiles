...
encoder.save("/kaggle/working/my_encoder.keras")  # or use .h5 for HDF5 format
...
## save
model.save("/kaggle/working/my_model.keras")  # or use .h5 for HDF5 format
...
submission = pandas.DataFrame({'ID': range(1,len(X)+1)})
