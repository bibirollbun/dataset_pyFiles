...
submission.to_csv("submission_challenge210088609.csv", index=False)
print("✅ Submission file 'submission_challenge210088609.csv' created! Upload it to Kaggle for scoring.")
