...
# backbone 
BACKBONE_PATH = "/kaggle/input/28-december-2025-ps-s5e12/0.70_765.csv"


OTHER_PATHS = [
    "/kaggle/input/diabetes-0-70599/submission.csv",
    "/kaggle/input/24-december-2025-ps-s5e12/0.70744.c.csv",
    "/kaggle/input/19-december-2025-ps-s5e12/0.70776.csv"
]
