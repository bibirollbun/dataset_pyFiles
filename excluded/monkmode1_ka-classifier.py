...
model_name = "microsoft/deberta-v3-base"  # Changed to a larger model
...
batch_size = 8  # Increased batch size for better performance
...
for fold, (train_idx, val_idx) in enumerate(skf.split(train_texts, train_labels)):
    ...
    num_epochs = 4  # Increased epochs for better training
