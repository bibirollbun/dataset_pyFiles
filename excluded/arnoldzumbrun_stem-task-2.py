...
# albumentations for data argumentation
!pip install -U albumentations # kaggle notebook has an older version of albumentations. This will upgrade the package
...
!yolo train \
    model=yolo11n.pt \
    data=/kaggle/input/stem-challenge-task-2-competition/task_2_train_val/data.yaml \
    epochs=20 \
    imgsz=1280 \
    device=0,1 \
...
Image(filename=f'/kaggle/working/train/results.png', width=800)


!yolo train model=yolo11n.pt data=/kaggle/input/stem-challenge-task-2-competition/task_2_train_val/data.yaml epochs=10 imgsz=640 device=0,1 project=/kaggle/working lr0=0.1
...
# Adjust according to your training folder number; for instance, /kaggle/working/train###/weights/best.pt
...
yolo_kaggle_predict(MODEL_WEIGHTS, "/kaggle/input/stem-challenge-task-2-competition/task_2_test/images/test", "/kaggle/working/submission.csv")
