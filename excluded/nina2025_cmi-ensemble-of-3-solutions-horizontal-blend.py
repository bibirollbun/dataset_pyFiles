import os, json, joblib, numpy as np, pandas as pd, copy
import random
...
lps_asc  = sorted(lps_asc,  key=lambda k:k['n'],reverse=False)         # h-blend
...
# Yes, it seems that in order to "catch the outlines" - the initial random search will be faster. 
...
#     # wts = np.asarray([0.270,0.345,0.385]) - v2
#     # wts = np.asarray([0.268,0.345,0.387]) - v14 < v2
    

#     # wrc11 = np.asarray([0.271,0.344,0.385])
#     # wrc12 = np.asarray([0.271,0.343,0.386])
#     # wrc13 = np.asarray([0.271,0.342,0.387])  # Lb = 0.84    # v16.Top.2
#     # wrc14 = np.asarray([0.271,0.341,0.388])
#     # wrc15 = np.asarray([0.271,0.340,0.389])

#     wrc21 = np.asarray([0.271,0.345,0.384])
#     wrc22 = np.asarray([0.271,0.346,0.383])
#     wrc23 = np.asarray([0.271,0.347,0.382])  # Lb = 0.85     # v17.Top.1
#     wrc24 = np.asarray([0.271,0.348,0.381])
#     wrc25 = np.asarray([0.271,0.349,0.380])

#     #wts = random.choice([wrc21, wrc22, wrc23, wrc24, wrc25]) # v17.Top.1


#     #wts = random.choice([wrc21, wrc22, wrc23              ]) # v18  LB=0.84
#     #wts = random.choice([       wrc22, wrc23, wrc24       ]) # v19  LB - ?
#     #wts = random.choice([              wrc23, wrc24, wrc25]) # v20  LB=0.85         < v17
#     #wts = random.choice([wrc21,               wrc24, wrc25]) # v21  LB=0.85   < v20 < v17
#     #wts = random.choice([wrc21, wrc22,               wrc25]) # v2?
...
#     #wts = wrc23
#     #wts = np.asarray([0.271,0.3474,0.3816])    #  v22  #  LB=0.84
#     #wts = wrc24                                #  v24  #  LB=0.85 < v20 < v17
#     #wts = np.asarray([0.271,0.3485,0.3805])    #  v23  #  LB=0.85 < v20 < v17
#     #wts = wrc25                                #  v25  #  LB=0.85 < v20 < v17
...
#     # wrc11 = np.asarray([0.271,0.344,0.385])
#     # wrc12 = np.asarray([0.271,0.343,0.386])
#     # wrc13 = np.asarray([0.271,0.342,0.387])                   # v16.Top.2  # Lb=0.849
#     # wrc14 = np.asarray([0.271,0.341,0.388])
#     # wrc15 = np.asarray([0.271,0.340,0.389])

#     # wrc21 = np.asarray([0.271,0.345,0.384])
#     # wrc22 = np.asarray([0.271,0.346,0.383])
#     # wrc23 = np.asarray([0.271,0.347,0.382])                   # v17.Top.1  # Lb=0.850 
#     # wrc24 = np.asarray([0.271,0.348,0.381])
#     # wrc25 = np.asarray([0.271,0.349,0.380])

#     # wts = random.choice([wrc11, wrc12, wrc13, wrc14, wrc15])  # v16.Top.2
#     # wts = random.choice([wrc21, wrc22, wrc23, wrc24, wrc25])  # v17.Top.1

#     # wrc31 = np.asarray([0.271-0.0003, 0.345+0.00015, 0.384+0.00015])
#     # wrc32 = np.asarray([0.271-0.0003, 0.346+0.00015, 0.383+0.00015])
#     # wrc33 = np.asarray([0.271-0.0003, 0.347+0.00015, 0.382+0.00015])       # Lb=0.849
#     # wrc34 = np.asarray([0.271-0.0003, 0.348+0.00015, 0.381+0.00015])
#     # wrc35 = np.asarray([0.271-0.0003, 0.349+0.00015, 0.380+0.00015])
    
#     # wts = random.choice([wrc31, wrc32, wrc33, wrc34, wrc35]) 

#     # wrc41 = np.asarray([0.271+0.0003, 0.345-0.00015, 0.384-0.00015])
#     # wrc42 = np.asarray([0.271+0.0003, 0.346-0.00015, 0.383-0.00015])
#     # wrc43 = np.asarray([0.271+0.0003, 0.347-0.00015, 0.382-0.00015])       # Lb=0.849
#     # wrc44 = np.asarray([0.271+0.0003, 0.348-0.00015, 0.381-0.00015])
#     # wrc45 = np.asarray([0.271+0.0003, 0.349-0.00015, 0.380-0.00015])

#     # wts = random.choice([wrc41, wrc42, wrc43, wrc44, wrc45]) 

#     # wrc51 = np.asarray([0.271, 0.345+0.0007, 0.384-0.0007])
#     # wrc52 = np.asarray([0.271, 0.346+0.0007, 0.383-0.0007])
#     # wrc53 = np.asarray([0.271, 0.347+0.0007, 0.382-0.0007])  # Lb = 0.847
#     # wrc54 = np.asarray([0.271, 0.348+0.0007, 0.381-0.0007])
#     # wrc55 = np.asarray([0.271, 0.349+0.0007, 0.380-0.0007])

#     # wts = random.choice([wrc51, wrc52, wrc53, wrc54, wrc55])
...
#     wts = random.choice([wrc21, wrc22, wrc23, wrc24, wrc25])

#     # wts = wrc24

#     #---------------------------------------------------------
#     c123 = np.asarray([1.0041-0.00005,0.9974,0.9985+0.00005])
#     c132 = np.asarray([1.0041-0.00005,0.9985+0.00005,0.9974])
#     #---------------------------------------------------------
#     c213 = np.asarray([0.9974,1.0041-0.00005,0.9985+0.00005])
#     c231 = np.asarray([0.9985+0.00005,1.0041-0.00005,0.9974])
#     #---------------------------------------------------------
#     c312 = np.asarray([0.9974,0.9985+0.00005,1.0041-0.00005])
#     c321 = np.asarray([0.9985+0.00005,0.9974,1.0041-0.00005])
#     #---------------------------------------------------------
#     preds = []
#     for a,b,c in zip(pred0,pred1,pred2):
#         if   a <= b <= c: _wts = c123 * wts
...
#     # # v.3
#     # # M3 : weights = {'A': 0.5023, 'B': 0.2023, 'C': 0.2954}
#     # #===========================================================
#     # wts = wrc24                                               # LB= 0.849
#     # #---------------------------------------------------------
#     # c123 = np.asarray([1.0041-0.00004,0.9974,0.9985+0.00004])
#     # c132 = np.asarray([1.0041-0.00004,0.9985+0.00004,0.9974])
#     # #---------------------------------------------------------
#     # c213 = np.asarray([0.9974,1.0041-0.00004,0.9985+0.00004])
#     # c231 = np.asarray([0.9985+0.00004,1.0041-0.00004,0.9974])
#     # #---------------------------------------------------------
#     # c312 = np.asarray([0.9974,0.9985+0.00004,1.0041-0.00004])
#     # c321 = np.asarray([0.9985+0.00004,0.9974,1.0041-0.00004])
#     # #---------------------------------------------------------
#     # #===========================================================

    
#     # # v.2
#     # # M3 : weights = {'A': 0.5025, 'B': 0.2025, 'C': 0.295}
#     # #===========================================================
#     # wts = wrc25                                               # LB= 0.850  =  Top of Tops
#     # #---------------------------------------------------------
#     # c123 = np.asarray([1.0041-0.00005,0.9974,0.9985+0.00005])
#     # c132 = np.asarray([1.0041-0.00005,0.9985+0.00005,0.9974])
#     # #---------------------------------------------------------
...
#     # # v.4
#     # # M3 : weights = {'A': 0.5027, 'B': 0.2027, 'C': 0.2946}
#     # #===========================================================
#     # wts  = wrc27                                              # LB= 0.850 < v.2
#     # #---------------------------------------------------------
#     # c123 = np.asarray([1.0041-0.00005,0.9974,0.9985+0.00005])
#     # c132 = np.asarray([1.0041-0.00005,0.9985+0.00005,0.9974])
#     # #---------------------------------------------------------
...
#     # # M3 : weights = {'A': 0.5025, 'B': 0.2025, 'C': 0.295}
#     # #===========================================================
#     # wts  = wrc25                                              # LB= 0.850 < v.4 < v.2
#     # #---------------------------------------------------------
#     # c123 = np.asarray([1.0041-0.00008,0.9974,0.9985+0.00008])
#     # c132 = np.asarray([1.0041-0.00008,0.9985+0.00008,0.9974])
#     # #---------------------------------------------------------
#     # c213 = np.asarray([0.9974,1.0041-0.00008,0.9985+0.00008])
#     # c231 = np.asarray([0.9985+0.00008,1.0041-0.00008,0.9974])
#     # #---------------------------------------------------------
#     # c312 = np.asarray([0.9974,0.9985+0.00008,1.0041-0.00008])
#     # c321 = np.asarray([0.9985+0.00008,0.9974,1.0041-0.00008])
#     # #---------------------------------------------------------
#     # #===========================================================


#     # # v.8
#     # # M3 : weights = {'A': 0.5024, 'B': 0.2024, 'C': 0.2952}
#     # #===========================================================
#     # wts  = wrc28                                              # LB= 0.850 < v.2
#     # #---------------------------------------------------------
#     # c123 = np.asarray([1.0041-0.000054,0.9974,0.9985+0.000054])
#     # c132 = np.asarray([1.0041-0.000054,0.9985+0.000054,0.9974])
#     # #---------------------------------------------------------
#     # c213 = np.asarray([0.9974,1.0041-0.000054,0.9985+0.000054])
#     # c231 = np.asarray([0.9985+0.000054,1.0041-0.000054,0.9974])
#     # #---------------------------------------------------------
#     # c312 = np.asarray([0.9974,0.9985+0.000054,1.0041-0.000054])
#     # c321 = np.asarray([0.9985+0.000054,0.9974,1.0041-0.000054])
#     # #---------------------------------------------------------
#     # #===========================================================
...
#     # # M3 : weights = {'A': 0.5025, 'B': 0.2025, 'C': 0.295}
#     # #===========================================================
#     # wts = wrc25   # LB=0.850 = Top of everything we have (v.2)
#     # #---------------------------------------------------------
#     # c123 = np.asarray([1.0041-0.00005,0.9974,0.9985+0.00005])
#     # c132 = np.asarray([1.0041-0.00005,0.9985+0.00005,0.9974])
#     # #---------------------------------------------------------
...
#     r =       5
#     k = 1.00005         # v.12 - Lb=0.850 - Top.1
#     o = 1.0000 
    
#     r =      4        
#     k = 1.0004          # v.13 - Lb=0.850   < v.2 < v.12
#     o = 1.0000
...
#     r =       5        
#     k = 1.00008         # v.15 - Lb=0.850 - Top.2
#     o = 0.99992
    
#     r =       5        
#     k = 1.00002         # v.16 - Lb=0.850  < v.2 < v.15 < v.12
#     o = 0.99998

#     r =       5
#     k = 1.000054        # v.17 - Lb=0.850  < v.2 < v.15 < v.12
#     o = 0.999954 

#     r =       5
#     k = 1.00008         # v.18 - Lb=0.850  < v.2 < v.15 < v.12
#     o = 1.0000 

#     r =       5
#     k = 1.000058        # v.19  - Lb=0.850  < v.2 < v.15 < v.12 # two round
#     o = 1.0000 
...
def predict(sequence, demographics):
    ...
    m_w,da_w,c_w = [0.271, 0.347, 0.382], [0.60, 0.40], [+0.0021,-0.0007,-0.0014] # v25=0.852                                                 
    m_w,da_w,c_w = [0.271, 0.347, 0.382], [0.80, 0.20], [+0.0021,-0.0007,-0.0014] # v26=0.851                                                   
    m_w,da_w,c_w = [0.271, 0.347, 0.382], [0.70, 0.30], [+0.0021,-0.0007,-0.0014] # v23=0.852 
    # v25 < v23 
