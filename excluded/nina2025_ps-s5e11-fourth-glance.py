...
params = {
      ...
      'subwts'   : [ -0.03, 0.0, -0.02, 0.0, -0.01 ],
      'subm'     : [    
         { 'name': f'0.92664','weight':+0.03,'color':"darkslategray" },
         { 'name': f'0.92684','weight':+0.03,'color':"limegreen" },
         { 'name': f'0.92722','weight':+0.03,'color':"darkgreen" },
         { 'name': f'0.92756','weight':+0.21,'color':"forestgreen" },
         { 'name': f'0.92761','weight':+0.70,'color':"lime" },]  
}
df_cross1 = h_blend(params, figures1=True, figures2=True, details=True)
...
params = {
      ...
      'id_target': ['id',"loan_paid_back"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [ 0.0, -0.03, 0, -0.03, 0.00 ],
      'subm'     : [    
         { 'name': f'0.92712', 'weight':+0.036,'color':"indigo" },
         { 'name': f'0.92732', 'weight':+0.04, 'color':"blue" },
         { 'name': f'0.92740', 'weight':+0.074,'color':"navy" },
         { 'name': f'0.92756', 'weight':+0.15, 'color':"mediumblue" },
         { 'name': f'0.92761c','weight':+0.70, 'color':"royalblue" },]  
}
df_cross2 = h_blend(params, figures1=True, figures2=True, details=True)

display_distances(params)


df_cross = pd.read_csv('/kaggle/input/playground-series-s5e11/sample_submission.csv')

df_cross['loan_paid_back'] = \
    df_cross1['loan_paid_back'] * 0.5 + \
    df_cross2['loan_paid_back'] * 0.5

df_cross.to_csv('submission__Group1_x_Group2__0_92762.csv',index=False)
...
params = {
      ...
      'id_target': ['id',"loan_paid_back"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [ +0.0006, +0.0004, +0.0003, +0.0002, 
                     -0.0001,-0.0002,-0.0003,-0.0004,-0.0005 ],
      'subm'     : [    
         { 'name': f'0.92664', 'weight':+0.001, 'color':"crimson"      },
         { 'name': f'0.92684', 'weight':+0.002, 'color':"red"          },
         { 'name': f'0.92712', 'weight':+0.003, 'color':"tomato"       },
         { 'name': f'0.92722', 'weight':+0.004, 'color':"darkgreen"    },
         { 'name': f'0.92732', 'weight':+0.005, 'color':"forestgreen"  },
         { 'name': f'0.92740', 'weight':+0.006, 'color':"limegreen"    },
         { 'name': f'0.92756', 'weight':+0.009, 'color':"navy"         },
         { 'name': f'0.92761', 'weight':+0.950, 'color':"darkmagenta"  }, 
         { 'name': f'0.92761c','weight':+0.020, 'color':"midnightblue" },]  
}
