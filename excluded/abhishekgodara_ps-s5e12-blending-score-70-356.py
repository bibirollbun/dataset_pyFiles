...
# ------------------------------------------------------------------------
    ...
    def da(dk,sorting_direction,show_details):
        ...
        if len(wts) == 1:
            ...
            # ----- ADD WEIGHT SHIFT NOISE (Â±5%) -----
            noise_strength = 0.05  # 5%
...
params = {
      ...
      'subm'     : [
         { 'name': f'0.70009', 'weight':+0.101, 'color':'tomato'},
         { 'name': f'0.70108', 'weight':+0.301, 'color':'darkmagenta'},
         { 'name': f'0.70109', 'weight':+0.299, 'color':'limegreen'},
         { 'name': f'0.70110', 'weight':+0.299, 'color':'royalblue'},]
}
