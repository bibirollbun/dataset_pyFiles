...
_ = pd.read_csv('/kaggle/input/playground-series-s5e7/sample_submission.csv', index_col='id')
_
...
train_df.dropna(axis=0, subset=['Personality'], inplace=True)
...
output = pd.DataFrame({"id":X_test.index, "Personality":preds})
output
