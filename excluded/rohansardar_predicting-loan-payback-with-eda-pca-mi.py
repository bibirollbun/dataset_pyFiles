...
for col in object_cols:
    ...
    sns.countplot(x=col, hue='loan_paid_back', data=train_fe)
...
for col in numerical_cols:
    ...
    sns.boxplot(x='loan_paid_back', y=col, data=train_fe)
...
for obj in object_cols:
    ...
    test_fe[obj] = encoder.transform(test_fe[obj])
...
test_scaled_df = pd.DataFrame(test_scaled, columns=test_fe.columns)
test_scaled_df.head()
...
xgb_search = RandomizedSearchCV(estimator=xgb, param_distributions=xgb_params, n_iter=100,
