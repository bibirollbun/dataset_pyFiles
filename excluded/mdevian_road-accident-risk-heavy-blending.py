...
# alias -> path
subs = {
    "sub1": "/kaggle/input/road-accident-risk-1/autogluon_experiment9.csv",
    "sub2": "/kaggle/input/road-accident-risk-1/submission blending.csv",
    "sub3": "/kaggle/input/road-accident-risk-1/submission extrapolative.csv",
}
...
# Normalize weights
weights = { subs[a]: w for a, w in weights_by_alias.items() }
