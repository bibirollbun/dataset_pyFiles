...
def color_scheme(dk,color):
    ...
    clr_alls3 = ["gold",'mediumblue','blue']
    clr_alls4 = ['crimson',"darkmagenta",'mediumblue','blue']
...
path = f'/kaggle/input/01-november-2025-ps-s5e11/submission_'
...
params = {
      ...
      'subm'     : [
         { 'name': f'0.92235','weight':-0.04 },
         { 'name': f'0.92637','weight':+0.12 },
         { 'name': f'0.92657','weight':+0.27 },
         { 'name': f'0.92670','weight':+0.65 },
      ]
}
