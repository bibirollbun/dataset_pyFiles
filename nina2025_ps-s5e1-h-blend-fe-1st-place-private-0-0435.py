...
def color_scheme(dk,color):
    ...
    clr_tes7  = ['Dimgray']+['gray']+["darkgray"]+['gold']+["silver"]+['gainsboro']+['whitesmoke']
...
def bokeh_show(
    ...
    if show_figures2 == True:
        ...
        line_y     = [dfs[i][b:e]['num_sold'] for i in range(len(dfs))]
    ...
    def load(path,fs_names):
        ...
        for i in range(len(dfs)):
            dfs[i] = dfs[i].rename(columns={
                "target": f'{fs_names[i]}',"num_sold": f'{fs_names[i]}'})
...
# path ='/kaggle/input/ps-s5e1/submission '

# params = {
#       'path'     : path,            
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.09,+0.07,+0.04, -0.01,-0.03,-0.05,-0.11 ], # v1.LB = 0.04357     
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.20 },
#          { 'name': f'0.04300.2', 'weight': +0.20 },
#          { 'name': f'0.04408',   'weight': +0.20 },
#          { 'name': f'0.04422',   'weight': +0.21 },
#          { 'name': f'0.04605',   'weight': +0.13 },
#          { 'name': f'0.04733',   'weight': +0.10 },
#          { 'name': f'0.04970',   'weight': -0.04 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.09,+0.07,+0.04, -0.01,-0.03,-0.05,-0.11 ], # v3.LB = 0.04466       
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.21 },
#          { 'name': f'0.04300.2', 'weight': +0.21 },
#          { 'name': f'0.04408',   'weight': +0.21 },
#          { 'name': f'0.04422',   'weight': +0.21 },
#          { 'name': f'0.04605',   'weight': +0.11 },
#          { 'name': f'0.04733',   'weight': +0.09 },
#          { 'name': f'0.04970',   'weight': -0.04 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.09,+0.07,+0.04, -0.01,-0.03,-0.05,-0.11 ], # v4.LB = 0.04350       
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.19 },
#          { 'name': f'0.04300.2', 'weight': +0.18 },
#          { 'name': f'0.04408',   'weight': +0.17 },
#          { 'name': f'0.04422',   'weight': +0.25 },
#          { 'name': f'0.04605',   'weight': +0.14 },
#          { 'name': f'0.04733',   'weight': +0.11 },
#          { 'name': f'0.04970',   'weight': -0.04 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.09,+0.07,+0.04, -0.01,-0.03,-0.05,-0.11 ], # v5.LB = 0.04538     
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.40 },
#          { 'name': f'0.04300.2', 'weight': +0.40 },
#          { 'name': f'0.04408',   'weight': +0.10 },
#          { 'name': f'0.04422',   'weight': +0.11 },
#          { 'name': f'0.04605',   'weight': +0.05 },
#          { 'name': f'0.04733',   'weight': +0.04 },
#          { 'name': f'0.04970',   'weight': -0.10 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.09,+0.07,+0.04, -0.01,-0.03,-0.05,-0.11 ], # v6.LB = ?     
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.95 },
#          { 'name': f'0.04300.2', 'weight': +0.05 },
#          { 'name': f'0.04408',   'weight': +0.04 },
#          { 'name': f'0.04422',   'weight': +0.03 },
#          { 'name': f'0.04605',   'weight': +0.02 },
#          { 'name': f'0.04733',   'weight': +0.01 },
#          { 'name': f'0.04970',   'weight': -0.10 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.07,-0.03,-0.04 ],            # v7.LB = 0.04534   
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.34 },
#          { 'name': f'0.04300.2', 'weight': +0.33 },
#          { 'name': f'0.04408',   'weight': +0.33 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.07,-0.03,-0.04 ],            # v8.LB = 0.04560   
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.90 },
#          { 'name': f'0.04300.2', 'weight': +0.05 },
#          { 'name': f'0.04408',   'weight': +0.05 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.11,-0.01,-0.03,-0.07 ],            # v9.LB = 0.04461 
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.25 },
#          { 'name': f'0.04300.2', 'weight': +0.25 },
#          { 'name': f'0.04408',   'weight': +0.25 },
#          { 'name': f'0.04422',   'weight': +0.25 },]
# }
...
#       'id_target': ['id',"num_sold"],          
#       'type_sort': ['asc/desc',0.30, 0.70],
#       'subwts'   : [ +0.11,-0.01,-0.03,-0.07 ],            # v10.LB = 0.04453
#       'subm'     : [ 
#          { 'name': f'0.04300.1', 'weight': +0.15 },
#          { 'name': f'0.04300.2', 'weight': +0.15 },
#          { 'name': f'0.04408',   'weight': +0.15 },
#          { 'name': f'0.04422',   'weight': +0.55 },]
# }
...
params = {
      ...
      'id_target': ['id',"num_sold"],          
      'type_sort': ['asc/desc',0.30, 0.70],
      'subwts'   : [ +0.09,+0.07,+0.04, -0.01,-0.03,-0.05,-0.11 ], # v11.LB = 0.04350       
      'subm'     : [ 
         { 'name': f'0.04300.1', 'weight': +0.19 },
         { 'name': f'0.04300.2', 'weight': +0.18 },
         { 'name': f'0.04408',   'weight': +0.17 },
...
df_cross = h_blend ( params, color='tes7', figures1=True, figures2=True, details=True)

df_cross['num_sold'] = df_cross['num_sold'].astype(int)
