...
class CustomModel(nn.Module):
    def __init__(self, pretrained=False):
        super().__init__()        
        self.model = timm.create_model("tf_efficientnet_b3_ns", pretrained=pretrained, in_chans=3)
...
for i in [0, 1, 2]:
    ...
    model = Tez(model)
    model.load(f"/kaggle/input/pooja-10151-training-siim-isic-melanoma/model_f{i}.bin", weights_only=True)
