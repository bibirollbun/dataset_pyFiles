...
traindf.isnull().sum() #checking if there is any null valus exits or not!


testdf.isnull().sum()


print("All information about the train dataset:")
traindf.info()
print("\nAll information about the test dataset:")
testdf.info()
...
numeric_cols = traindf.select_dtypes(include=['int64', 'float64']).columns.drop("accident_risk")
...
print("\nâœ… Submission file 'submission.csv' created using XGBoost pipeline!")
