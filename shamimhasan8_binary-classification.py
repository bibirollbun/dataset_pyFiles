...
# path4 = '/kaggle/input/4-august-2025-ps-s5e8/'

# submission__0_97472  = pd.read_csv(path4 + 'submission 0.97472.csv')
# submission__0_97538  = pd.read_csv(path3 + 'submission 0.97538.csv')
# submission__0_97539  = pd.read_csv(path3 + 'submission 0.97539.csv')
# submission__0_975941 = pd.read_csv(path3 + 'submission 0.975941.csv')
# submission__0_975942 = pd.read_csv(path3 + 'submission 0.975942.csv')

# submission__0_97472 .to_csv('submission 0.97472.csv',  index=False)
# submission__0_97538 .to_csv('submission 0.97538.csv',  index=False)
# submission__0_97539 .to_csv('submission 0.97539.csv',  index=False)
# submission__0_975941.to_csv('submission 0.975941.csv', index=False)          
# submission__0_975942.to_csv('submission 0.975942.csv', index=False)
#---------------------------------------------------------------------------- LB=0.97640


# file_short_names = ['0.97472','0.97538','0.97539','0.975941','0.975942']
...
#          { 'name':file_short_names[2],'weight':0.11, },      LB = 0.97640
#          { 'name':file_short_names[3],'weight':0.29, },
#          { 'name':file_short_names[4],'weight':0.47, },
#       ]
#     }
...
1.                  no_data  + 0.97472  -> x1_data
2.                  0.97538  + 0.97539  -> x2_data
3.                  0.975941 + 0.975942 -> x3_data
...
subm_x11 = pd.read_csv(        'submission no_data.csv' )
subm_x12 = pd.read_csv(path4 + 'submission 0.97472.csv' )
subm_x21 = pd.read_csv(path3 + 'submission 0.97538.csv' )
subm_x22 = pd.read_csv(path3 + 'submission 0.97539.csv' )
subm_x31 = pd.read_csv(path3 + 'submission 0.975941.csv')
subm_x32 = pd.read_csv(path3 + 'submission 0.975942.csv')
...
straight_blend(subm_x31, subm_x32, 'x3_data.csv')
...
#          { 'name':file_short_names[2],'weight':0.07, },     # Lb = 0.97716
#          { 'name':file_short_names[3],'weight':0.10, },
#          { 'name':file_short_names[4],'weight':0.79, },
#       ]
#     }
...
#       'desc'   : 0.70,
#       'asc'    : 0.30,
#       'subwts' : [+0.08, +0.03, -0.01, -0.04, -0.06],       # Lb = 0.97717
#       'subm'   : [
#          { 'name':file_short_names[0],'weight':0.015, },
#          { 'name':file_short_names[1],'weight':0.030, },
#          { 'name':file_short_names[2],'weight':0.070, },
#          { 'name':file_short_names[3],'weight':0.080, },
#          { 'name':file_short_names[4],'weight':0.805, },
#       ]
#     }
...
params = {
      ...
      'desc'   : 0.70,
      'asc'    : 0.30,
      'subwts' : [+0.087, +0.033, -0.012, -0.043, -0.065],        # Lb = 
      'subm'   : [
         { 'name':file_short_names[0],'weight':0.015, },
         { 'name':file_short_names[1],'weight':0.030, },
         { 'name':file_short_names[2],'weight':0.055, },
         { 'name':file_short_names[3],'weight':0.080, },
         { 'name':file_short_names[4],'weight':0.820, },
      ]
    }

df = hv_blend ( path, file_short_names, params )

df.to_csv('submission_internal_my.csv', index=False)

display(df)


subm_internal_my = pd.read_csv('submission_internal_my.csv')
subm_ext_v_blend = pd.read_csv('/kaggle/input/ps-s5e7-binary-classification-v-blend/submission.csv')

submission = straight_blend(subm_internal_my, subm_ext_v_blend, 'submission.csv', wts=[0.85,0.15])
