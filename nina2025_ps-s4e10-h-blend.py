    ...
    def load(path,fs_names):
        ...
        for i in range(len(dfs)):
            dfs[i] = dfs[i].rename(columns={
                "target": f'{fs_names[i]}',"loan_status": f'{fs_names[i]}'})
...
def procedure_Cage(FiN_import,n_iter=4,ks1=[1.0054,0.0021],ks2=[1.00037,0.00037]):
    ...
    per = sub_import['loan_status'].values
    # ..................................................................................................
    sns.set()
    plt.figure(figsize=(5, 2))
    plt.hist(per, bins=80)
    plt.gca().set_facecolor('mintcream')
    plt.suptitle('Before | loan_status', y=0.96, fontsize=12, c='navy')
    # ..................................................................................................
    print('- - - - - - - ',FiN_import)
    ...
    plt.suptitle('After | loan_status', y=0.96, fontsize=11, c='navy')
    # .......................................................................
    min_per  = np.min(per);  print('Min:',  round(min_per, 7))
    max_per  = np.max(per);  print('Max:',  round(max_per, 7))
    mean_per = np.mean(per); print('Mean:', round(mean_per,7)); 
...
def Cage_by_MehranKazeminia(file_name_to_Cage):
    ...
    plt.hist(per, bins=80)
    plt.gca().set_facecolor('mintcream')
    plt.suptitle('Before | loan_status', y=0.96, fontsize=13, c='navy')
    # ...................................................................................
    ...
    plt.hist(per, bins=80)
    plt.gca().set_facecolor('snow')
    plt.suptitle('After | loan_status', y=0.96, fontsize=12, c='navy')
    ...
    plt.suptitle('After the after | loan_status', y=0.96, fontsize=11, c='navy')
    # .......................................................................
    min_per  = np.min (per) ;print('Min:',  round(min_per, 3))
    max_per  = np.max (per) ;print('Max:',  round(max_per, 3))
    mean_per = np.mean(per) ;print('Mean:', round(mean_per,3))
...
path ='/kaggle/input/ps-s4e10/submission_'
...
params = {
      'path'     : path,            
      'id_target': ['id',"loan_status"],          
      'type_sort': ['asc/desc',0.30, 0.70],
      'subwts'   : [ +0.04,+0.03,+0.02,+0.01,0,-0.01,-0.02,-0.03,-0.04],      
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.16 },
         { 'name': f'0.97405','weight': +0.14 },
         { 'name': f'0.97404','weight': +0.13 },
         { 'name': f'0.97389','weight': +0.12 },
         { 'name': f'0.97363','weight': +0.11 },
         { 'name': f'0.97355','weight': +0.10 },
         { 'name': f'0.97344','weight': +0.09 },
         { 'name': f'0.97325','weight': +0.08 },
         { 'name': f'0.97321','weight': +0.07 },]
}
...
params = {
      ...
      'subwts'   : [ +0.04,+0.03,+0.02,+0.01,0,-0.01,-0.02,-0.03,-0.04],       
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.18 },
         { 'name': f'0.97405','weight': +0.15 },
         { 'name': f'0.97404','weight': +0.14 },
         { 'name': f'0.97389','weight': +0.13 },
         { 'name': f'0.97363','weight': +0.10 },
         { 'name': f'0.97355','weight': +0.09 },
         { 'name': f'0.97344','weight': +0.08 },
         { 'name': f'0.97325','weight': +0.07 },
         { 'name': f'0.97321','weight': +0.06 },]
}
...
params = {
      ...
      'subwts'   : [ +0.04,+0.03,+0.02,+0.01,0,-0.01,-0.02,-0.03,-0.04],       
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.20 },
         { 'name': f'0.97405','weight': +0.18 },
         { 'name': f'0.97404','weight': +0.17 },
         { 'name': f'0.97389','weight': +0.14 },
         { 'name': f'0.97363','weight': +0.10 },
         { 'name': f'0.97355','weight': +0.09 },
         { 'name': f'0.97344','weight': +0.05 },
         { 'name': f'0.97325','weight': +0.04 },
         { 'name': f'0.97321','weight': +0.03 },]
}
...
params = {
      ...
      'subwts'   : [ +0.04,+0.03,+0.02,+0.01,0,-0.01,-0.02,-0.03,-0.04],       
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.22 },
         { 'name': f'0.97405','weight': +0.20 },
         { 'name': f'0.97404','weight': +0.19 },
         { 'name': f'0.97389','weight': +0.14 },
         { 'name': f'0.97363','weight': +0.10 },
         { 'name': f'0.97355','weight': +0.09 },
         { 'name': f'0.97344','weight': +0.05 },
...
params = {
      ...
      'subwts'   : [ +0.04,+0.03,+0.02,+0.01,0,-0.01,-0.02,-0.03,-0.04],       
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.23 },
         { 'name': f'0.97405','weight': +0.21 },
         { 'name': f'0.97404','weight': +0.19 },
         { 'name': f'0.97389','weight': +0.17 },
         { 'name': f'0.97363','weight': +0.09 },
         { 'name': f'0.97355','weight': +0.08 },
         { 'name': f'0.97344','weight': +0.05 },
         { 'name': f'0.97325','weight': +0.02 },
         { 'name': f'0.97321','weight': -0.04 },]
}
...
params = {
      ...
      'subwts'   : [ +0.04,+0.03,+0.02,+0.01,0,-0.01,-0.02,-0.03,-0.04],       
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.25 },
         { 'name': f'0.97405','weight': +0.22 },
         { 'name': f'0.97404','weight': +0.20 },
         { 'name': f'0.97389','weight': +0.18 },
         { 'name': f'0.97363','weight': +0.08 },
         { 'name': f'0.97355','weight': +0.07 },
         { 'name': f'0.97344','weight': +0.04 },
         { 'name': f'0.97325','weight': +0.01 },
         { 'name': f'0.97321','weight': -0.05 },]
}
...
params = {
      ...
      'subwts'   : [ +0.04,+0.03,+0.02,+0.01,0,-0.01,-0.02,-0.03,-0.04],       
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.28 },
         { 'name': f'0.97405','weight': +0.25 },
         { 'name': f'0.97404','weight': +0.22 },
         { 'name': f'0.97389','weight': +0.21 },
         { 'name': f'0.97363','weight': +0.05 },
         { 'name': f'0.97355','weight': +0.04 },
         { 'name': f'0.97344','weight': +0.03 },
         { 'name': f'0.97325','weight': +0.00 },
         { 'name': f'0.97321','weight': -0.08 },]
}
...
params = {
      ...
      'subm'     : [ 
         { 'name': f'0.97406','weight': +0.52 },
         { 'name': f'0.97389','weight': +0.25 },
         { 'name': f'0.97344','weight': +0.15 },
         { 'name': f'0.97325','weight': +0.08 }]
}
...
params = {
      ...
      'subm'     : [ 
         { 'name': f'0.97389','weight': +0.70 },
         { 'name': f'0.97344','weight': +0.20 },
         { 'name': f'0.97325','weight': +0.10 }]
}
...
params = {
      ...
      'subwts'   : [ +0.10,-0.10 ],       
      'subm'     : [ 
         { 'name': f'0.97405','weight': +0.50 },
         { 'name': f'0.97406','weight': +0.50 }]
}
...
df_cross = h_blend(params, color='gold', figures1=True, figures2=True, details=True)
