...
pd.crosstab(train_data['Type of Travel'], train_data['Class'], margins=True)

# Heatmap of satisfaction rate by gender and class
ct = pd.crosstab(train_data['Gender'], train_data['Class'], values=(train_data['satisfaction'] == 'satisfied').astype(int), aggfunc='mean')
