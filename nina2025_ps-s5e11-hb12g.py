...
# version 1 LB=0.92_777

local_1_weights = [0.25, 0.30, 0.45]
group_1_weights = [0.55, 0.30, 0.15]

local_4_weights = [0.25, 0.30, 0.45]
group_4_weights = [0.50, 0.30, 0.20]

# version 2 LB=0.92_777

local_1_weights = [0.20, 0.25, 0.45]
group_1_weights = [0.55, 0.30, 0.15]

local_4_weights = [0.25, 0.30, 0.45]
group_4_weights = [0.55, 0.27, 0.18]

# version 3 LB=0.92_777

local_1_weights = [0.20, 0.25, 0.40]
group_1_weights = [0.55, 0.30, 0.15]

local_4_weights = [0.25, 0.30, 0.45]
group_4_weights = [0.55, 0.27, 0.18]

# version 4 LB=0.92_778
...
# version 6 LB=0.92_778

local_1_weights = [0.15, 0.25, 0.45]
group_1_weights = [0.57, 0.30, 0.13]

local_4_weights = [0.33, 0.33, 0.34]
group_4_weights = [0.34, 0.33, 0.33]

# version 7 LB=0.92_778          Top4

local_1_weights = [0.10, 0.25, 0.50]
group_1_weights = [0.59, 0.30, 0.11]

local_4_weights = [0.30, 0.30, 0.40]
group_4_weights = [0.40, 0.30, 0.30]

# version 8 LB=0.92_778

local_1_weights = [0.08, 0.25, 0.52]
group_1_weights = [0.61, 0.30, 0.09]

local_4_weights = [0.70, 0.15, 0.15]
group_4_weights = [0.15, 0.15, 0.70]

# version 9 LB=0.92_778          Top3
...
# version 10 LB=0.92_779         Top2

local_1_weights = [0.07, 0.30, 0.50]
group_1_weights = [0.58, 0.32, 0.10]

local_4_weights = [0.28, 0.44, 0.28]
group_4_weights = [0.28, 0.44, 0.28]

# version 11 LB=0.92_779  current Top

local_1_weights = [0.07, 0.31, 0.49]
group_1_weights = [0.55, 0.35, 0.10]

local_4_weights = [0.24, 0.52, 0.24]
group_4_weights = [0.24, 0.52, 0.24]

# version 12 LB=

local_1_weights = [0.07, 0.40, 0.45]
group_1_weights = [0.50, 0.40, 0.10]

local_4_weights = [0.10, 0.80, 0.10]
group_4_weights = [0.10, 0.80, 0.10]

# version 15 LB=

local_1_weights = [0.07, 0.40, 0.40]
group_1_weights = [0.40, 0.40, 0.07]
...
params = {
      ...
      'subm'     : [
         { 'name': f'_1', 'weight':+0.54, 'color':'brown'       },
         { 'name': f'_2', 'weight':+0.39, 'color':'chocolate'   },
         { 'name': f'_3', 'weight':+0.07, 'color':'sandybrown'  },
