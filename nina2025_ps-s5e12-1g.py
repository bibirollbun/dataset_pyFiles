...
params = {
      'path'     : '/kaggle/input/01-december-2025-ps-s5e12/',            
      'id_target': ['id',"diagnosed_diabetes"],          
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [w/100 for w in [10, -3,-7]],
      'subm'     : [
         { 'name': f'0.64020', 'weight':+0.10, 'color':'royalblue'},
         { 'name': f'0.69306', 'weight':+0.20, 'color':'green'},
         { 'name': f'0.69728', 'weight':+0.70, 'color':'red'},]
}
...
params = {
      ...
      'subwts'   : [w/100 for w in [10, -3,-7]],
      'subm'     : [
         { 'name': f'0.65555', 'weight':+0.10, 'color':'royalblue'},
         { 'name': f'0.69733', 'weight':+0.80, 'color':'green'},
         { 'name': f'noscore', 'weight':+0.10, 'color':'red'},]
}
...
params = {
      ...
      'subwts'   : [w/100 for w in [10, -3,-7]],
      'subm'     : [
         { 'name': f'0.69638', 'weight':+0.10, 'color':'royalblue'},
         { 'name': f'0.69652', 'weight':+0.10, 'color':'green'},
         { 'name': f'0.69821', 'weight':+0.80, 'color':'red'},]
}
...
params = {
      ...
      'subwts'   : [w/100 for w in [10, -3,-7]],
      'subm'     : [
         { 'name': f'g1', 'weight':+0.10, 'color':'mediumblue'},
         { 'name': f'g2', 'weight':+0.10, 'color':'darkgreen'},
         { 'name': f'g3', 'weight':+0.80, 'color':'crimson'},]
}
df_v3 = h_blend(params, details=True)
...
params = {'subm' : [
          {'name': f'0.64020', 'weight':+0.25, 'color':'royalblue'},
          {'name': f'0.69306', 'weight':+0.25, 'color':'green'},
          {'name': f'0.69728', 'weight':+0.50, 'color':'red'},]  
}
h_blend(params,_update=up, details=True, subm='g1.csv')

params = {'subm' : [
          {'name': f'0.65555', 'weight':+0.25, 'color':'royalblue'},
          {'name': f'0.69733', 'weight':+0.50, 'color':'green'},
          {'name': f'noscore', 'weight':+0.25, 'color':'red'},]
}
h_blend(params,_update=up, details=True, subm='g2.csv')

params = {'subm' : [
          {'name': f'0.69638', 'weight':+0.25, 'color':'royalblue'},
          {'name': f'0.69652', 'weight':+0.25, 'color':'green'},
          {'name': f'0.69821', 'weight':+0.50, 'color':'red'},]
}
h_blend(params,_update=up, details=True, subm='g3.csv')

params = {'subm' : [
          {'name': f'g1', 'weight':+0.20, 'color':'mediumblue'},
          {'name': f'g2', 'weight':+0.20, 'color':'darkgreen'},
          {'name': f'g3', 'weight':+0.60, 'color':'crimson'},]
}
up['path'] = '/kaggle/working/'

df_v5 = h_blend(params,_update=up, details=True)

for file in 'g1,g2,g3'.split(','): os.remove(f'/kaggle/working/{file}.csv')


df_comparison = pd.merge(df_v3, df_v5, on='id')
df_comparison["delta_proba's"] = df_v3['diagnosed_diabetes'] - df_v5['diagnosed_diabetes']
df_comparison


df_v5.to_csv('submission.csv',index=False)
df_v5
