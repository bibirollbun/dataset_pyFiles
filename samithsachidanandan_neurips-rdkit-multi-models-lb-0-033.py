...
sub = {
    ...
    'Tg':    train_and_evaluate(tg, test, ExtraTreesRegressor, 'Tg', submission=True), 
    ...
    'FFV': 0.3 * train_and_evaluate(ffv, test, ExtraTreesRegressor, 'FFV', submission=True) +         
           0.3 * train_and_evaluate(ffv, test, XGBRegressor, 'FFV', submission=True)+
            0.2 * train_and_evaluate(ffv, test, LGBMRegressor, 'FFV', submission=True)+
           0.2 * train_and_evaluate(ffv, test, CatBoostRegressor, 'FFV', submission=True),

    'Tc': 0.3 * train_and_evaluate(tc, test, ExtraTreesRegressor, 'Tc', submission=True) +
          0.2 * train_and_evaluate(tc, test, XGBRegressor, 'Tc', submission=True) +
          0.2 * train_and_evaluate(tc, test, LGBMRegressor, 'Tc', submission=True) +  
          0.3 * train_and_evaluate(tc, test, CatBoostRegressor, 'Tc', submission=True),
