...
categorical_cols = ['first_genre', 'production_company', 'director', 'writer', 'producer','lead_actor_name', 'original_language']
...
print("\n--- 4. Training model ---")
params = {'objective': 'regression_l1', 'metric': 'rmse', 'n_estimators': 3000,'learning_rate': 0.003, 'feature_fraction': 0.7, 'bagging_fraction': 0.7,'bagging_freq': 1, 'lambda_l1': 0.1, 'lambda_l2': 0.1, 'num_leaves': 31,'verbose': -1, 'n_jobs': -1, 'seed': 42, 'boosting_type': 'gbdt',}
...
submission = pd.DataFrame({'id': test_df['id'],'revenue': final_predictions})
...
print(importance_df.head(20)) # 上位20個を表示する
