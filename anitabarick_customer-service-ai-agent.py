...
class ReplyAgent:
    def create_reply(self, message, intent, urgency):
        if intent == "refund":
            return "I understand you want a refund. Please share your order ID number."
        if intent == "cancellation":
            return "I can help you cancel your subscription. Kindly provide your registered email ID."
        if intent == "billing":
            return "It seems you have a billing related problem. Please send your invoice number and date for verification."
        if intent == "general_help":
            return "Sure, I'm here to help. Could you please share more detail about your concern?"
