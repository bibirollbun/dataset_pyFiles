...
def export_conversation_history(filename="conversation_history.txt"):
    ...
    try:
        ...
        with open(filename, 'w') as f:
            f.write("=" * 60 + "\n")
            f.write("KAGGLEBOOST AI AGENT - CONVERSATION HISTORY\n")
            f.write("=" * 60 + "\n\n")
...
conv_file = export_conversation_history("kaggleboost_conversation.txt")

print()

# Export detailed logs
log_file = export_agent_logs("kaggleboost_logs.json")
