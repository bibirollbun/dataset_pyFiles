...
class FinalTabularMLPipeline:
    def __init__(self, target_column='stroke', random_state=42, max_categories=20):
        ...
        Args:
            ...
            max_categories (int): Maximum unique values to consider as categorical
        """
        self.target_column = target_column
        self.random_state = random_state
        self.max_categories = max_categories
        self.label_encoder = LabelEncoder()
        self.cat_encoder = None  # Will be initialized after data loading
    ...
    def _auto_detect_features(self, df):
        ...
        for col in df.columns:
            ...
            # String or object types are always categorical
            if pd.api.types.is_string_dtype(df[col]) or pd.api.types.is_object_dtype(df[col]):
                self.categorical.append(col)
            # Low cardinality numeric features
    ...
    def load_and_prepare_data(self, train_path, test_path=None, submission_path=None):
        """Load data with automatic feature detection"""
        ...
        # Auto-detect feature types from training data
        self._auto_detect_features(self.train)
        
        # Initialize encoder with detected categorical features
