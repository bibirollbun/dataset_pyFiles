...
filters = {
    'Tg': list(set([
        ...
        'FpDensityMorgan3','HallKierAlpha','Kappa3','MolLogP',
        'NumAmideBonds','NumHeteroatoms','NumHeterocycles','NumRotatableBonds',
        'PEOE_VSA14','Phi','RingCount','SMR_VSA1','SPS','TPSA'
    ...
    'FFV': list(set([
        ...
        'MaxEStateIndex','MinEStateIndex','MolLogP','MolMR','NHOHCount',
        'NOCount','NumAromaticHeterocycles','NumHAcceptors','NumHDonors',
        'NumHeterocycles','NumRotatableBonds','PEOE_VSA14','RingCount'
    ]).union(required_descriptors)),
