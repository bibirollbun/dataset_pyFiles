...
class Config:
    target = 'price'
    train = pd.read_csv('/kaggle/input/predicting-the-price-of-diamond/train.csv', index_col='id')
    test = pd.read_csv('/kaggle/input/predicting-the-price-of-diamond/test.csv', index_col='id')
...
submission[Config.target] = np.expm1(TEST_preds)
