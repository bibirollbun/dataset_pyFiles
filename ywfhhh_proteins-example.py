...
import pandas as pd
train_dataset = torch.load('/kaggle/input/sztu-graph-classification-proteins/PROTEINS_train.pt',weights_only=False)
test_dataset = torch.load('/kaggle/input/sztu-graph-classification-proteins/PROTEINS_test.pt',weights_only=False)
