...
params = {
      'path'     : '/kaggle/input/12-11-2025-ps-s5e11/submission ',            
      'id_target': ['id',"loan_paid_back"],
      'type_sort': ['asc/desc',0.30,0.70 ],
      'subwts'   : [ +0.03, -0.01,-0.02  ],
      'subm'     : [
         { 'name': f'0.92603', 'weight':+0.08, 'color':"silver" },
         { 'name': f'0.92712', 'weight':+0.45, 'color':"lemonchiffon" },
         { 'name': f'0.92718', 'weight':+0.47, 'color':"crimson" }]
}
