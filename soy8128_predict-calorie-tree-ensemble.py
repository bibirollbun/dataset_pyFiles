...
cross_features = numerical_features + ["BMI", "Intensity"] 
...
if DEBUG:
    ...
    models = {
        "LightGBM": LGBMRegressor(n_estimators=20, learning_rate=0.02, max_depth=1,
...
if DEBUG:
    DEBUG_pred = 0.4 * np.expm1(results["LightGBM"]["pred"])
    submission["Calories"] = np.clip(DEBUG_pred, 1, 314)
