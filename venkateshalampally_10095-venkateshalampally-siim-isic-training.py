...
df = pd.read_csv("/kaggle/input/10095-venkateshalampally-siim-isic-k-folds/train_5folds.csv")
df.head()


# Encode all categorical features (skip image_name, patient_id, target)
