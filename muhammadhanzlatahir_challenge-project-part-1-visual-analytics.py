...
df1 = app_train[['SK_ID_CURR', 'TARGET']].merge(
    prev_app[['SK_ID_CURR', 'NAME_CONTRACT_STATUS']], on='SK_ID_CURR', how='left')
...
df1_grouped.to_csv("loan_approval_vs_prev_app.csv", index=False)


# Merge previous applications with installments payments
df2 = prev_app[['SK_ID_CURR', 'SK_ID_PREV']].merge(
    inst_pay[['SK_ID_PREV', 'DAYS_ENTRY_PAYMENT']], on='SK_ID_PREV', how='left')
...
df2_final = df2_grouped.merge(app_train[['SK_ID_CURR', 'TARGET']], on='SK_ID_CURR', how='left')
...
# Merge with application_train
df3_final = df3_grouped.merge(app_train[['SK_ID_CURR', 'TARGET']], on='SK_ID_CURR', how='left')
...
# Merge with application_train
df4_final = df4.merge(app_train[['SK_ID_CURR', 'TARGET']], on='SK_ID_CURR', how='left')
