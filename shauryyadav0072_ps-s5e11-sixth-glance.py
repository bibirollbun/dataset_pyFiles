...
def straight_blend(df1,df2,df3, wts=[0.34, 0.30, 0.30], sub=''):
    t = 'loan_paid_back'
...
params = {
      ...
      'subm'     : [
          ...
          {'name': f'0.92727', 'weight':+0.11, 'color':'forestgreen'},
          {'name': f'0.92730', 'weight':+0.11, 'color':'darkgreen'  },
...
straight_blend(df1,df2,df3, wts=[0.13, 0.16, 0.71], sub='Group_A.csv')
...
straight_blend(df1,df2,df3, wts=[0.14, 0.14, 0.72], sub='Group_B.csv')
...
straight_blend(df1,df2,df3, wts=[0.13, 0.13, 0.74], sub='Group_C.csv')
