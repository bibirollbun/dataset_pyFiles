...
df = pd.read_csv("/kaggle/input/ml-dataset-c221137/train_dataset.csv")
...
train_df = pd.read_csv("/kaggle/input/ml-dataset-c221137/train_dataset.csv")
test_df = pd.read_csv("/kaggle/input/ml-dataset-c221137/test_dataset_exam.csv")
