...
train = pd.read_csv('/kaggle/input/eda-n-folds-lmsys-23bcs10157/train_5folds.csv')
final_df.head()
...
for kfold in range(kfolds):
    ...
    model_loaded.load_state_dict(torch.load(f"/kaggle/input/inference-lmsys-23bcs10157/lstm_classifier_kfold_{kfold}_epoch_{epoches_to_use[kfold]}.pth", map_location=device))
