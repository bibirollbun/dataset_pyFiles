...
data_yaml='''
path: /kaggle/input/multi-class-object-detection-challenge/Data
...
test_images_path = "/kaggle/input/multi-class-object-detection-challenge/Data/testImages/images"
