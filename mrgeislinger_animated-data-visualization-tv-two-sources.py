...
path_to_sign = train[train.sign == 'TV'].path.sample(1).tolist()[0]
path_to_sign
...
# my values
dir = '/kaggle/input/demo-asl-video-isolated-sign-to-landmarks-data'
path_to_sign = 'TV-gtsignstudy4a.8031-TV-2023_01_24_20_22_42.559-0.parquet'
