...
train_loader = DataLoader(train_ds, batch_size=64, collate_fn=collator, shuffle=True)

val_data = parsed_data_dict['val']['sents']
val_ds = JointDataset(val_data, label2id_intents, label2id_slots)
val_loader = DataLoader(val_ds, batch_size=8, collate_fn=collator, shuffle=False)

test_data = parsed_data_dict['test']['sents']
test_ds = JointDataset(test_data, label2id_intents, label2id_slots)
test_loader = DataLoader(test_ds, batch_size=8, collate_fn=collator, shuffle=False)
...
SUBMIT_NAME: submit_d15dc979.csv
   id                intent                                              slots
0   1  SearchScreeningEvent  O O O O O I-movie_name O I-location I-location...
1   2    SearchCreativeWork              O O O O I-object_name I-object_name O
2   3          weather/find                          O O O O O O O O O O O O O
3   4    SearchCreativeWork    O O O I-object_name I-object_name I-object_name
4   5              RateBook  O O O O I-object_name I-object_name O I-object...
5   6              RateBook  O O I-object_name I-object_name I-object_name ...
6   7    SearchCreativeWork                O O O I-object_name O I-object_name
7   8             PlayMusic                  O O O O O O I-object_name O O O O
8   9    SearchCreativeWork  O O O I-object_name I-object_name I-object_nam...
9  10          weather/find  O O O I-object_name I-object_name I-object_nam...
