...
formatted_dataset[:100].keys()


for i in tqdm(range(23800, 28000, BATCH_SIZE), desc="Generating responses"):
    ...
    # updated_rows.update(batch_data)


    with open("backup.json", "w") as f:
        json.dump(updated_rows, f, indent=2)

    print(f"========ITERATION {i} / 15000 DONE===========")
