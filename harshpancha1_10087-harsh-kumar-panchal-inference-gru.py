...
train = pd.read_csv('/kaggle/input/10087-harsh-kumar-panchal-creating-folds-lmsys/train_5folds.csv')
final_df.head()
...
for kfold in range(kfolds):
    ...
    model_path = f"/kaggle/input/10087-harsh-kumar-panchal-training-gru/gru_classifier_kfold_{kfold}_epoch_{epoches_to_use[kfold]}.pth"
