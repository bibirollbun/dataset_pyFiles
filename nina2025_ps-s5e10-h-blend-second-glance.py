...
def blend(path, short_name1, short_name2, w=[0.50, 0.50]):
...
path = f'/kaggle/input/8-october-2025-ps-s5e10/submission_'

params = {
      'path'     : path,            
      'id_target': ['id',"accident_risk"],          
      'type_sort': ['asc/desc',0.30,0.70],
      'subwts'   : [ +0.07, -0.02,-0.05 ],
      'subm'     : [
         { 'name': f'0.05543.a','weight':+0.80 },
         { 'name': f'0.05545.a','weight':+0.10 },
         { 'name': f'0.05546.f','weight':+0.10 },]
}

df_cross1_red31 = h_blend(params,color='red31',figures1=True)#,details=True)

df_cross1_red31.to_csv('submission_g1_red31.csv',index=False)

matrix_distances = matrix_vs( path, ['0.05543.a','0.05545.a','0.05546.f'] )

display(matrix_distances)

display(df_cross1_red31.head(5))
...
params = {
      ...
      'subwts'   : [ +0.07, -0.02,-0.05 ],
      'subm'     : [
         { 'name': f'0.05546.g','weight':+0.80 },
         { 'name': f'0.05549.b','weight':+0.35 },
         { 'name': f'0.05552.e','weight':-0.15 },]
}

df_cross1_red13 = h_blend(params,color='red13',figures1=True)#,details=True)

df_cross1_red13.to_csv('submission_g1_red13.csv',index=False)

matrix_distances = matrix_vs( path, ['0.05546.g','0.05549.b','0.05552.e'] )

display(matrix_distances)

display(df_cross1_red13.head(5))


df_cross1 = pd.read_csv('/kaggle/input/playground-series-s5e10/sample_submission.csv')

df_cross1["accident_risk"] =\
    df_cross1_red31["accident_risk"] *0.85 + \
    df_cross1_red13["accident_risk"] *0.15

df_cross1.to_csv('submission_g1.red.csv',index=False)

path = '/kaggle/working/submission_'

matrix_distances = matrix_vs( path, ['g1_red31','g1_red13'] )

display(matrix_distances)

display(df_cross1.head(5))
...
params = {
      ...
      'id_target': ['id',"accident_risk"],          
      'type_sort': ['asc/desc',0.30,0.70],
      'subwts'   : [ +0.07, -0.01,-0.02,-0.04 ],
      'subm'     : [
         { 'name': f'0.05547.a','weight':+0.74 },
         { 'name': f'0.05548.b','weight':+0.24 },
         { 'name': f'0.05549.c','weight':+0.19 },
         { 'name': f'0.05552.b','weight':-0.17 },]
}

df_cross2 = h_blend(params,color='green4',figures1=True)#,details=True)

df_cross2.to_csv('submission_g2.green.csv',index=False)

matrix_distances = matrix_vs( path, ['0.05547.a','0.05548.b','0.05549.c','0.05552.b'] )

display(matrix_distances)

display(df_cross2.head(5))
...
params = {
      ...
      'subwts'   : [ +0.07, -0.01,-0.02,-0.04 ],
      'subm'     : [
         { 'name': f'0.05548.a','weight':+0.85 },
         { 'name': f'0.05549.a','weight':+0.27 },
         { 'name': f'0.05550.c','weight':-0.04 },
         { 'name': f'0.05552.a','weight':-0.08 },]
}

df_cross3 = h_blend(params,color='blue4',figures1=True)#,details=True)

df_cross3.to_csv('submission_g3.blue.csv',index=False)

matrix_distances = matrix_vs(path,['0.05548.a','0.05549.a','0.05550.c','0.05552.a'])

display(matrix_distances)

display(df_cross3.head(5))
...
params = {
      ...
      'subwts'   : [ +0.07, -0.01,-0.02,-0.04 ],
      'subm'     : [
         { 'name': f'0.05548.c','weight':+0.74 },
         { 'name': f'0.05550.d','weight':+0.39 },
         { 'name': f'0.05551.a','weight':-0.05 },
         { 'name': f'0.05552.f','weight':-0.08 },]
}

df_cross4 = h_blend(params,color='brown',figures1=True)#,details=True)

df_cross4.to_csv('submission_g4.brown.csv',index=False)

matrix_distances = matrix_vs(path,['0.05548.c','0.05550.d','0.05551.a','0.05552.f'])

display(matrix_distances)

display(df_cross4.head(5))
...
#       'id_target': ['id',"accident_risk"],          
#       'type_sort': ['asc/desc',0.30,0.70],
#       'subwts'   : [ +0.14, -0.02,-0.04,-0.08 ],     # Version.10.LB=0.055_43
#       'subm'     : [
#          { 'name': f'g1.red',  'weight':+0.58 },
#          { 'name': f'g2.green','weight':+0.15 },
#          { 'name': f'g3.blue', 'weight':+0.14 },
#          { 'name': f'g4.brown','weight':+0.13 },]
# }

# df_cross5 = h_blend(params,color='alls4j',figures1=True,details=True)
# df_cross5.to_csv('submission_h-blend(g1,g2,g3,g4).ver.10.csv',index=False)
# matrix_distances = matrix_vs(path,['g1.red','g2.green','g3.blue','g4.brown'])
# matrix_distances
...
#       'id_target': ['id',"accident_risk"],          
#       'type_sort': ['asc/desc',0.30,0.70],
#       'subwts'   : [ +0.11, -0.01,-0.03,-0.07 ],     # Version.11.LB=0.055_43
#       'subm'     : [
#          { 'name': f'g1.red',  'weight':+0.67 },
#          { 'name': f'g2.green','weight':+0.12 },
#          { 'name': f'g3.blue', 'weight':+0.11 },
#          { 'name': f'g4.brown','weight':+0.10 },]
# }

# df_cross5 = h_blend(params,color='alls4j',figures1=True,details=True)
# df_cross5.to_csv('submission_h-blend(g1,g2,g3,g4).ver.11.csv',index=False)
# matrix_distances = matrix_vs(path,['g1.red','g2.green','g3.blue','g4.brown'])
# matrix_distances
...
params = {
      ...
      'subwts'   : [ +0.07, -0.01,-0.02,-0.04 ],
      'subm'     : [
         { 'name': f'g1.red',  'weight':+0.85 },
         { 'name': f'g2.green','weight':+0.10 },
         { 'name': f'g3.blue', 'weight':+0.07 },
         { 'name': f'g4.brown','weight':-0.02 },]
}

df_cross5 = h_blend(params,color='alls4j',figures1=True,details=True)

df_cross5.to_csv('submission_h-blend(g1,g2,g3,g4).ver.12.csv',index=False)
...
path = '/kaggle/input/8-october-2025-ps-s5e10/submission_'

fsn = ['0.05543.v1','0.05543.v2','0.05543.v3','0.05542.v4','0.05542.v5','0.05542.v6']
...
fsn = [
    '0.05543.a','0.05545.a','0.05546.f','0.05546.g','0.05547.a','0.05548.a','0.05548.b',
    '0.05549.a','0.05549.b','0.05549.c','0.05550.c','0.05550.d','0.05551.a',
    '0.05552.a','0.05552.b','0.05552.e','0.05552.f'
]
...
p = '/kaggle/input/8-october-2025-ps-s5e10/submission_'

v12 = pd.read_csv('/kaggle/working/submission_h-blend(g1,g2,g3,g4).ver.12.csv')

v1 = pd.read_csv(p + '0.05543.v1.csv')
v3 = pd.read_csv(p + '0.05543.v3.csv')
v2 = pd.read_csv(p + '0.05543.v2.csv')
v4 = pd.read_csv(p + '0.05542.v4.csv')
v6 = pd.read_csv(p + '0.05542.v6.csv')

df = pd.read_csv('/kaggle/input/playground-series-s5e10/sample_submission.csv')

t = "accident_risk"

df[t] = v12[t] *1.05 - 0.05* v1[t]
df[t] =  df[t] *1.05 - 0.05* v3[t]
df[t] =  df[t] *1.05 - 0.05* v2[t]
df[t] =  df[t] *1.05 - 0.05* v4[t]
df[t] =  df[t] *1.05 - 0.05* v6[t]

for subm in [
    pd.read_csv(p + '0.05543.a.csv'),
    pd.read_csv(p + '0.05545.a.csv'),
    pd.read_csv(p + '0.05546.f.csv'),
    pd.read_csv(p + '0.05546.g.csv'),
    pd.read_csv(p + '0.05547.a.csv'),
    pd.read_csv(p + '0.05548.a.csv'),
    pd.read_csv(p + '0.05548.b.csv'),
    pd.read_csv(p + '0.05549.a.csv'),
    pd.read_csv(p + '0.05549.b.csv'),
    pd.read_csv(p + '0.05549.c.csv'),
    pd.read_csv(p + '0.05550.c.csv'),
    pd.read_csv(p + '0.05550.d.csv'),
    pd.read_csv(p + '0.05551.a.csv'),
    pd.read_csv(p + '0.05552.a.csv'),
    pd.read_csv(p + '0.05552.b.csv'),
    pd.read_csv(p + '0.05552.e.csv'),
    pd.read_csv(p + '0.05552.f.csv'),
]:   
    df[t] = df[t] *1.017 - 0.017* subm[t]
