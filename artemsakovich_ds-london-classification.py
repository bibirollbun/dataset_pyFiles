...
x_train,x_test,y_train,y_test = train_test_split(train_data,train_labels, test_size = 0.30, random_state = 505)
...
rfc_model = RandomForestClassifier(n_estimators = 100,random_state = 505)
...
print('Random Forest',cross_val_score(rfc_model,norm_train_data, train_labels.values.ravel(), cv=15).mean())
