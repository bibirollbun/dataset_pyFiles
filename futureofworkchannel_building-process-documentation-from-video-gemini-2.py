...
files = [
  upload_to_gemini("/kaggle/input/rpa-credit-bank-business-process-videos/process acme - sha1 - process 5.mp4", mime_type="video/mp4")
]
...
# Cost of the previeus step was about $0.006 (0.02 PLN)
# 1 minute of work 0.81 PLN
...
# Display results
generateCostComparisonCharts("gemini-1.5-pro", queries)
generateCostComparisonCharts("gemini-1.5-flash", queries)
