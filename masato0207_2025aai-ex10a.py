...
#print(len(train))
#print(len(test))
#print(train[train["card_id"] == "C_ID_d639edf6cd"]["first_active_month"])
...
# # 集約特徴の作成パターンを辞書化
agg_funcs = {
     "purchase_amount": ['min', 'max', 'mean', 'median','std'], # 正規化済みの購入金額（負値 = 顧客の支出）
     "installments":    ['min', 'max', 'median','std'],# 分割払いの分割回数
