...
params = {
    'booster': 'gbtree',
    'lambda': 0.006666671423087813,
    'alpha': 0.008837535662106858,
    'colsample_bytree': 0.47245266417648174,
    'subsample': 0.8604641136794223,
    'learning_rate': 0.20438213030492847,
    'max_depth': 10,
    'min_child_weight': 5
}


parameters = {'booster': 'gbtree', 'lambda': 0.10981716650591189, 'alpha': 0.06328862792362104, 'colsample_bytree': 0.44480879299923415, 'subsample': 0.9421836308948885, 'learning_rate': 0.25235148428479065, 'max_depth': 10, 'min_child_weight': 4}
