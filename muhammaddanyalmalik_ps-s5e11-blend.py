...
def main():
    ...
    weight_dict = {
        ...
        # "/kaggle/input/predicting-loan-payback-vault/submission (1).csv": 0.5,
        "/kaggle/input/17-11-2025-ps-s5e11/submission 4.e.csv":4.5,
        "/kaggle/input/17-11-2025-ps-s5e11/submission 5.d.csv":2.5,
        "/kaggle/input/17-11-2025-ps-s5e11/submission 7.a.csv":1.0,
        "/kaggle/input/17-11-2025-ps-s5e11/submission 7.b.csv":1.5,
        "/kaggle/input/17-11-2025-ps-s5e11/submission 7.c.csv":3.5
    }
    # Call blend function
