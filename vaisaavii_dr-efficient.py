...
# ✅ Save the full model in .h5 format to /kaggle/working
torch.save(model, '/kaggle/working/single_model.h5')
print("Saved full model to /kaggle/working/single_model.h5")
...
# ✅ Save final model only once at the end of cross-validation
torch.save(model, '/kaggle/working/dr2019_final_model.h5')
print("✅ Saved final DR 2019 model to /kaggle/working/dr2019_final_model.h5")


!mkdir -p /kaggle/working/final-models
!cp /kaggle/working/single_model.h5 /kaggle/working/final-models/
!cp /kaggle/working/dr2019_final_model.h5 /kaggle/working/final-models/


metadata = """
{
  "title": "DR EfficientNet Final Models",
  "id": "vaisaavii/dr-efficientnet-models",
  "licenses": [{"name": "CC0-1.0"}],
  "privacy": "private"
}
"""
with open('/kaggle/working/final-models/dataset-metadata.json', 'w') as f:
    f.write(metadata)



!kaggle datasets create -p /kaggle/working/final-models --dir-mode zip
