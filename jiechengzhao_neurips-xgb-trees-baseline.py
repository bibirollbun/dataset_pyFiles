...
sub_={'id':ID,'Tg':model(tg_,test,ExtraTreesRegressor(),'Tg',submission=True),
    'FFV':model(ffv_,test,ExtraTreesRegressor(),'FFV',submission=True),
    'Tc':model(tc_,test,ExtraTreesRegressor(),'Tc',submission=True),
    'Density':model(density_,test,ExtraTreesRegressor(),'Density',submission=True),
    'Rg':model(rg_,test,ExtraTreesRegressor(),'Rg',submission=True)}
