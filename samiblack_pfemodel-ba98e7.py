...
# âœ… Group by class_id and count the occurrences of each bounding box (instead of unique classes per image)
...
# âœ… Define the class mapping dictionary without 'Fibrosis & ILD'
class_mapping = {
    0: "Cardiac & Vascular", 
    1: "Lung Collapse",  
    2: "Cardiac & Vascular",
...
# âœ… Remove rows with class IDs 4 and 12 (since they are no longer mapped)
...
# âœ… Apply WBF Function (with filtering for "Fibrosis & ILD" before WBF)
...
# âœ… Apply WBF once (now without "Fibrosis & ILD")
...
# âœ… Define class names without 'Fibrosis & ILD'
class_names = [
    "Cardiac & Vascular",
    "Lung Collapse",
    "Lung Opacity",
...
# âœ… Adjust the 'new_class_id' mappings accordingly (shift the indices of the remaining classes)
...
# âœ… Visualize many images of the same class
...
path = "/usr/local/lib/python3.10/dist-packages/ultralytics/engine/trainer.py"
...
!zip -r yolov12-training.zip /kaggle/working/yolov12-training/yolo12m-vinbigdata/
