...
model = CustomModel()
model = Tez(model)
# model.load(f"/kaggle/input/training-petfinder-my-Customity-contest/model_f{i}.bin", weights_only=True)
model.load(f"/kaggle/input/v-shravanth10030/model_f0.bin", weights_only=True)
