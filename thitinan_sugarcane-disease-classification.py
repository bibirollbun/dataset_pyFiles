...
df = pd.read_csv('/kaggle/input/durian-hackathon-sugarcane-disease-classification/train.csv')
...
train_generator = train_datagen.flow_from_dataframe(
    train_df, 
    "/kaggle/input/durian-hackathon-sugarcane-disease-classification/Images", 
    x_col='id',
    y_col='label',
...
#test data
test_df = pd.read_csv('/kaggle/input/durian-hackathon-sugarcane-disease-classification/submit.csv')
