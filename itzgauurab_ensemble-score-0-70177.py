...
params = {
      ...
      'subm'     : [
         { 'name': f'0.69896', 'weight':+0.052, 'color':'crimson'},
         { 'name': f'0.69941', 'weight':+0.101, 'color':'limegreen'},
         { 'name': f'0.70096', 'weight':+0.299, 'color':'royalblue'},
         { 'name': f'0.70108', 'weight':+0.548, 'color':'darkmagenta'},]
}
