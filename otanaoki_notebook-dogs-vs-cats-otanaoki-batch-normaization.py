...
model = models.Sequential([
    layers.Conv2D(32, (3, 3), input_shape=(150, 150, 3)), # 画像化から特徴を抽出する
    layers.BatchNormalization(),              # バッチ正規化を追加
    layers.Activation('relu'), # 活性化関数は別で明示するのが推奨
    ...
    layers.Dense(512), # 中間特徴を学習し、分析精度を向上させる
    layers.BatchNormalization(),     # Dense層にもバッチ正規化
