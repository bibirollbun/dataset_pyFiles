...
cat_feats = ['alcohol_consumption_per_week', 'ethnicity', 'education_level', 'income_level', 'smoking_status', 'employment_status', 'family_history_diabetes', 'hypertension_history', 'cardiovascular_history']
for feat in cat_feats:
    X[feat] = X[feat].astype("category").cat.codes
    X_test[feat] = X_test[feat].astype("category").cat.codes


kf = StratifiedKFold(n_splits = 5, shuffle = True, random_state = 48)
...
cat_features_indices = ['alcohol_consumption_per_week',  'ethnicity', 'education_level', 'income_level', 'smoking_status', 'employment_status', 'family_history_diabetes', 'hypertension_history', 'cardiovascular_history'] # [X.columns.get_loc(col) for col in cat_feats]
