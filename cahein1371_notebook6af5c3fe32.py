...
def copy_requirements_file(src="/kaggle/input/defalt/input_requirements.txt", dst="/kaggle/working/input_requirements.txt"):
    shutil.copy(src, dst)
...
download_pip_files("/kaggle/input/defalt/input_requirements.txt")
create_install_script("/kaggle/input/defalt/input_requirements.txt", script_name="install_requirements.sh")
