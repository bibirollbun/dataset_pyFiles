...
# This forces pip to run with the same Python executable that the notebook uses
import sys
print("Python executable:", sys.executable)

# Install pytrends into that Python
!{sys.executable} -m pip install --upgrade pip
!{sys.executable} -m pip install pytrends


# Check pip version and where it's coming from
!which pip || where pip
!pip --version

# Show whether Python can find the package file
import importlib.util, sys
spec = importlib.util.find_spec("pytrends")
print("pytrends spec:", spec)
...
try:
    import pytrends
    print("pytrends imported from:", pytrends.__file__)
except Exception as e:
    print("Import error:", repr(e))
    traceback.print_exc()
    
# pip info
subprocess.run([sys.executable, "-m", "pip", "show", "pytrends"])
