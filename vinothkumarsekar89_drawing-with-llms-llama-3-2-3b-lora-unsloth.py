...
#save merged 16bit
import os
dir_path = "Llama-32-3B-Instruct-LoRA"
...
# MODEL_SLUG = 'llama_3p2_3b_svg_16bit_merged' # Replace with model slug.

# # Learn more about naming model variations at
# # https://www.kaggle.com/docs/models#name-model.
# VARIATION_SLUG = '05' # Replace with variation slug.

# kagglehub.model_upload(
#   handle = f"vinothkumarsekar89/{MODEL_SLUG}/transformers/{VARIATION_SLUG}",
#   local_model_dir = LOCAL_MODEL_DIR,
#   version_notes = 'Update 2025-05-03')
