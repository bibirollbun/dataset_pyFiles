...
# Plot a 4x4 grid of images with label 0
plot_batch_of_images(label=0)


# Plot a 4x4 grid of images with label 1
...
class CancerDataset(Dataset):
    ...
    # Returns a single sample (image and label) at a given index
    def __getitem__(self, idx):
        # Get the image ID and label from the DataFrame at the specified index
...
train_dl = DataLoader(train_dataset, 
                    batch_size=32, 
                    num_workers=2, # Use 2 worker processes to load data
