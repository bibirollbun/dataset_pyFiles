...
#     for key, val in files_and_cols.items():
#         if col in val and col not in combination_df:
#             df = pd.read_csv(dir_path + key)
#             combination_df[col] = df[col]
#             parent_child[col] = key
#             del df

# combination_df.info()
# combination_df.to_csv("combination_dataset.csv")
...
print(df_regular_season.info())  # Display summary of merged dataset



drop_cols = ["WScore_tourney","LScore_tourney","NumOT_tourney","CityID","WScore"]
