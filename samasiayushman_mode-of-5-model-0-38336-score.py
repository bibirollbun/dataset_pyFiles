...
# Load the datasets
csv1 = pd.read_csv('/kaggle/input/submissionfiles/my_submission.csv')
csv2 = pd.read_csv('/kaggle/input/submissionfiles/submission (1).csv')
csv3 = pd.read_csv('/kaggle/input/submissionfiles/submission (2).csv')
csv4 = pd.read_csv('/kaggle/input/submissionfiles/submission.csv')
csv5 = pd.read_csv('/kaggle/input/submissionfiles/submission_de_neg_0.38345.csv')
