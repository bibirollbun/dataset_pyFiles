...
class GestureLitModule(pl.LightningModule):
    def __init__(
        ...
        self.model = TCN(n_feats, n_classes, channels=[128, 256, 256], k_size=2, dropout=0.2)
...
_infer_model = TCN(n_feats=X.shape[2], n_classes=NUM_CLASSES, channels=[128, 256, 256], k_size=2, dropout=0.2)
