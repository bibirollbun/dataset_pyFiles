...
class Config:
    ...
    lora_dir = '/kaggle/input/wsdm-test-03'
    max_length = 2300
    batch_size = 4
...
# 计算新的 "winner" 列
result_df['winner'] = result_df.apply(lambda row: 'model_a' if row['winner_model_a'] > row['winner_model_b'] else 'model_b', axis=1)

# 将ID和新计算的 "winner" 列添加到 submission_df
