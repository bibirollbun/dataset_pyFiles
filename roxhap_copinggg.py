...
for target in TARGET_VARIABLES:
    ...
    X_train_fold, X_val_fold, y_train_fold, y_val_fold = train_test_split(
        X_subset.drop(columns=[target]), y, test_size=0.0001, random_state=10
    )
    ...
    if target == "Tg":
        xgb_model = XGBRegressor(n_estimators= 2173, learning_rate= 0.0672418745539774, max_depth= 6, reg_lambda= 5.545520219149715, random_state = 42)
    elif target == "Rg":
        xgb_model = XGBRegressor(n_estimators= 520, learning_rate= 0.07324113948440986, max_depth= 5, reg_lambda=0.9717380315982088, random_state = 42)
    elif target == "FFV":
        xgb_model = XGBRegressor(n_estimators= 2202, learning_rate= 0.07220580588586338, max_depth= 4, reg_lambda= 2.8872976032666493, random_state = 42)
    elif target == "Tc":
        xgb_model = XGBRegressor(n_estimators= 1488, learning_rate= 0.010456188013762864, max_depth= 5, reg_lambda= 9.970345982204618, random_state = 42)
    elif target == "Density":
        xgb_model = XGBRegressor(n_estimators= 1958, learning_rate= 0.10955287548172478, max_depth= 5, reg_lambda= 3.074470087965767, random_state = 42)

    xgb_model.fit(X_train_fold, y_train_fold, eval_set=[(X_val_fold, y_val_fold)], verbose=False)
    xgb_oof_preds_1 = xgb_model.predict(X_val_fold)
    test_preds_xgb_1 = xgb_model.predict(X_test)

    if target == "Tg":
        xgb_model = XGBRegressor(n_estimators= 2173, learning_rate= 0.0672418745539774, max_depth= 6, reg_lambda= 5.545520219149715, random_state = 49)
    elif target == "Rg":
        xgb_model = XGBRegressor(n_estimators= 520, learning_rate= 0.07324113948440986, max_depth= 5, reg_lambda=0.9717380315982088, random_state = 49)
    elif target == "FFV":
        xgb_model = XGBRegressor(n_estimators= 2202, learning_rate= 0.07220580588586338, max_depth= 4, reg_lambda= 2.8872976032666493, random_state = 49)
    elif target == "Tc":
        xgb_model = XGBRegressor(n_estimators= 1488, learning_rate= 0.010456188013762864, max_depth= 5, reg_lambda= 9.970345982204618, random_state = 49)
    elif target == "Density":
        xgb_model = XGBRegressor(n_estimators= 1958, learning_rate= 0.10955287548172478, max_depth= 5, reg_lambda= 3.074470087965767, random_state = 49)

    xgb_model.fit(X_train_fold, y_train_fold, eval_set=[(X_val_fold, y_val_fold)], verbose=False)
    xgb_oof_preds_2 = xgb_model.predict(X_val_fold)
    test_preds_xgb_2 = xgb_model.predict(X_test)

    if target == "Tg":
        xgb_model = XGBRegressor(n_estimators= 2173, learning_rate= 0.0672418745539774, max_depth= 6, reg_lambda= 5.545520219149715, random_state = 89)
    elif target == "Rg":
        xgb_model = XGBRegressor(n_estimators= 520, learning_rate= 0.07324113948440986, max_depth= 5, reg_lambda=0.9717380315982088, random_state = 89)
    elif target == "FFV":
        xgb_model = XGBRegressor(n_estimators= 2202, learning_rate= 0.07220580588586338, max_depth= 4, reg_lambda= 2.8872976032666493, random_state = 89)
    elif target == "Tc":
        xgb_model = XGBRegressor(n_estimators= 1488, learning_rate= 0.010456188013762864, max_depth= 5, reg_lambda= 9.970345982204618, random_state = 89)
    elif target == "Density":
        xgb_model = XGBRegressor(n_estimators= 1958, learning_rate= 0.10955287548172478, max_depth= 5, reg_lambda= 3.074470087965767, random_state = 89)

    xgb_model.fit(X_train_fold, y_train_fold, eval_set=[(X_val_fold, y_val_fold)], verbose=False)
    xgb_oof_preds_3 = xgb_model.predict(X_val_fold)
    test_preds_xgb_3 = xgb_model.predict(X_test)
    

    # xgb_model = XGBRegressor()
    # xgb_model.fit(X_train_fold, y_train_fold, eval_set=[(X_val_fold, y_val_fold)], verbose=False)
    # xgb_oof_preds1 = xgb_model.predict(X_val_fold)
    # test_preds_xgb1 = xgb_model.predict(X_test)
    ...
    # rff_model = RandomForestRegressor(random_state = 50)
    # rff_model.fit(X_train_fold, y_train_fold)
...
TARGET_VARIABLES = [ "Tc", "Density", "Rg"]
RANDOM_STATE = 42
gbdt_oof_df = {}
mae_scores = {}
all_importances = {}
