...
class HyperparameterSpace:
    ...
    learning_rate: Tuple[float, float] = (1e-5, 0.1)
    batch_size: List[int] = None
    dropout_rate: Tuple[float, float] = (0.1, 0.7)
    ...
    def __post_init__(self):
        ...
        if self.epochs is None:
            self.epochs = list(range(10, 51, 5))  
    ...
    def create_cnn_model(self, trial, optimize_param: str = HyperparameterType.ALL):
        ...
        if optimize_param == HyperparameterType.ALL:
            ...
            hyperparams['dropout_rate'] = trial.suggest_float(
                'dropout_rate',
                self.hyperparameter_space.dropout_rate[0],
                self.hyperparameter_space.dropout_rate[1]
            )
